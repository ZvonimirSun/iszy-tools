...
.jse-status-bar.svelte-1ulj7zd .jse-status-bar-info:where(.svelte-1ulj7zd) {
  padding: 2px;
}`);var py=B('<div class="jse-status-bar-info svelte-1ulj7zd"> </div>'),fy=B('<div class="jse-status-bar-info svelte-1ulj7zd"> </div>'),hy=B('<div class="jse-status-bar-info svelte-1ulj7zd"> </div>'),gy=B('<div class="jse-status-bar svelte-1ulj7zd"><!> <!> <!></div>'),ld=jm.define([{tag:Us.propertyName,color:"var(--internal-key-color)"},{tag:Us.number,color:"var(--internal-value-color-number)"},{tag:Us.bool,color:"var(--internal-value-color-boolean)"},{tag:Us.string,color:"var(--internal-value-color-string)"},{tag:Us.keyword,color:"var(--internal-value-color-null)"}]),my=qp(ld),by=ld.style;ld.style=e=>by(e||[]);ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
