...
}`);var Ep=X(`<div class="jse-color-picker-popup svelte-v77py2"></div>`);function Dp(e,t){Xo(t,!1);var n=$(t,`color`,8),r=$(t,`onChange`,8),i=$(t,`showOnTop`,8),a=B(),o=()=>{};Cu(Wa(function*(){var e=new((yield re(()=>import(`./vanilla-picker-BWc2OGUN.js`),[]))?.default)({parent:K(a),color:n(),popup:i()?`top`:`bottom`,onDone(e){var t=e.rgba[3]===1?e.hex.substring(0,7):e.hex;r()(t)}});e.show(),o=()=>{e.destroy()}})),wu(()=>{o()}),Sd();var s=Ep();yd(s,e=>V(a,e),()=>K(a)),Z(e,s),Zo()}op(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
}`);var gv=X(`<table class="jse-transform-wizard svelte-9wqi8y"><tbody><tr class="svelte-9wqi8y"><th class="svelte-9wqi8y">Filter</th><td class="svelte-9wqi8y"><div class="jse-horizontal svelte-9wqi8y"><!> <!> <input class="jse-filter-value svelte-9wqi8y"/></div></td></tr><tr class="svelte-9wqi8y"><th class="svelte-9wqi8y">Sort</th><td class="svelte-9wqi8y"><div class="jse-horizontal svelte-9wqi8y"><!> <!></div></td></tr><tr class="svelte-9wqi8y"><th class="svelte-9wqi8y">Pick</th><td class="svelte-9wqi8y"><div class="jse-horizontal svelte-9wqi8y"><!></div></td></tr></tbody></table>`);function _v(e,t){var n,r,i;Xo(t,!1);var a=B(void 0,!0),o=B(void 0,!0),s=B(void 0,!0),c=B(void 0,!0),l=B(void 0,!0),u=B(void 0,!0),d=Ad(`jsoneditor:TransformWizard`),f=$(t,`json`,9),p=$(t,`queryOptions`,29,()=>({})),m=$(t,`onChange`,9),h=[`==`,`!=`,`<`,`<=`,`>`,`>=`].map(e=>({value:e,label:e})),g=[{value:`asc`,label:`ascending`},{value:`desc`,label:`descending`}],_=B((n=p())!=null&&(n=n.filter)!=null&&n.path?Tg(p().filter.path):void 0,!0),v=B(h.find(e=>e.value===p().filter?.relation)??h[0],!0),y=B(((r=p())==null||(r=r.filter)==null?void 0:r.value)||``,!0),b=B((i=p())!=null&&(i=i.sort)!=null&&i.path?Tg(p().sort.path):void 0,!0),x=B(g.find(e=>e.value===p().sort?.direction)??g[0],!0);W(()=>J(f()),()=>{V(a,Array.isArray(f()))}),W(()=>(K(a),J(f())),()=>{V(o,K(a)?Zd(f()):[])}),W(()=>(K(a),J(f())),()=>{V(s,K(a)?Zd(f(),!0):[])}),W(()=>(K(o),Tg),()=>{V(c,K(o).map(Tg))}),W(()=>(K(s),Tg),()=>{V(l,K(s)?K(s).map(Tg):[])}),W(()=>(J(p()),K(l),k),()=>{var e;V(u,(e=p())!=null&&(e=e.projection)!=null&&e.paths&&K(l)?p().projection.paths.map(e=>K(l).find(t=>k(t.value,e))).filter(e=>!!e):void 0)}),W(()=>K(_),()=>{var e=K(_)?.value,t;k((t=p())==null||(t=t.filter)==null?void 0:t.path,e)||(d(`changeFilterPath`,e),p(on(p(),[`filter`,`path`],e,!0)),m()(p()))}),W(()=>K(v),()=>{var e=K(v)?.value,t;k((t=p())==null||(t=t.filter)==null?void 0:t.relation,e)||(d(`changeFilterRelation`,e),p(on(p(),[`filter`,`relation`],e,!0)),m()(p()))}),W(()=>K(y),()=>{var e=K(y),t;k((t=p())==null||(t=t.filter)==null?void 0:t.value,e)||(d(`changeFilterValue`,e),p(on(p(),[`filter`,`value`],e,!0)),m()(p()))}),W(()=>K(b),()=>{var e=K(b)?.value,t;k((t=p())==null||(t=t.sort)==null?void 0:t.path,e)||(d(`changeSortPath`,e),p(on(p(),[`sort`,`path`],e,!0)),m()(p()))}),W(()=>K(x),()=>{var e=K(x)?.value,t;k((t=p())==null||(t=t.sort)==null?void 0:t.direction,e)||(d(`changeSortDirection`,e),p(on(p(),[`sort`,`direction`],e,!0)),m()(p()))}),W(()=>K(u),()=>{(function(e){var t;k((t=p())==null||(t=t.projection)==null?void 0:t.paths,e)||(d(`changeProjectionPaths`,e),p(on(p(),[`projection`,`paths`],e,!0)),m()(p()))})(K(u)?K(u).map(e=>e.value):void 0)}),il(),Sd(!0);var S=gv(),C=H(H(S)),w=H(H(U(H(C))));hv(w,{class:`jse-filter-path`,showChevron:!0,get items(){return K(c)},get value(){return K(_)},set value(e){V(_,e)},$$legacy:!0});var T=U(w,2);hv(T,{class:`jse-filter-relation`,showChevron:!0,clearable:!1,get items(){return h},get value(){return K(v)},set value(e){V(v,e)},$$legacy:!0});var E=U(T,2),ee=U(C),te=H(H(U(H(ee))));hv(te,{class:`jse-sort-path`,showChevron:!0,get items(){return K(c)},get value(){return K(b)},set value(e){V(b,e)},$$legacy:!0}),hv(U(te,2),{class:`jse-sort-direction`,showChevron:!0,clearable:!1,get items(){return g},get value(){return K(x)},set value(e){V(x,e)},$$legacy:!0}),hv(H(H(U(H(U(ee))))),{class:`jse-projection-paths`,multiple:!0,showChevron:!0,get items(){return K(l)},get value(){return K(u)},set value(e){V(u,e)},$$legacy:!0}),md(E,()=>K(y),e=>V(y,e)),Z(e,S),Zo()}op(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
}`);var by=wd(()=>gy),xy=X(`<div class="jse-separator svelte-1qi6rc1">:</div>`),Sy=X(`<div class="jse-bracket svelte-1qi6rc1">[</div> <!> &nbsp;`,1),Cy=X(`<div class="jse-bracket svelte-1qi6rc1">[</div> <!> <div class="jse-bracket svelte-1qi6rc1">]</div>`,1),wy=X(`<div class="jse-context-menu-pointer-anchor svelte-1qi6rc1"><!></div>`),Ty=X(`<div role="none" class="jse-insert-selection-area jse-inside svelte-1qi6rc1" data-type="insert-selection-area-inside"></div>`),Ey=X(`<div role="none" class="jse-insert-selection-area jse-after svelte-1qi6rc1" data-type="insert-selection-area-after"></div>`),Dy=X(`<div data-type="insert-selection-area-inside"><!></div>`),Oy=X(`<div slot="identifier" class="jse-identifier svelte-1qi6rc1"><div class="jse-index svelte-1qi6rc1"> </div></div>`),ky=X(`<!> <!>`,1),Ay=X(`<div role="none" class="jse-insert-selection-area jse-after svelte-1qi6rc1" data-type="insert-selection-area-after"></div>`),jy=X(`<div class="jse-items svelte-1qi6rc1"><!> <!></div> <div class="jse-footer-outer svelte-1qi6rc1"><div data-type="selectable-value" class="jse-footer svelte-1qi6rc1"><span class="jse-bracket svelte-1qi6rc1">]</span></div> <!></div>`,1),My=X(`<div class="jse-header-outer svelte-1qi6rc1"><div class="jse-header svelte-1qi6rc1"><button type="button" class="jse-expand svelte-1qi6rc1" title="Expand or collapse this array (Ctrl+Click to expand/collapse recursively)"><!></button> <!> <!> <div class="jse-meta svelte-1qi6rc1"><div class="jse-meta-inner svelte-1qi6rc1" data-type="selectable-value"><!></div></div> <!></div> <!> <!></div> <!>`,1),Ny=X(`<div class="jse-separator svelte-1qi6rc1">:</div>`),Py=X(`<div class="jse-bracket jse-expanded svelte-1qi6rc1">&lbrace;</div>`),Fy=X(`<div class="jse-bracket svelte-1qi6rc1">&lbrace;</div> <!> <div class="jse-bracket svelte-1qi6rc1">&rbrace;</div>`,1),Iy=X(`<div class="jse-context-menu-pointer-anchor svelte-1qi6rc1"><!></div>`),Ly=X(`<div role="none" class="jse-insert-selection-area jse-inside svelte-1qi6rc1" data-type="insert-selection-area-inside"></div>`),Ry=X(`<div role="none" class="jse-insert-selection-area jse-after svelte-1qi6rc1" data-type="insert-selection-area-after"></div>`),zy=X(`<div data-type="insert-selection-area-inside"><!></div>`),By=X(`<div slot="identifier"><!></div>`),Vy=X(`<div role="none" class="jse-insert-selection-area jse-after svelte-1qi6rc1" data-type="insert-selection-area-after"></div>`),Hy=X(`<div class="jse-props svelte-1qi6rc1"><!> <!></div> <div class="jse-footer-outer svelte-1qi6rc1"><div data-type="selectable-value" class="jse-footer svelte-1qi6rc1"><div class="jse-bracket svelte-1qi6rc1">&rbrace;</div></div> <!></div>`,1),Uy=X(`<div class="jse-header-outer svelte-1qi6rc1"><div class="jse-header svelte-1qi6rc1"><button type="button" class="jse-expand svelte-1qi6rc1" title="Expand or collapse this object (Ctrl+Click to expand/collapse recursively)"><!></button> <!> <!> <div class="jse-meta svelte-1qi6rc1" data-type="selectable-value"><div class="jse-meta-inner svelte-1qi6rc1"><!></div></div> <!></div> <!> <!></div> <!>`,1),Wy=X(`<div class="jse-separator svelte-1qi6rc1">:</div>`),Gy=X(`<div class="jse-context-menu-pointer-anchor svelte-1qi6rc1"><!></div>`),Ky=X(`<div role="none" class="jse-insert-selection-area jse-after svelte-1qi6rc1" data-type="insert-selection-area-after"></div>`),qy=X(`<div class="jse-contents-outer svelte-1qi6rc1"><div class="jse-contents svelte-1qi6rc1"><!> <!> <div class="jse-value-outer svelte-1qi6rc1"><!></div> <!></div> <!> <!></div>`),Jy=X(`<div data-type="insert-selection-area-after"><!></div>`),Yy=X(`<div role="treeitem" tabindex="-1"><!> <!></div>`);function Xy(e,t){Xo(t,!1);var n=B(void 0,!0),r=B(void 0,!0),i=$(t,`pointer`,9),a=$(t,`value`,9),o=$(t,`state`,9),s=$(t,`validationErrors`,9),l=$(t,`searchResults`,9),u=$(t,`selection`,9),d=$(t,`context`,9),f=$(t,`onDragSelectionStart`,9),p=Ad(`jsoneditor:JSONNode`),m=B(void 0,!0),h=void 0,_=B(void 0,!0),v=B(void 0,!0),y=B(void 0,!0),b=B(void 0,!0),x=B(void 0,!0),S=B(void 0,!0),C=B(void 0,!0);function w(e){e.stopPropagation();var t=ip(e);d().onExpand(K(v),!K(y),t)}function T(){d().onExpand(K(v),!0)}function E(e,t){var n=Vh(K(v),Object.keys(a()),e,t);return d().onPatch(n),c(fn(n[0].path))}function ee(e){d().onDrag(e)}function te(e){by().selecting&&(by(by().selecting=!1),e.stopPropagation()),d().onDragEnd(),document.removeEventListener(`mousemove`,ee,!0),document.removeEventListener(`mouseup`,te)}function ne(){var e;return((e=d().findElement([]))==null||(e=e.getBoundingClientRect())==null?void 0:e.top)||0}function re(e,t){var n=ne()-e.initialContentTop;return t.clientY-e.initialClientY-n}function ie(e){if(!d().readOnly&&u()){var t=Ct(Mh(u()));if(k(K(v),t)){var n=function(e,t){var n=[];function r(e){var t=K(v).concat(e),r=d().findElement(t);r!==void 0&&n.push({path:t,height:r.clientHeight})}if(Array.isArray(a())){var i=d().getJson();if(i===void 0)return;var o=ah(i,e),s=oh(i,e),l=parseInt(c(o),10),u=parseInt(c(s),10),f=t.find(e=>l>=e.start&&u<=e.end);if(!f)return;var{start:p,end:m}=f;Qd(p,Math.min(a().length,m),e=>r(String(e)))}else Object.keys(a()).forEach(r);return n}(u(),K(x)||Pp);if(p(`dragSelectionStart`,{selection:u(),items:n}),n){var r=d().getJson();if(r!==void 0){var i=ah(r,u()),o=n.findIndex(e=>k(e.path,i)),{offset:s}=_y({json:r,selection:d().getSelection(),deltaY:0,items:n});V(_,{initialTarget:e.target,initialClientY:e.clientY,initialContentTop:ne(),selectionStartIndex:o,selectionItemsCount:rh(r,u()).length,items:n,offset:s,didMoveItems:!1}),by(by().dragging=!0),document.addEventListener(`mousemove`,ae,!0),document.addEventListener(`mouseup`,oe)}}else p(`Cannot drag the current selection (probably spread over multiple sections)`)}else f()(e)}}function ae(e){if(K(_)){var t=d().getJson();if(t===void 0)return;var n=re(K(_),e),{offset:r}=_y({json:t,selection:d().getSelection(),deltaY:n,items:K(_).items});r!==K(_).offset&&(p(`drag selection`,r,n),V(_,L(L({},K(_)),{},{offset:r,didMoveItems:!0})))}}function oe(e){if(K(_)){var t=d().getJson();if(t===void 0)return;var n=re(K(_),e),{operations:r,updatedSelection:i}=_y({json:t,selection:d().getSelection(),deltaY:n,items:K(_).items});if(r)d().onPatch(r,(e,t)=>({state:t,selection:i??u()}));else if(e.target===K(_).initialTarget&&!K(_).didMoveItems){var a=Qf(e.target),o=ep(e.target);o&&d().onSelect(Oh(a,o))}V(_,void 0),by(by().dragging=!1),document.removeEventListener(`mousemove`,ae,!0),document.removeEventListener(`mouseup`,oe)}}function se(e){e.shiftKey||(e.stopPropagation(),e.preventDefault(),d().onSelect(bh(K(v))))}function D(e){e.shiftKey||(e.stopPropagation(),e.preventDefault(),d().onSelect(xh(K(v))))}function ce(e){d().onSelect(bh(K(v))),Hs(),d().onContextMenu(e)}function le(e){d().onSelect(xh(K(v))),Hs(),d().onContextMenu(e)}W(()=>J(i()),()=>{V(v,fn(i()))}),W(()=>J(i()),()=>{V(n,encodeURIComponent(i()))}),W(()=>J(o()),()=>{V(y,!!fm(o())&&o().expanded)}),W(()=>(J(a()),J(o())),()=>{V(b,Rm(a(),o(),[]))}),W(()=>J(o()),()=>{V(x,um(o())?o().visibleSections:void 0)}),W(()=>J(s()),()=>{V(S,s()?.validationError)}),W(()=>(J(d()),J(u()),K(v)),()=>{V(C,Ah(d().getJson(),u(),K(v)))}),W(()=>K(v),()=>{V(r,K(v).length===0)}),il(),Sd(!0);var O,ue,de=Yy(),fe=H(de),pe=e=>{var n=My(),c=Kc(n),f=H(c),p=H(f),h=H(p),b=e=>{Cp(e,{get data(){return Ji}})},E=e=>{Cp(e,{get data(){return hi}})};Q(h,e=>{K(y)?e(b):e(E,-1)});var ee=U(p,2);zu(ee,t,`identifier`,{},null);var te=U(ee,2),ne=e=>{Z(e,xy())};Q(te,e=>{K(r)||e(ne)});var re=U(te,2),ae=H(H(re)),oe=e=>{var t=Sy();mg(U(Kc(t),2),{children:(e,t)=>{var n=au();G(()=>{var e,t;return du(n,`${(J(a()),e=q(()=>a().length))!==null&&e!==void 0?e:``}
                ${(J(a()),t=q(()=>a().length===1?`item`:`items`))!==null&&t!==void 0?t:``}`)}),Z(e,n)},$$slots:{default:!0}}),Z(e,t)},le=e=>{var t=Cy();mg(U(Kc(t),2),{onclick:T,children:(e,t)=>{var n=au();G(()=>{var e,t;return du(n,`${(J(a()),e=q(()=>a().length))!==null&&e!==void 0?e:``}
                ${(J(a()),t=q(()=>a().length===1?`item`:`items`))!==null&&t!==void 0?t:``}`)}),Z(e,n)},$$slots:{default:!0}}),Z(e,t)};Q(ae,e=>{K(y)?e(oe):e(le,-1)});var O=U(re,2),ue=e=>{var t=wy();dy(H(t),{get root(){return K(r)},selected:!0,get onContextMenu(){return J(d()),q(()=>d().onContextMenu)}}),Z(e,t)},de=Sc(()=>(J(d()),K(C),J(u()),J(Qm),J($m),J(wh),J(k),J(Mh),K(v),q(()=>!d().readOnly&&K(C)&&u()&&(Qm(u())||$m(u()))&&!wh(u())&&k(Mh(u()),K(v)))));Q(O,e=>{K(de)&&e(ue)});var fe=U(f,2),pe=e=>{yy(e,{get validationError(){return K(S)},onExpand:T})};Q(fe,e=>{K(S),K(y),q(()=>K(S)&&(!K(y)||!K(S).isChildError))&&e(pe)});var me=U(fe,2),he=e=>{var t=Ty();Y(`click`,t,se),Z(e,t)},ge=e=>{var t=Ey();Y(`click`,t,D),Z(e,t)};Q(me,e=>{K(y)?e(he):e(ge,-1)});var A=U(c,2),_e=e=>{var t=jy(),n=Kc(t),c=H(n),f=e=>{var t,n,r=Dy(),i=H(r),a=z(()=>(K(C),J(Xm),J(u()),q(()=>K(C)&&Xm(u()))));dy(i,{insert:!0,get selected(){return K(a)},onContextMenu:ce}),G(e=>{t=Ju(r,1,`jse-insert-area jse-inside svelte-1qi6rc1`,null,t,e),cd(r,`title`,Lp),n=Xu(r,``,n,{"--level":(K(v),q(()=>K(v).length+1))})},[()=>({"jse-hovered":K(m)===zp,"jse-selected":K(C)&&Xm(u())})]),Z(e,r)},p=Sc(()=>(J(d()),K(m),J(zp),K(C),J(Xm),J(u()),q(()=>!d().readOnly&&(K(m)===zp||K(C)&&Xm(u())))));Q(c,e=>{K(p)&&e(f)}),Nu(U(c,2),1,()=>K(x)||Pp,ju,(e,t,n)=>{var r=ky(),c=Kc(r);Nu(c,1,()=>(J(a()),K(t),K(_),q(()=>function(e,t,n){var r=t.start,i=g(r,Math.min(t.end,e.length));return n&&n.offset!==0?nf(i,n.selectionStartIndex,n.selectionItemsCount,n.offset).map((e,t)=>({index:e,gutterIndex:t})):i.map(e=>({index:e,gutterIndex:e}))}(a(),K(t),K(_)))),e=>e.index,(e,t)=>{var n=z(()=>(J(um),J(s()),K(t),q(()=>um(s())?s().items[K(t).index]:void 0))),r=z(()=>(J(kh),J(d()),J(u()),K(v),K(t),q(()=>kh(d().getJson(),u(),K(v).concat(String(K(t).index)))))),c=ou(),f=Kc(c),p=z(()=>(J(hn),J(i()),K(t),q(()=>hn(i(),K(t).index)))),m=z(()=>(J(um),J(o()),K(t),q(()=>um(o())?o().items[K(t).index]:void 0))),h=z(()=>(J(um),J(l()),K(t),q(()=>um(l())?l().items[K(t).index]:void 0)));Xy(f,{get value(){return J(a()),K(t),q(()=>a()[K(t).index])},get pointer(){return K(p)},get state(){return K(m)},get validationErrors(){return K(n)},get searchResults(){return K(h)},get selection(){return K(r)},get context(){return d()},onDragSelectionStart:ie,$$slots:{identifier:(e,n)=>{var r=Oy(),i=H(H(r));G(()=>du(i,(K(t),q(()=>K(t).gutterIndex)))),Z(e,r)}}}),Z(e,c)});var f=U(c,2),p=e=>{var t=z(()=>K(x)||Pp);ly(e,{get visibleSections(){return K(t)},sectionIndex:n,get total(){return J(a()),q(()=>a().length)},get path(){return K(v)},get onExpandSection(){return J(d()),q(()=>d().onExpandSection)},get selection(){return u()},get context(){return d()}})};Q(f,e=>{K(t),J(a()),q(()=>K(t).end<a().length)&&e(p)}),Z(e,r)});var h=U(H(U(n,2)),2),y=e=>{var t=Ay();Y(`click`,t,D),Z(e,t)};Q(h,e=>{K(r)||e(y)}),Z(e,t)};Q(A,e=>{K(y)&&e(_e)}),Y(`click`,p,w),Z(e,n)},me=Sc(()=>(J(a()),q(()=>Array.isArray(a())))),he=e=>{var n=Uy(),c=Kc(n),f=H(c),p=H(f),h=H(p),g=e=>{Cp(e,{get data(){return Ji}})},b=e=>{Cp(e,{get data(){return hi}})};Q(h,e=>{K(y)?e(g):e(b,-1)});var x=U(p,2);zu(x,t,`identifier`,{},null);var ee=U(x,2),te=e=>{Z(e,Ny())};Q(ee,e=>{K(r)||e(te)});var ne=U(ee,2),re=H(H(ne)),ae=e=>{Z(e,Py())},oe=e=>{var t=Fy();mg(U(Kc(t),2),{onclick:T,children:(e,t)=>{var n=au();G((e,t)=>du(n,`${e??``}
                ${t??``}`),[()=>(J(a()),q(()=>Object.keys(a()).length)),()=>(J(a()),q(()=>Object.keys(a()).length===1?`prop`:`props`))]),Z(e,n)},$$slots:{default:!0}}),Z(e,t)};Q(re,e=>{K(y)?e(ae):e(oe,-1)});var le=U(ne,2),O=e=>{var t=Iy();dy(H(t),{get root(){return K(r)},selected:!0,get onContextMenu(){return J(d()),q(()=>d().onContextMenu)}}),Z(e,t)},ue=Sc(()=>(J(d()),K(C),J(u()),J(Qm),J($m),J(wh),J(k),J(Mh),K(v),q(()=>!d().readOnly&&K(C)&&u()&&(Qm(u())||$m(u()))&&!wh(u())&&k(Mh(u()),K(v)))));Q(le,e=>{K(ue)&&e(O)});var de=U(f,2),fe=e=>{yy(e,{get validationError(){return K(S)},onExpand:T})};Q(de,e=>{K(S),K(y),q(()=>K(S)&&(!K(y)||!K(S).isChildError))&&e(fe)});var pe=U(de,2),me=e=>{var t=Ly();Y(`click`,t,se),Z(e,t)},he=e=>{var t=Ry();Y(`click`,t,D),Z(e,t)};Q(pe,e=>{K(y)?e(me):K(r)||e(he,1)});var ge=U(c,2),A=e=>{var t=Hy(),n=Kc(t),c=H(n),f=e=>{var t,n,r=zy(),i=H(r),a=z(()=>(K(C),J(Xm),J(u()),q(()=>K(C)&&Xm(u()))));dy(i,{insert:!0,get selected(){return K(a)},onContextMenu:ce}),G(e=>{t=Ju(r,1,`jse-insert-area jse-inside svelte-1qi6rc1`,null,t,e),cd(r,`title`,Lp),n=Xu(r,``,n,{"--level":(K(v),q(()=>K(v).length+1))})},[()=>({"jse-hovered":K(m)===zp,"jse-selected":K(C)&&Xm(u())})]),Z(e,r)},p=Sc(()=>(J(d()),K(m),J(zp),K(C),J(Xm),J(u()),q(()=>!d().readOnly&&(K(m)===zp||K(C)&&Xm(u())))));Q(c,e=>{K(p)&&e(f)}),Nu(U(c,2),1,()=>(J(a()),K(_),q(()=>function(e,t){var n=Object.keys(e);return t&&t.offset!==0?nf(n,t.selectionStartIndex,t.selectionItemsCount,t.offset):n}(a(),K(_)))),ju,(e,t)=>{var n=z(()=>(J(hn),J(i()),K(t),q(()=>hn(i(),K(t))))),r=z(()=>(J(lm),J(l()),K(t),q(()=>lm(l())?l().properties[K(t)]:void 0))),c=z(()=>(J(lm),J(s()),K(t),q(()=>lm(s())?s().properties[K(t)]:void 0))),f=z(()=>(K(v),K(t),q(()=>K(v).concat(K(t))))),p=z(()=>(J(kh),J(d()),J(u()),J(K(f)),q(()=>kh(d().getJson(),u(),K(f))))),m=ou(),h=Kc(m),g=z(()=>(J(lm),J(o()),K(t),q(()=>lm(o())?o().properties[K(t)]:void 0)));Xy(h,{get value(){return J(a()),K(t),q(()=>a()[K(t)])},get pointer(){return K(n)},get state(){return K(g)},get validationErrors(){return K(c)},get searchResults(){return K(r)},get selection(){return K(p)},get context(){return d()},onDragSelectionStart:ie,$$slots:{identifier:(e,i)=>{var a,o=By(),s=H(o),c=z(()=>(J(ag),J(K(r)),q(()=>ag(K(r)))));(function(e,t){Xo(t,!1);var n=B(void 0,!0),r=B(void 0,!0),i=$(t,`pointer`,9),a=$(t,`key`,9),o=$(t,`selection`,9),s=$(t,`searchResultItems`,9),c=$(t,`onUpdateKey`,9),l=$(t,`context`,9),u=B(void 0,!0);function d(e){K(r)||l().readOnly||(e.preventDefault(),l().onSelect(_h(K(u))))}function f(e,t){var n=c()(a(),l().normalization.unescapeValue(e)),r=Ct(K(u)).concat(n);l().onSelect(t===jf.nextInside?vh(r):gh(r)),t!==jf.self&&l().focus()}function p(){l().onSelect(gh(K(u))),l().focus()}W(()=>J(i()),()=>{V(u,fn(i()))}),W(()=>(J(o()),K(u)),()=>{V(n,Zm(o())&&k(o().path,K(u)))}),W(()=>(K(n),J(o())),()=>{V(r,K(n)&&wh(o()))}),il(),Sd(!0);var m=py(),h=Kc(m),g=e=>{var t=z(()=>(J(l()),J(a()),q(()=>l().normalization.escapeValue(a())))),n=z(()=>(J(wh),J(o()),q(()=>wh(o())?o().initialValue:void 0)));Lh(e,{get value(){return K(t)},get initialValue(){return K(n)},label:`Edit key`,shortText:!0,onChange:f,onCancel:p,get onFind(){return J(l()),q(()=>l().onFind)}})},_=e=>{var t,n=fy(),r=H(n),i=e=>{var t=z(()=>(J(l()),J(a()),q(()=>l().normalization.escapeValue(a()))));dg(e,{get text(){return K(t)},get searchResultItems(){return s()}})},o=e=>{var t=au();G(e=>du(t,e),[()=>(J(Wf),J(l()),J(a()),q(()=>Wf(l().normalization.escapeValue(a()))))]),Z(e,t)};Q(r,e=>{s()?e(i):e(o,-1)}),G(()=>t=Ju(n,1,`jse-key svelte-1n4cez4`,null,t,{"jse-empty":a()===``})),Y(`dblclick`,n,d),Z(e,n)};Q(h,e=>{J(l()),K(r),q(()=>!l().readOnly&&K(r))?e(g):e(_,-1)});var v=U(h,2),y=e=>{dy(e,{selected:!0,get onContextMenu(){return J(l()),q(()=>l().onContextMenu)}})};Q(v,e=>{J(l()),K(n),K(r),q(()=>!l().readOnly&&K(n)&&!K(r))&&e(y)}),Z(e,m),Zo()})(s,{get pointer(){return K(n)},get key(){return K(t)},get selection(){return K(p)},get searchResultItems(){return K(c)},get context(){return d()},onUpdateKey:E}),G(e=>a=Ju(o,1,`jse-key-outer svelte-1qi6rc1`,null,a,e),[()=>({"jse-selected-key":Zm(K(p))&&k(K(p).path,K(f))})]),Z(e,o)}}}),Z(e,m)});var h=U(H(U(n,2)),2),g=e=>{var t=Vy();Y(`click`,t,D),Z(e,t)};Q(h,e=>{K(r)||e(g)}),Z(e,t)};Q(ge,e=>{K(y)&&e(A)}),Y(`click`,p,w),Z(e,n)},ge=Sc(()=>(J(Rd),J(a()),q(()=>Rd(a())))),A=e=>{var n=qy(),i=H(n),o=H(i);zu(o,t,`identifier`,{},null);var s=U(o,2),c=e=>{Z(e,Wy())};Q(s,e=>{K(r)||e(c)});var f=U(s,2),p=H(f),m=z(()=>K(C)?u():void 0),h=z(()=>(J(og),J(l()),q(()=>og(l()))));hy(p,{get path(){return K(v)},get value(){return a()},get enforceString(){return K(b)},get selection(){return K(m)},get searchResultItems(){return K(h)},get context(){return d()}});var g=U(f,2),_=e=>{var t=Gy();dy(H(t),{get root(){return K(r)},selected:!0,get onContextMenu(){return J(d()),q(()=>d().onContextMenu)}}),Z(e,t)},y=Sc(()=>(J(d()),K(C),J(u()),J(Qm),J($m),J(wh),J(k),J(Mh),K(v),q(()=>!d().readOnly&&K(C)&&u()&&(Qm(u())||$m(u()))&&!wh(u())&&k(Mh(u()),K(v)))));Q(g,e=>{K(y)&&e(_)});var x=U(i,2),w=e=>{yy(e,{get validationError(){return K(S)},onExpand:T})};Q(x,e=>{K(S)&&e(w)});var E=U(x,2),ee=e=>{var t=Ky();Y(`click`,t,D),Z(e,t)};Q(E,e=>{K(r)||e(ee)}),Z(e,n)};Q(fe,e=>{K(me)?e(pe):K(ge)?e(he,1):e(A,-1)});var _e=U(fe,2),ve=e=>{var t,n=Jy(),r=H(n),i=z(()=>(K(C),J(Ym),J(u()),q(()=>K(C)&&Ym(u()))));dy(r,{insert:!0,get selected(){return K(i)},onContextMenu:le}),G(e=>{t=Ju(n,1,`jse-insert-area jse-after svelte-1qi6rc1`,null,t,e),cd(n,`title`,Lp)},[()=>({"jse-hovered":K(m)===Bp,"jse-selected":K(C)&&Ym(u())})]),Z(e,n)},j=Sc(()=>(J(d()),K(m),J(Bp),K(C),J(Ym),J(u()),q(()=>!d().readOnly&&(K(m)===Bp||K(C)&&Ym(u())))));Q(_e,e=>{K(j)&&e(ve)}),G((e,t)=>{O=Ju(de,1,e,`svelte-1qi6rc1`,O,t),cd(de,`data-path`,K(n)),cd(de,`aria-selected`,K(C)),ue=Xu(de,``,ue,{"--level":(K(v),q(()=>K(v).length))})},[()=>Wu((J(Ph),K(y),J(d()),K(v),J(a()),q(()=>Ph(`jse-json-node`,{"jse-expanded":K(y)},d().onClassName(K(v),a()))))),()=>({"jse-root":K(r),"jse-selected":K(C)&&$m(u()),"jse-selected-value":K(C)&&Qm(u()),"jse-readonly":d().readOnly,"jse-hovered":K(m)===Vp})]),Y(`mousedown`,de,function(e){if((e.buttons===1||e.buttons===2)&&!((t=e.target).nodeName===`DIV`&&t.contentEditable===`true`||e.buttons===1&&Gf(e.target,`BUTTON`))){var t;e.stopPropagation(),e.preventDefault(),d().focus(),document.addEventListener(`mousemove`,ee,!0),document.addEventListener(`mouseup`,te);var n=Qf(e.target),i=d().getJson(),o=d().getDocumentState();if(!u()||n===Ef.after||n===Ef.inside||u().type!==n&&u().type!==Ef.multi||!Ah(i,u(),K(v)))if(by(by().selecting=!0),by(by().selectionAnchor=K(v)),by(by().selectionAnchorType=n),by(by().selectionFocus=K(v)),e.shiftKey){var s=d().getSelection();s&&d().onSelect(Sh(Nh(s),K(v)))}else if(n===Ef.multi)if(K(r)&&e.target.hasAttribute(`data-path`)){var l=c(Vm(a(),o));d().onSelect(Dh(l))}else d().onSelect(Sh(K(v),K(v)));else i!==void 0&&d().onSelect(Oh(n,K(v)));else e.button===0&&f()(e)}}),Y(`mousemove`,de,function(e){if(by().selecting){e.preventDefault(),e.stopPropagation(),by().selectionFocus===void 0&&window.getSelection&&window.getSelection().empty();var t=Qf(e.target);k(K(v),by().selectionFocus)&&t===by().selectionAnchorType||(by(by().selectionFocus=K(v)),by(by().selectionAnchorType=t),d().onSelect(Sh(by().selectionAnchor||by().selectionFocus,by().selectionFocus)))}}),Y(`mouseover`,de,function(e){by().selecting||by().dragging||(e.stopPropagation(),Kf(e.target,`data-type`,`selectable-value`)?V(m,Vp):Kf(e.target,`data-type`,`selectable-key`)?V(m,void 0):Kf(e.target,`data-type`,`insert-selection-area-inside`)?V(m,zp):Kf(e.target,`data-type`,`insert-selection-area-after`)&&V(m,Bp),clearTimeout(h))}),Y(`mouseout`,de,function(e){e.stopPropagation(),h=window.setTimeout(()=>V(m,void 0))}),Z(e,de),Zo()}var Zy={prefix:`fas`,iconName:`jsoneditor-expand`,icon:[512,512,[],``,`M 0,448 V 512 h 512 v -64 z M 0,0 V 64 H 512 V 0 Z M 256,96 128,224 h 256 z M 256,416 384,288 H 128 Z`]},Qy={prefix:`fas`,iconName:`jsoneditor-collapse`,icon:[512,512,[],``,`m 0,224 v 64 h 512 v -64 z M 256,192 384,64 H 128 Z M 256,320 128,448 h 256 z`]},$y={prefix:`fas`,iconName:`jsoneditor-format`,icon:[512,512,[],``,`M 0,32 v 64 h 416 v -64 z M 160,160 v 64 h 352 v -64 z M 160,288 v 64 h 288 v -64 z M 0,416 v 64 h 320 v -64 z`]},eb={prefix:`fas`,iconName:`jsoneditor-compact`,icon:[512,512,[],``,`M 0,32 v 64 h 512 v -64 z M 0,160 v 64 h 512 v -64 z M 0,288 v 64 h 352 v -64 z`]};op(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
.jse-text-mode.svelte-k2b9e6 .jse-fold-progress:where(.svelte-k2b9e6) .jse-fold-cancel-button:where(.svelte-k2b9e6):hover {
  background: var(--jse-theme-color-highlight, #5f9dff);
  color: #fff;
}`);var Gx=X(`<div class="jse-fold-progress svelte-k2b9e6"><span class="jse-fold-tip svelte-k2b9e6">Collapsing</span> <div class="jse-fold-progress-track svelte-k2b9e6"><div class="jse-fold-progress-fill svelte-k2b9e6"></div></div> <button class="jse-fold-cancel-button svelte-k2b9e6" type="button" title="Cancel folding">Cancel</button></div>`),Kx=X(`<!> <div class="jse-contents jse-preview svelte-k2b9e6"> </div>`,1),qx=X(`<!> <!> <!> <!>`,1),Jx=X(`<div></div> <!> <!>`,1),Yx=X(`<div class="jse-contents svelte-k2b9e6"><div class="jse-loading-space svelte-k2b9e6"></div> <div class="jse-loading svelte-k2b9e6">loading...</div></div>`),Xx=X(`<div><!> <!> <!></div>`);function Zx(e,t){Xo(t,!1);var n=B(void 0,!0),r=B(void 0,!0),i=$(t,`readOnly`,9),a=$(t,`mainMenuBar`,9),o=$(t,`statusBar`,9),s=$(t,`askToFormat`,9),c=$(t,`externalContent`,9),l=$(t,`externalSelection`,9),u=$(t,`history`,9),d=$(t,`indentation`,9),f=$(t,`tabSize`,9),p=$(t,`escapeUnicodeCharacters`,9),m=$(t,`maxDocumentSize`,9),h=$(t,`parser`,9),g=$(t,`validator`,9),v=$(t,`validationParser`,9),y=$(t,`onChange`,9),b=$(t,`onChangeMode`,9),x=$(t,`onSelect`,9),C=$(t,`onUndo`,9),w=$(t,`onRedo`,9),T=$(t,`onError`,9),E=$(t,`onFocus`,9),ee=$(t,`onBlur`,9),te=$(t,`onRenderMenu`,9),ne=$(t,`onSortModal`,9),re=$(t,`onTransformModal`,9),ie=Ad(`jsoneditor:TextMode`),ae={key:`Mod-i`,run:Tt,shift:Et,preventDefault:!0},oe=typeof window>`u`;ie(`isSSR:`,oe);var se,D=B(void 0,!0),ce=B(void 0,!0),le=B(void 0,!0),O=B(!1,!0),me=B(s(),!0),A=B([],!0),ve=B(!1,!0),M=B(0,!0),be=B(0,!0),N=null,P=new De,Te=new De,je=new De,Be=new De,Ve=new De,Ge=c(),Ye=B(_f(Ge,d(),h()),!0),rt=ze.define(),it=null;function ct(){if(!it||it.length===0)return!1;var e=it[0].startState,t=it[it.length-1].state,n=it.map(e=>e.changes).reduce((e,t)=>e.compose(t)),r={type:`text`,undo:{changes:n.invert(e.doc).toJSON(),selection:rn(e.selection)},redo:{changes:n.toJSON(),selection:rn(t.selection)}};return ie(`add history item`,r),u().add(r),it=null,!0}var lt=B(p(),!0);Cu(Wa(function*(){if(!oe)try{se=function(e){var{target:t,initialText:n,readOnly:r,indentation:i}=e;ie(`Create CodeMirror editor`,{readOnly:r,indentation:i});var a=function(e,t){return nh(e)?e.ranges.every(e=>e.anchor<t.length&&e.head<t.length):!1}(l(),n)?qt(l()):void 0;return se=new Xe({state:ot.create({doc:n,selection:a,extensions:[Pe.of([fe,ae]),P.of(Bt()),Oe(),Ie(),Ue(),et(),_e(),mt(),qe(),Qe(),ot.allowMultipleSelections.of(!0),Se(),Je(ue,{fallback:!0}),pe(),He(),Me(),We(),ke(),Ne(),F(),Pe.of([...$e,...Ae,...at,{key:`Mod-z`,run:Mt,preventDefault:!0},{key:`Mod-y`,mac:`Mod-Shift-z`,run:Nt,preventDefault:!0},{key:`Ctrl-Shift-z`,run:Nt,preventDefault:!0},...ye,...Fe,...Ke]),Hx,Fa({hideFirstIndent:!0}),Xe.domEventHandlers({dblclick:zt}),Xe.updateListener.of(e=>{(V(le,e.state),e.docChanged)&&(e.transactions.some(e=>!!e.annotation(rt))||(it=[...it??[],e]),$t()),e.selectionSet&&nn()}),Ta(),tt({top:!0}),Xe.lineWrapping,Te.of(ot.readOnly.of(r)),Be.of(ot.tabSize.of(f())),je.of(Qt(i)),Ve.of(Xe.theme({},{dark:Vt()}))]}),parent:t}),a&&se.dispatch(se.state.update({selection:a.main,scrollIntoView:!0})),se}({target:K(D),initialText:an(K(Ye),m(),K(O))?``:K(n).escapeValue(K(Ye)),readOnly:i(),indentation:d()})}catch(e){console.error(e)}})),wu(()=>{en(),se&&(ie(`Destroy CodeMirror editor`),se.destroy()),vt()});var ut=Ut(),dt=Ut();function ft(){se&&(ie(`focus`),se.focus())}function pt(e,t){if(se)try{(function(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[],t=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1],r=se.state,i=r.doc.length,a=j(r,i,1/0);if(a){var o=[];if(e.length===0)o=gt(a,r,void 0,t);else{var{from:s}=df(K(n).escapeValue(K(Ye)),e);s!==void 0&&s!==0&&(o=gt(a,r,s,t))}o.length>0&&function(e){_t.apply(this,arguments)}(o)}})(e,t)}catch(e){T()(e)}}function mt(){return de.of((e,t,n)=>{var r=j(e,e.doc.length,1/0);if(!r||r.length<n)return null;for(var i=null,a=r.resolveStack(n,1);a;a=a.next){var o=a.node;if(!(o.to<=n||o.from>n)){if(i&&o.from<t)break;var s=o.type.prop(st);if(s&&(o.to<r.length-50||r.length==e.doc.length||!ht(o))){var c=s(o,e);c&&c.from<=n&&c.from>=t&&c.to>n&&(i=c)}}}return i})}function ht(e){var t=e.lastChild;return t&&t.to==e.to&&t.type.isError}function gt(e,t,n){var r=!(arguments.length>3&&arguments[3]!==void 0)||arguments[3],i=[],a=new Set;return e.iterate({enter(e){if(n===void 0||e.from>=n){var o=xe(t,e.from,e.to);if(o){var s=`${o.from}-${o.to}`;a.has(s)||(r?(i.push({from:o.from,to:o.to}),a.add(s)):i.some(e=>e.from<=o.from&&e.to>=o.to)||(i.push({from:o.from,to:o.to}),a.add(s)))}}}}),i}function _t(){return _t=Wa(function*(e){if(e.length!==0){var t=e.length>5e3;t&&(V(ve,!0),V(M,0),V(be,e.length),N=new AbortController);var n=r=>new Promise(i=>{var a;t&&(a=N)!=null&&a.signal.aborted?i():requestAnimationFrame(()=>{var a=Math.min(r+100,e.length),o=e.slice(r,a);se.dispatch({effects:o.map(e=>he.of({from:e.from,to:e.to}))}),t&&V(M,a),a<e.length?n(a).then(i):i()})});yield n(0),t&&(V(ve,!1),V(M,0),V(be,0),N=null)}}),_t.apply(this,arguments)}function vt(){N&&N.abort()}function yt(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Km;if(se)try{if(e&&e.length>0){var{from:r}=df(K(n).escapeValue(K(Ye)),e);r!==void 0&&(se.dispatch({selection:{anchor:r,head:r}}),Ce(se))}else we(se);t?.(e)}catch(e){T()(e)}}function bt(){yt([],()=>!0)}function xt(){pt([],!0)}var St=!1;function Ct(e){return wt(e,!1)}function wt(e,t){ie(`handlePatch`,e,t);var n=h().parse(K(Ye)),r=gn(n,e),i=On(n,e);return Kt({text:h().stringify(r,null,d())},t,!1),{json:r,previousJson:n,undo:i,redo:e}}function Tt(){if(ie(`format`),i())return!1;try{var e=h().parse(K(Ye));return Kt({text:h().stringify(e,null,d())},!0,!1),V(me,s()),!0}catch(e){T()(e)}return!1}function Et(){if(ie(`compact`),i())return!1;try{var e=h().parse(K(Ye));return Kt({text:h().stringify(e)},!0,!1),V(me,!1),!0}catch(e){T()(e)}return!1}function Dt(){if(ie(`repair`),!i())try{Kt({text:br(K(Ye))},!0,!1),V(I,Hp),V(on,void 0)}catch(e){T()(e)}}function Ot(){var e;if(!i())try{var t=h().parse(K(Ye));St=!0,ne()({id:ut,json:t,rootPath:[],onSort:(e=Wa(function*(e){var{operations:t}=e;ie(`onSort`,t),wt(t,!0)}),function(t){return e.apply(this,arguments)}),onClose:()=>{St=!1,ft()}})}catch(e){T()(e)}}function kt(e){var{id:t,rootPath:n,onTransform:r,onClose:i}=e;try{var a=h().parse(K(Ye));St=!0,re()({id:t||dt,json:a,rootPath:n||[],onTransform:e=>{r?r({operations:e,json:a,transformedJson:gn(a,e)}):(ie(`onTransform`,e),wt(e,!0))},onClose:()=>{St=!1,ft(),i&&i()}})}catch(e){T()(e)}}function At(){i()||kt({rootPath:[]})}function jt(){se&&(K(D)&&K(D).querySelector(`.cm-search`)?Re(se):Ee(se))}function Mt(){if(i())return!1;en();var e=u().undo();return ie(`undo`,e),hm(e)?(se.dispatch({annotations:rt.of(`undo`),changes:Le.fromJSON(e.undo.changes),selection:nt.fromJSON(e.undo.selection),scrollIntoView:!0}),!0):(C()(e),!1)}function Nt(){if(i())return!1;en();var e=u().redo();return ie(`redo`,e),hm(e)?(se.dispatch({annotations:rt.of(`redo`),changes:Le.fromJSON(e.redo.changes),selection:nt.fromJSON(e.redo.selection),scrollIntoView:!0}),!0):(w()(e),!1)}function Pt(){V(O,!0),Kt(c(),!0,!0)}function Ft(){b()(Tf.tree)}function It(){Xt()}function Lt(e){ie(`select validation error`,e);var{from:t,to:n}=Ht(e);t!==void 0&&n!==void 0&&(Rt(t,n),ft())}function Rt(e,t){ie(`setSelection`,{anchor:e,head:t}),se&&se.dispatch(se.state.update({selection:{anchor:e,head:t},scrollIntoView:!0}))}function zt(e,t){if(t.state.selection.ranges.length===1){var n=t.state.selection.ranges[0],r=K(Ye).slice(n.from,n.to);if(r===`{`||r===`[`){var i=Sr.parse(K(Ye)),a=Object.keys(i.pointers).find(e=>i.pointers[e].value?.pos===n.from),o=i.pointers[a];a&&o&&o.value&&o.valueEnd&&(ie(`pointer found, selecting inner contents of path:`,a,o),Rt(o.value.pos+1,o.valueEnd.pos-1))}}}function Bt(){return Ze(sn,{delay:300})}function Vt(){return!!K(D)&&getComputedStyle(K(D)).getPropertyValue(`--jse-theme`).includes(`dark`)}function Ht(e){var{path:t,message:r,severity:i}=e,{line:a,column:o,from:s,to:c}=df(K(n).escapeValue(K(Ye)),t);return{path:t,line:a,column:o,from:s,to:c,message:r,severity:i,actions:[]}}function Wt(e,t){var{line:n,column:r,position:a,message:o}=e;return{path:[],line:n,column:r,from:a,to:a,severity:Of.error,message:o,actions:t&&!i()?[{name:`Auto repair`,apply:()=>Dt()}]:void 0}}function Gt(e){return{from:e.from||0,to:e.to||0,message:e.message||``,actions:e.actions,severity:e.severity}}function Kt(e,t,r){var i=_f(e,d(),h()),a=!k(e,Ge),o=Ge;ie(`setCodeMirrorContent`,{isChanged:a,emitChange:t,forceUpdate:r}),se&&(a||r)&&(Ge=e,V(Ye,i),an(K(Ye),m(),K(O))||se.dispatch({changes:{from:0,to:se.state.doc.length,insert:K(n).escapeValue(K(Ye))}}),ct(),a&&t&&tn(Ge,o))}function qt(e){return nh(e)?nt.fromJSON(e):void 0}function Jt(){return Yt.apply(this,arguments)}function Yt(){return Yt=Wa(function*(){ie(`refresh`),yield function(){return Zt.apply(this,arguments)}()}),Yt.apply(this,arguments)}function Xt(){if(se){var e=se?K(n).unescapeValue(se.state.doc.toString()):``,t=e!==K(Ye);if(ie(`onChangeCodeMirrorValue`,{isChanged:t}),t){var r=Ge;V(Ye,e),Ge={text:K(Ye)},ct(),tn(Ge,r),Hs(),nn()}}}function Zt(){return(Zt=Wa(function*(){if(Hs(),se){var e=Vt();return ie(`updateTheme`,{dark:e}),se.dispatch({effects:[Ve.reconfigure(Xe.theme({},{dark:e}))]}),new Promise(e=>setTimeout(e))}return Promise.resolve()})).apply(this,arguments)}function Qt(e){var t=ge.of(typeof e==`number`?` `.repeat(e):e);return e===`	`?[t]:[t,Wx]}Iv({onMount:Cu,onDestroy:wu,getWindow:()=>Yf(K(ce)),hasFocus:()=>St&&document.hasFocus()||Xf(K(ce)),onFocus:E(),onBlur:()=>{en(),ee()()}});var $t=S(Xt,300);function en(){$t.flush()}function tn(e,t){y()&&y()(e,t,{contentErrors:cn(),patchResult:void 0})}function nn(){x()(rn(K(le).selection))}function rn(e){return L({type:Ef.text},e.toJSON())}function an(e,t,n){return!!e&&e.length>t&&!n}var I=B(Hp,!0),on=B(void 0,!0);function sn(){if(an(K(Ye),m(),K(O)))return[];var e=cn();if(im(e)){var{parseError:t,isRepairable:n}=e;return[Gt(Wt(t,n))]}return am(e)?e.validationErrors.map(Ht).map(Gt):[]}function cn(){ie(`validate:start`),en();var e=ln(K(n).escapeValue(K(Ye)),g(),h(),v());return im(e)?(V(I,e.isRepairable?Up:`invalid`),V(on,e.parseError),V(A,[])):(V(I,Hp),V(on,void 0),V(A,e?.validationErrors||[])),ie(`validate:end`),e}var ln=_(Pv);function un(){K(on)&&function(e){ie(`select parse error`,e);var t=Wt(e,!1);Rt(t.from==null?0:t.from,t.to==null?0:t.to),ft()}(K(on))}var dn={icon:_i,text:`Show me`,title:`Move to the parse error location`,onClick:un};W(()=>J(p()),()=>{V(n,Nf({escapeControlCharacters:!1,escapeUnicodeCharacters:p()}))}),W(()=>J(c()),()=>{Kt(c(),!1,!1)}),W(()=>J(l()),()=>{(function(e){if(nh(e)){var t=qt(e);!se||!t||K(le)&&K(le).selection.eq(t)||(ie(`applyExternalSelection`,t),se.dispatch({selection:t}))}})(l())}),W(()=>J(g()),()=>{(function(e){ie(`updateLinter`,e),se&&se.dispatch({effects:P.reconfigure(Bt())})})(g())}),W(()=>J(d()),()=>{(function(e){se&&(ie(`updateIndentation`,e),se.dispatch({effects:je.reconfigure(Qt(e))}))})(d())}),W(()=>J(f()),()=>{(function(e){se&&(ie(`updateTabSize`,e),se.dispatch({effects:Be.reconfigure(ot.tabSize.of(e))}))})(f())}),W(()=>J(i()),()=>{(function(e){se&&(ie(`updateReadOnly`,e),se.dispatch({effects:[Te.reconfigure(ot.readOnly.of(e))]}))})(i())}),W(()=>(K(lt),J(p())),()=>{K(lt)!==p()&&(V(lt,p()),ie(`forceUpdateText`,{escapeUnicodeCharacters:p()}),se&&se.dispatch({changes:{from:0,to:se.state.doc.length,insert:K(n).escapeValue(K(Ye))}}))}),W(()=>(K(I),J(i()),Ai),()=>{V(r,K(I)!==Up||i()?[dn]:[{icon:Ai,text:`Auto repair`,title:`Automatically repair JSON`,onClick:Dt},dn])}),il();var fn={focus:ft,collapse:pt,expand:yt,patch:Ct,handlePatch:wt,openTransformModal:kt,refresh:Jt,flush:en,validate:cn};Sd(!0);var pn,mn=Xx(),hn=H(mn),_n=e=>{var t=z(()=>(K(Ye),q(()=>K(Ye).length===0))),n=z(()=>!K(t)),r=z(()=>!K(t)),a=z(()=>!K(t)),o=z(()=>!K(t)),s=z(()=>!K(t)),c=z(()=>!K(t));(function(e,t){Xo(t,!1);var n=B(void 0,!0),r=$(t,`readOnly`,9,!1),i=$(t,`onExpandAll`,9),a=$(t,`onCollapseAll`,9),o=$(t,`onFormat`,9),s=$(t,`onCompact`,9),c=$(t,`onSort`,9),l=$(t,`onTransform`,9),u=$(t,`onToggleSearch`,9),d=$(t,`onUndo`,9),f=$(t,`onRedo`,9),p=$(t,`canExpandAll`,9),m=$(t,`canCollapseAll`,9),h=$(t,`canUndo`,9),g=$(t,`canRedo`,9),_=$(t,`canFormat`,9),v=$(t,`canCompact`,9),y=$(t,`canSort`,9),b=$(t,`canTransform`,9),x=$(t,`onRenderMenu`,9),S=B(void 0,!0),C=B(void 0,!0),w={type:`button`,icon:gi,title:`Search (Ctrl+F)`,className:`jse-search`,onClick:u()},T=B(void 0,!0);W(()=>(J(i()),J(p())),()=>{V(S,{type:`button`,icon:Zy,title:`Expand all`,className:`jse-expand-all`,onClick:i(),disabled:!p()})}),W(()=>(J(a()),J(m())),()=>{V(C,{type:`button`,icon:Qy,title:`Collapse all`,className:`jse-collapse-all`,onClick:a(),disabled:!m()})}),W(()=>(J(r()),K(S),K(C),J(o()),J(_()),J(s()),J(v()),J(c()),J(y()),J(l()),J(b()),J(d()),J(h()),J(f()),J(g())),()=>{V(T,r()?[K(S),K(C),{type:`separator`},w,{type:`space`}]:[K(S),K(C),{type:`separator`},{type:`button`,icon:$y,title:`Format JSON: add proper indentation and new lines (Ctrl+I)`,className:`jse-format`,onClick:o(),disabled:r()||!_()},{type:`button`,icon:eb,title:`Compact JSON: remove all white spacing and new lines (Ctrl+Shift+I)`,className:`jse-compact`,onClick:s(),disabled:r()||!v()},{type:`separator`},{type:`button`,icon:zi,title:`Sort`,className:`jse-sort`,onClick:c(),disabled:r()||!y()},{type:`button`,icon:pi,title:`Transform contents (filter, sort, project)`,className:`jse-transform`,onClick:l(),disabled:r()||!b()},w,{type:`separator`},{type:`button`,icon:Yi,title:`Undo (Ctrl+Z)`,className:`jse-undo`,onClick:d(),disabled:!h()},{type:`button`,icon:qi,title:`Redo (Ctrl+Shift+Z)`,className:`jse-redo`,onClick:f(),disabled:!g()},{type:`space`}])}),W(()=>(J(x()),K(T)),()=>{V(n,x()(K(T))||K(T))}),il(),Sd(!0),ny(e,{get items(){return K(n)}}),Zo()})(e,{get readOnly(){return i()},onExpandAll:bt,onCollapseAll:xt,onFormat:Tt,onCompact:Et,onSort:Ot,onTransform:At,onToggleSearch:jt,onUndo:Mt,onRedo:Nt,get canExpandAll(){return K(n)},get canCollapseAll(){return K(r)},get canFormat(){return K(a)},get canCompact(){return K(o)},get canSort(){return K(s)},get canTransform(){return K(c)},get canUndo(){return J(u()),q(()=>u().canUndo)},get canRedo(){return J(u()),q(()=>u().canRedo)},get onRenderMenu(){return te()}})};Q(hn,e=>{a()&&e(_n)});var vn=U(hn,2),yn=e=>{var t=Gx(),n=U(H(t),2),r=H(n),i=U(n,2);G(()=>Xu(r,`width: ${K(be)>0?K(M)/K(be)*100:0}%`)),Y(`click`,i,vt),Z(e,t)};Q(vn,e=>{K(ve)&&e(yn)});var bn=U(vn,2),xn=e=>{var t,n=z(()=>(K(Ye),J(m()),K(O),q(()=>an(K(Ye),m(),K(O))))),i=Jx(),a=Kc(i);yd(a,e=>V(D,e),()=>K(D));var s=U(a,2),c=e=>{var t=Kx(),n=Kc(t),r=z(()=>(J(fg),J(m()),K(Ye),q(()=>`The JSON document is larger than ${fg(m())}, and may crash your browser when loading it in text mode. Actual size: ${fg(K(Ye).length)}.`)));zv(n,{get icon(){return Bi},type:`error`,get message(){return K(r)},actions:[{text:`Open anyway`,title:`Open the document in text mode. This may freeze or crash your browser.`,onClick:Pt},{text:`Open in tree mode`,title:`Open the document in tree mode. Tree mode can handle large documents.`,onClick:Ft},{text:`Cancel`,title:`Cancel opening this large document.`,onClick:It}],onClose:ft});var i=H(U(n,2));G(e=>du(i,e),[()=>(J(pp),K(Ye),J(Np),q(()=>pp(K(Ye)||``,Np)))]),Z(e,t)};Q(s,e=>{K(n)&&e(c)});var l=U(s,2),u=e=>{var t=qx(),n=Kc(t),i=e=>{(function(e,t){Xo(t,!1);var n=$(t,`editorState`,8),r=B(),i=B(),a=B(),o=B(),s=B();W(()=>J(n()),()=>{var e;V(r,(e=n())==null||(e=e.selection)==null||(e=e.main)==null?void 0:e.head)}),W(()=>(K(r),J(n())),()=>{var e;V(i,K(r)===void 0||(e=n())==null||(e=e.doc)==null?void 0:e.lineAt(K(r)))}),W(()=>K(i),()=>{V(a,K(i)===void 0?void 0:K(i).number)}),W(()=>(K(i),K(r)),()=>{V(o,K(i)!==void 0&&K(r)!==void 0?K(r)-K(i).from+1:void 0)}),W(()=>J(n()),()=>{var e;V(s,(e=n())==null||(e=e.selection)==null||(e=e.ranges)==null?void 0:e.reduce((e,t)=>e+t.to-t.from,0))}),il(),Sd();var c=Bx(),l=H(c),u=e=>{var t=Lx(),n=H(t);G(()=>du(n,`Line: ${K(a)??``}`)),Z(e,t)};Q(l,e=>{K(a)!==void 0&&e(u)});var d=U(l,2),f=e=>{var t=Rx(),n=H(t);G(()=>du(n,`Column: ${K(o)??``}`)),Z(e,t)};Q(d,e=>{K(o)!==void 0&&e(f)});var p=U(d,2),m=e=>{var t=zx(),n=H(t);G(()=>du(n,`Selection: ${K(s)??``} characters`)),Z(e,t)};Q(p,e=>{K(s)!==void 0&&K(s)>0&&e(m)}),Z(e,c),Zo()})(e,{get editorState(){return K(le)}})};Q(n,e=>{o()&&e(i)});var a=U(n,2),s=e=>{zv(e,{type:`error`,get icon(){return Bi},get message(){return K(on),q(()=>K(on).message)},get actions(){return K(r)},onClick:un,onClose:ft})};Q(a,e=>{K(on)&&e(s)});var c=U(a,2),l=e=>{var t=z(()=>[{icon:$y,text:`Format`,title:`Format JSON: add proper indentation and new lines (Ctrl+I)`,onClick:Tt},{icon:Fi,text:`No thanks`,title:`Close this message`,onClick:()=>V(me,!1)}]);zv(e,{type:`success`,message:`Do you want to format the JSON?`,get actions(){return K(t)},onClose:ft})},u=Sc(()=>(K(on),K(me),J(wf),K(Ye),q(()=>!K(on)&&K(me)&&wf(K(Ye)))));Q(c,e=>{K(u)&&e(l)}),Kv(U(c,2),{get validationErrors(){return K(A)},selectError:Lt}),Z(e,t)};Q(l,e=>{K(n)||e(u)}),G(()=>t=Ju(a,1,`jse-contents svelte-k2b9e6`,null,t,{"jse-hidden":K(n)})),Z(e,i)},Sn=e=>{Z(e,Yx())};return Q(bn,e=>{oe?e(Sn,-1):e(xn)}),yd(mn,e=>V(ce,e),()=>K(ce)),G(()=>pn=Ju(mn,1,`jse-text-mode svelte-k2b9e6`,null,pn,{"no-main-menu":!a()})),Z(e,mn),_d(t,`focus`,ft),_d(t,`collapse`,pt),_d(t,`expand`,yt),_d(t,`patch`,Ct),_d(t,`handlePatch`,wt),_d(t,`openTransformModal`,kt),_d(t,`refresh`,Jt),_d(t,`flush`,en),_d(t,`validate`,cn),Zo(fn)}op(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
.jse-table-mode.svelte-1p86y3c .jse-contents.jse-contents-loading:where(.svelte-1p86y3c) .jse-loading:where(.svelte-1p86y3c) {
  ...
  font-family: var(--jse-font-family, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen-Sans, Ubuntu, Cantarell, "Helvetica Neue", sans-serif);
  font-size: var(--jse-font-size, 16px);
}`);var sS=X(`<div class="jse-table-root-error svelte-1p86y3c"><!></div>`),cS=X(`<th class="jse-table-cell jse-table-cell-header svelte-1p86y3c"><!></th>`),lS=X(`<th class="jse-table-cell jse-table-cell-header svelte-1p86y3c"><!></th>`),uS=X(`<th class="jse-table-cell jse-table-cell-gutter svelte-1p86y3c"> <!></th>`),dS=X(`<div class="jse-context-menu-anchor svelte-1p86y3c"><!></div>`),fS=X(`<td class="jse-table-cell svelte-1p86y3c"><div><!><!></div> <!></td>`),pS=X(`<td class="jse-table-cell svelte-1p86y3c"></td>`),mS=X(`<tr class="jse-table-row svelte-1p86y3c"><!><!><!></tr>`),hS=X(`<div class="jse-search-box-container svelte-1p86y3c"><!></div> <div class="jse-contents svelte-1p86y3c"><table class="jse-table-main svelte-1p86y3c"><tbody><tr class="jse-table-row jse-table-row-header svelte-1p86y3c"><th class="jse-table-cell jse-table-cell-header svelte-1p86y3c"><!></th><!><!></tr><tr><td class="svelte-1p86y3c"></td></tr><!><tr class="jse-table-invisible-end-section svelte-1p86y3c"><td class="svelte-1p86y3c"></td></tr></tbody></table></div> <!> <!> <!> <!>`,1),gS=X(`<!> <!>`,1),_S=X(`<label class="jse-hidden-input-label svelte-1p86y3c"><input type="text" tabindex="-1" class="jse-hidden-input svelte-1p86y3c"/></label> <!>`,1),vS=X(`<div class="jse-contents jse-contents-loading svelte-1p86y3c"><div class="jse-loading-space svelte-1p86y3c"></div> <div class="jse-loading svelte-1p86y3c">loading...</div></div>`),yS=X(`<div role="table"><!> <!></div> <!> <!>`,1);function bS(e,t){Xo(t,!1);var n=B(void 0,!0),r=B(void 0,!0),i=B(void 0,!0),a=Ad(`jsoneditor:TableMode`),{openAbsolutePopup:o,closeAbsolutePopup:s}=Yo(`absolute-popup`),c=Ov(),l=Ut(),u=Ut(),d=typeof window>`u`;a(`isSSR:`,d);var f=$(t,`readOnly`,9),p=$(t,`externalContent`,9),m=$(t,`externalSelection`,9),h=$(t,`history`,9),g=$(t,`truncateTextSize`,9),v=$(t,`mainMenuBar`,9),y=$(t,`escapeControlCharacters`,9),b=$(t,`escapeUnicodeCharacters`,9),x=$(t,`flattenColumns`,9),S=$(t,`parser`,9),C=$(t,`parseMemoizeOne`,9),w=$(t,`validator`,9),T=$(t,`validationParser`,9),E=$(t,`indentation`,9),ee=$(t,`onChange`,9),te=$(t,`onChangeMode`,9),ne=$(t,`onSelect`,9),re=$(t,`onUndo`,9),ie=$(t,`onRedo`,9),ae=$(t,`onRenderValue`,9),oe=$(t,`onRenderMenu`,9),se=$(t,`onRenderContextMenu`,9),D=$(t,`onFocus`,9),ce=$(t,`onBlur`,9),le=$(t,`onSortModal`,9),O=$(t,`onTransformModal`,9),ue=$(t,`onJSONEditorModal`,9),de=B(void 0,!0),fe=B(void 0,!0),pe=B(void 0,!0),me=B(void 0,!0),he=B(void 0,!0);Iv({onMount:Cu,onDestroy:wu,getWindow:()=>Yf(K(fe)),hasFocus:()=>De&&document.hasFocus()||Xf(K(fe)),onFocus:()=>{Oe=!0,D()&&D()()},onBlur:()=>{Oe=!1,ce()&&ce()()}});var ge,A=B(void 0,!0),_e=B(void 0,!0),ve=B(void 0,!0),j=B(void 0,!0),M=B(void 0,!0),ye=B(void 0,!0),be=B(!1,!0),N=B(!1,!0);function P(e){V(ye,(ge=e)?cg(K(A),ge.items):void 0)}function xe(e){return Se.apply(this,arguments)}function Se(){return(Se=Wa(function*(e){V(F,void 0),yield nt(e)})).apply(this,arguments)}function Ce(){V(be,!1),V(N,!1),Qe()}var we=B(1e4,!0),Te=B([],!0),Ee=B(void 0,!0),De=!1,Oe=!1,ke=B(!1,!0),Ae=B({},!0),je=B(600,!0),Me=B(0,!0),Ne=18;function Pe(e){V(F,e)}function Fe(e){K(F)&&e!==void 0&&(dn(e,Nh(K(F)))&&dn(e,Mh(K(F)))||(a(`clearing selection: path does not exist anymore`,K(F)),V(F,void 0)))}var Ie=B(K(A)===void 0?void 0:_m({json:K(A)}),!0),F=B(th(m())?m():void 0,!0),Le=B(void 0,!0),Re=B(!1,!0);function ze(e){if(!f()){a(`onSortByHeader`,e);var t=e.sortDirection===Af.desc?-1:1;qe(ib(K(A),[],e.path,t),(t,n)=>({state:n,sortedColumn:e}))}}Cu(()=>{K(F)&&it(Mh(K(F)))});var Be=B(void 0,!0);function Ve(e){if(e.json!==void 0||e.text!==void 0){var t=K(A)!==void 0&&e.json!==void 0;h().add({type:`tree`,undo:{patch:t?[{op:`replace`,path:``,value:e.json}]:void 0,json:e.json,text:e.text,documentState:e.documentState,textIsRepaired:e.textIsRepaired,selection:hh(e.selection),sortedColumn:e.sortedColumn},redo:{patch:t?[{op:`replace`,path:``,value:K(A)}]:void 0,json:K(A),text:K(_e),documentState:K(Ie),textIsRepaired:K(Re),selection:hh(K(F)),sortedColumn:K(Le)}})}}var He=B([],!0),Ue=_(Nv);function We(e,t,n,r){kv(()=>{var i;try{i=Ue(e,t,n,r)}catch(e){i=[{path:[],message:`Failed to validate: `+e.message,severity:Of.warning}]}k(i,K(He))||(a(`validationErrors changed:`,i),V(He,i))},e=>a(`validationErrors updated in ${e} ms`))}function Ge(){return a(`validate`),K(ve)?{parseError:K(ve),isRepairable:!1}:(We(K(A),w(),S(),T()),Dt(K(He))?void 0:{validationErrors:K(He)})}function Ke(e,t){if(a(`patch`,e,t),K(A)===void 0)throw Error(`Cannot apply patch: no JSON`);var n=K(A),r={json:void 0,text:K(_e),documentState:K(Ie),selection:hh(K(F)),sortedColumn:K(Le),textIsRepaired:K(Re)},i=Yh(K(A),e),o=km(K(A),K(Ie),e),s=Fb(K(Le),e,K(Te)),c=typeof t==`function`?t(o.json,o.documentState,K(F)):void 0;return V(A,c?.json===void 0?o.json:c.json),V(Ie,c?.state===void 0?o.documentState:c.state),V(F,c?.selection===void 0?K(F):c.selection),V(Le,c?.sortedColumn===void 0?s:c.sortedColumn),V(_e,void 0),V(Re,!1),V(j,void 0),V(M,void 0),V(ve,void 0),h().add({type:`tree`,undo:L({patch:i},r),redo:{patch:e,json:void 0,text:void 0,documentState:K(Ie),selection:hh(K(F)),sortedColumn:K(Le),textIsRepaired:K(Re)}}),{json:K(A),previousJson:n,undo:i,redo:e}}function qe(e,t){a(`handlePatch`,e,t);var n={json:K(A),text:K(_e)},r=Ke(e,t);return Je(n,r),r}function Je(e,t){if((e.json!==void 0||e?.text!==void 0)&&ee()){if(K(_e)!==void 0){var n={text:K(_e),json:void 0};ee()(n,e,{contentErrors:Ge(),patchResult:t})}else if(K(A)!==void 0){var r={text:void 0,json:K(A)};ee()(r,e,{contentErrors:Ge(),patchResult:t})}}}function Ye(e){a(`pasted json as text`,e),V(j,e)}function Xe(e){a(`pasted multiline text`,{pastedText:e}),V(M,e)}function Ze(e){var t=parseInt(e[0],10),n=[String(t+1),...e.slice(1)];return dn(K(A),n)?vh(n):vh(e)}function Qe(){a(`focus`),K(me)&&(K(me).focus(),K(me).select())}function $e(e){V(Me,e.target.scrollTop)}function et(){K(F)||V(F,function(){if(Wt(K(A))&&!Dt(K(A))&&!Dt(K(Te)))return vh([`0`,...K(Te)[0]])}())}function tt(){if(K(Re)&&K(A)!==void 0){var e={json:K(A),text:K(_e)},t={json:K(A),documentState:K(Ie),selection:K(F),sortedColumn:K(Le),text:K(_e),textIsRepaired:K(Re)};V(_e,void 0),V(Re,!1),Fe(K(A)),Ve(t),Je(e,void 0)}return{json:K(A),text:K(_e)}}function nt(e){var{scrollToWhenVisible:t=!0}=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=K(be)?Kp:0,r=kb(e,K(Te),Ae,Ne),i=r-K(Me)+n+Ne,o=at(e);if(a(`scrollTo`,{path:e,top:r,scrollTop:K(Me),elem:o}),!K(pe))return Promise.resolve();var s=K(pe).getBoundingClientRect();if(o&&!t){var l=o.getBoundingClientRect();if(l.bottom>s.top&&l.top<s.bottom)return Promise.resolve()}var u=-Math.max(n+2*Ne,s.height/4);return new Promise(o?t=>{c(o,{container:K(pe),offset:u,duration:300,callback:()=>{rt(e),t()}})}:t=>{c(i,{container:K(pe),offset:u,duration:300,callback:()=>{Hs(),rt(e),t()}})})}function rt(e){var t=at(e);if(t&&K(pe)){var n=K(pe).getBoundingClientRect(),r=t.getBoundingClientRect();if(r.right>n.right){var i=r.right-n.right;Fc(pe,K(pe).scrollLeft+=i)}if(r.left<n.left){var a=n.left-r.left;Fc(pe,K(pe).scrollLeft-=a)}}}function it(e){(function(e){if(K(pe)){var{rowIndex:t}=Ab(e,K(Te)),n=kb(e,K(Te),Ae,Ne),r=n+(Ae[t]||Ne),i=Ne,a=K(pe).getBoundingClientRect(),o=K(Me),s=K(Me)+a.height-i;if(r>s){var c=r-s;Fc(pe,K(pe).scrollTop+=c)}if(n<o){var l=o-n;Fc(pe,K(pe).scrollTop-=l)}}})(e),rt(e)}function at(e){var t=K(Te).find(t=>mh(e.slice(1),t)),n=t?e.slice(0,1).concat(t):e;return K(pe)?.querySelector(`td[data-path="${$f(n)}"]`)??void 0}function ot(e){var{anchor:t,left:n,top:r,width:i,height:a,offsetTop:c,offsetLeft:l,showTip:u}=e,d=function(e){var{json:t,documentState:n,selection:r,readOnly:i,onEditValue:a,onEditRow:o,onToggleEnforceString:s,onCut:c,onCopy:l,onPaste:u,onRemove:d,onDuplicateRow:f,onInsertBeforeRow:p,onInsertAfterRow:m,onRemoveRow:h}=e,g=t!==void 0,_=!!r,v=t!==void 0&&r?I(t,Mh(r)):void 0,y=g&&($m(r)||Zm(r)||Qm(r)),b=!i&&g&&r!==void 0&&fh(r),x=b&&!zd(v),S=!i&&y,C=r!==void 0&&Rm(t,n,Mh(r));return[{type:`separator`},{type:`row`,items:[{type:`column`,items:[{type:`label`,text:`Table cell:`},{type:`dropdown-button`,main:{type:`button`,onClick:()=>a(),icon:Ii,text:`Edit`,title:`Edit the value (Double-click on the value)`,disabled:!b},width:`11em`,items:[{type:`button`,icon:Ii,text:`Edit`,title:`Edit the value (Double-click on the value)`,onClick:()=>a(),disabled:!b},{type:`button`,icon:C?wi:Xi,text:`Enforce string`,title:`Enforce keeping the value as string when it contains a numeric value`,onClick:()=>s(),disabled:!x}]},{type:`dropdown-button`,main:{type:`button`,onClick:()=>c(!0),icon:Vi,text:`Cut`,title:`Cut selected contents, formatted with indentation (Ctrl+X)`,disabled:!S},width:`10em`,items:[{type:`button`,icon:Vi,text:`Cut formatted`,title:`Cut selected contents, formatted with indentation (Ctrl+X)`,onClick:()=>c(!0),disabled:i||!y},{type:`button`,icon:Vi,text:`Cut compacted`,title:`Cut selected contents, without indentation (Ctrl+Shift+X)`,onClick:()=>c(!1),disabled:i||!y}]},{type:`dropdown-button`,main:{type:`button`,onClick:()=>l(!0),icon:Ki,text:`Copy`,title:`Copy selected contents, formatted with indentation (Ctrl+C)`,disabled:!y},width:`12em`,items:[{type:`button`,icon:Ki,text:`Copy formatted`,title:`Copy selected contents, formatted with indentation (Ctrl+C)`,onClick:()=>l(!1),disabled:!y},{type:`button`,icon:Ki,text:`Copy compacted`,title:`Copy selected contents, without indentation (Ctrl+Shift+C)`,onClick:()=>l(!1),disabled:!y}]},{type:`button`,onClick:()=>u(),icon:di,text:`Paste`,title:`Paste clipboard contents (Ctrl+V)`,disabled:i||!_},{type:`button`,onClick:()=>d(),icon:ji,text:`Remove`,title:`Remove selected contents (Delete)`,disabled:i||!y}]},{type:`column`,items:[{type:`label`,text:`Table row:`},{type:`button`,onClick:()=>o(),icon:Ii,text:`Edit row`,title:`Edit the current row`,disabled:i||!_||!g},{type:`button`,onClick:()=>f(),icon:Ci,text:`Duplicate row`,title:`Duplicate the current row (Ctrl+D)`,disabled:i||!_||!g},{type:`button`,onClick:()=>p(),icon:Gi,text:`Insert before`,title:`Insert a row before the current row`,disabled:i||!_||!g},{type:`button`,onClick:()=>m(),icon:Gi,text:`Insert after`,title:`Insert a row after the current row`,disabled:i||!_||!g},{type:`button`,onClick:()=>h(),icon:ji,text:`Remove row`,title:`Remove current row`,disabled:i||!_||!g}]}]}]}({json:K(A),documentState:K(Ie),selection:K(F),readOnly:f(),onEditValue:lt,onEditRow:ut,onToggleEnforceString:dt,onCut:xt,onCopy:wt,onPaste:mt,onRemove:Et,onDuplicateRow:kt,onInsertBeforeRow:At,onInsertAfterRow:jt,onRemoveRow:Mt}),p=se()(d)??d;if(!1!==p){var m={left:n,top:r,offsetTop:c,offsetLeft:l,width:i,height:a,anchor:t,closeOnOuterClick:!0,onClose:()=>{De=!1,Qe()}};De=!0;var h=o(lx,{tip:u?`Tip: you can open this context menu via right-click or with Ctrl+Q`:void 0,items:p,onRequestClose(){s(h),Qe()}},m)}}function st(e){if(!wh(K(F)))if(e&&(e.stopPropagation(),e.preventDefault()),e&&e.type===`contextmenu`&&e.target!==K(me))ot({left:e.clientX,top:e.clientY,width:Gp,height:Wp,showTip:!1});else{var t=K(pe)?.querySelector(`.jse-table-cell.jse-selected-value`);if(t)ot({anchor:t,offsetTop:2,width:Gp,height:Wp,showTip:!1});else{var n=K(pe)?.getBoundingClientRect();n&&ot({top:n.top+2,left:n.left+2,width:Gp,height:Wp,showTip:!1})}}}function ct(e){ot({anchor:Zf(e.target,`BUTTON`),offsetTop:0,width:Gp,height:Wp,showTip:!0})}function lt(){if(!f()&&K(F)){var e=Mh(K(F));zd(I(K(A),e))?Bt(e):V(F,vh(e))}}function ut(){!f()&&K(F)&&Bt(Mh(K(F)).slice(0,1))}function dt(){if(!f()&&Qm(K(F))){var e=K(F).path,t=pn(e),n=I(K(A),e),r=!Rm(K(A),K(Ie),e),i=r?String(n):Jd(String(n),S());a(`handleToggleEnforceString`,{enforceString:r,value:n,updatedValue:i}),qe([{op:`replace`,path:t,value:i}],(t,n)=>({state:Nm(K(A),n,e,{type:`value`,enforceString:r})}))}}function ft(){return pt.apply(this,arguments)}function pt(){return(pt=Wa(function*(){if(a(`apply pasted json`,K(j)),K(j)){var{onPasteAsJson:e}=K(j);e(),setTimeout(Qe)}})).apply(this,arguments)}function mt(){return ht.apply(this,arguments)}function ht(){return(ht=Wa(function*(){try{Ft(yield navigator.clipboard.readText())}catch(e){console.error(e),V(ke,!0)}})).apply(this,arguments)}function gt(){return _t.apply(this,arguments)}function _t(){return(_t=Wa(function*(){a(`apply pasted multiline text`,K(M)),K(M)&&(Ft(JSON.stringify(K(M))),setTimeout(Qe))})).apply(this,arguments)}function vt(){a(`clear pasted json`),V(j,void 0),Qe()}function yt(){a(`clear pasted multiline text`),V(M,void 0),Qe()}function bt(){te()(Tf.text)}function xt(e){return St.apply(this,arguments)}function St(){return(St=Wa(function*(e){yield Lb({json:K(A),selection:K(F),indentation:e?E():void 0,readOnly:f(),parser:S(),onPatch:qe})})).apply(this,arguments)}function wt(){return Tt.apply(this,arguments)}function Tt(){return Tt=Wa(function*(){var e=!(arguments.length>0&&arguments[0]!==void 0)||arguments[0];K(A)!==void 0&&(yield zb({json:K(A),selection:K(F),indentation:e?E():void 0,parser:S()}))}),Tt.apply(this,arguments)}function Et(){Hb({json:K(A),text:K(_e),selection:K(F),keepSelection:!0,readOnly:f(),onChange:ee(),onPatch:qe})}function Ot(e){f()||(a(`extract`,{path:e}),qe(Uh(K(A),vh(e))))}function kt(){(function(e){var{json:t,selection:n,columns:r,readOnly:i,onPatch:a}=e;if(!i&&t!==void 0&&n&&Th(n)){var{rowIndex:o,columnIndex:s}=Ab(Mh(n),r);Ib(`duplicate row`,{rowIndex:o}),a(Hh(t,[[String(o)]]),(e,n)=>({state:n,selection:vh(jb({rowIndex:o<t.length?o+1:o,columnIndex:s},r))}))}})({json:K(A),selection:K(F),columns:K(Te),readOnly:f(),onPatch:qe})}function At(){(function(e){var{json:t,selection:n,columns:r,readOnly:i,onPatch:a}=e;if(!i&&t!==void 0&&n&&Th(n)){var{rowIndex:o}=Ab(Mh(n),r);Ib(`insert before row`,{rowIndex:o}),a(zh(t,[String(o)],[{key:``,value:Gt(t[0])?{}:``}]))}})({json:K(A),selection:K(F),columns:K(Te),readOnly:f(),onPatch:qe})}function jt(){(function(e){var{json:t,selection:n,columns:r,readOnly:i,onPatch:a}=e;if(!i&&t!==void 0&&n&&Th(n)){var{rowIndex:o,columnIndex:s}=Ab(Mh(n),r);Ib(`insert after row`,{rowIndex:o});var c=o+1,l=[String(c)],u=[{key:``,value:Gt(t[0])?{}:``}];a(c<t.length?zh(t,l,u):Bh(t,[],u),(e,t)=>({state:t,selection:vh(jb({rowIndex:c,columnIndex:s},r))}))}})({json:K(A),selection:K(F),columns:K(Te),readOnly:f(),onPatch:qe})}function Mt(){(function(e){var{json:t,selection:n,columns:r,readOnly:i,onPatch:a}=e;if(!i&&t!==void 0&&n&&Th(n)){var{rowIndex:o,columnIndex:s}=Ab(Mh(n),r);Ib(`remove row`,{rowIndex:o}),a(Gh([[String(o)]]),(e,t)=>{var n=o<e.length?o:o>0?o-1:void 0,i=n===void 0?void 0:vh(jb({rowIndex:n,columnIndex:s},r));return Ib(`remove row new selection`,{rowIndex:o,newRowIndex:n,newSelection:i}),{state:t,selection:i}})}})({json:K(A),selection:K(F),columns:K(Te),readOnly:f(),onPatch:qe})}function Nt(){return(Nt=Wa(function*(e){yield Wb({char:e,selectInside:!1,json:K(A),selection:K(F),readOnly:f(),parser:S(),onPatch:qe,onReplaceJson:It,onSelect:Pe})})).apply(this,arguments)}function Pt(e){e.preventDefault(),Ft(e.clipboardData?.getData(`text/plain`))}function Ft(e){e!==void 0&&Vb({clipboardText:e,json:K(A),selection:K(F),readOnly:f(),parser:S(),onPatch:qe,onChangeText:Lt,onPasteMultilineText:Xe,openRepairModal:Vt})}function It(e,t){var n={json:K(A),text:K(_e)},r={json:K(A),documentState:K(Ie),selection:K(F),sortedColumn:K(Le),text:K(_e),textIsRepaired:K(Re)},i=Sm(e,K(Ie)),a=typeof t==`function`?t(e,i,K(F)):void 0;V(A,a?.json===void 0?e:a.json),V(Ie,a?.state===void 0?i:a.state),V(F,a?.selection===void 0?K(F):a.selection),V(Le,void 0),V(_e,void 0),V(Re,!1),V(ve,void 0),Fe(K(A)),Ve(r),Je(n,void 0)}function Lt(e,t){a(`handleChangeText`);var n={json:K(A),text:K(_e)},r={json:K(A),documentState:K(Ie),selection:K(F),sortedColumn:K(Le),text:K(_e),textIsRepaired:K(Re)};try{V(A,C()(e)),V(Ie,Sm(K(A),K(Ie))),V(_e,void 0),V(Re,!1),V(ve,void 0)}catch(t){try{V(A,C()(br(e))),V(Ie,Sm(K(A),K(Ie))),V(_e,e),V(Re,!0),V(ve,void 0)}catch{V(A,void 0),V(Ie,void 0),V(_e,e),V(Re,!1),V(ve,K(_e)===``?void 0:uf(K(_e),t.message||String(t)))}}if(typeof t==`function`){var i=t(K(A),K(Ie),K(F));V(A,i?.json===void 0?K(A):i.json),V(Ie,i?.state===void 0?K(Ie):i.state),V(F,i?.selection===void 0?K(F):i.selection)}Fe(K(A)),Ve(r),Je(n,void 0)}function Rt(e){a(`select validation error`,e),V(F,vh(e.path)),nt(e.path)}function zt(e){if(K(A)!==void 0){var{id:t,onTransform:n,onClose:r}=e,i=e.rootPath||[];De=!0,O()({id:t||u,json:K(A),rootPath:i||[],onTransform:e=>{n?n({operations:e,json:K(A),transformedJson:gn(K(A),e)}):(a(`onTransform`,i,e),qe(e))},onClose:()=>{De=!1,setTimeout(Qe),r&&r()}})}}function Bt(e){a(`openJSONEditorModal`,{path:e}),De=!0,ue()({content:{json:I(K(A),e)},path:e,onPatch:qe,onClose:()=>{De=!1,setTimeout(Qe)}})}function Vt(e,t){V(he,{text:e,onParse:e=>sf(e,e=>af(e,S())),onRepair:cf,onApply:t,onClose:Qe})}function Ht(){(function(e){f()||K(A)===void 0||(De=!0,le()({id:l,json:K(A),rootPath:e,onSort:t=>{var{operations:n,itemPath:r,direction:i}=t;a(`onSort`,n,e,r,i),qe(n,(e,t)=>({state:t,sortedColumn:{path:r,sortDirection:i===-1?Af.desc:Af.asc}}))},onClose:()=>{De=!1,setTimeout(Qe)}}))})([])}function Kt(){zt({rootPath:[]})}function qt(e){a(`openFind`,{findAndReplace:e}),V(be,!1),V(N,!1),Hs(),V(be,!0),V(N,e)}function Yt(){if(!f()&&h().canUndo){var e=h().undo();if(mm(e)){var t={json:K(A),text:K(_e)};V(A,e.undo.patch?gn(K(A),e.undo.patch):e.undo.json),V(Ie,e.undo.documentState),V(F,e.undo.selection),V(Le,e.undo.sortedColumn),V(_e,e.undo.text),V(Re,e.undo.textIsRepaired),V(ve,void 0),a(`undo`,{item:e,json:K(A)}),Je(t,e.undo.patch&&e.redo.patch?{json:K(A),previousJson:t.json,redo:e.undo.patch,undo:e.redo.patch}:void 0),Qe(),K(F)&&nt(Mh(K(F)),{scrollToWhenVisible:!1})}else re()(e)}}function Xt(){if(!f()&&h().canRedo){var e=h().redo();if(mm(e)){var t={json:K(A),text:K(_e)};V(A,e.redo.patch?gn(K(A),e.redo.patch):e.redo.json),V(Ie,e.redo.documentState),V(F,e.redo.selection),V(Le,e.redo.sortedColumn),V(_e,e.redo.text),V(Re,e.redo.textIsRepaired),V(ve,void 0),a(`redo`,{item:e,json:K(A)}),Je(t,e.undo.patch&&e.redo.patch?{json:K(A),previousJson:t.json,redo:e.redo.patch,undo:e.undo.patch}:void 0),Qe(),K(F)&&nt(Mh(K(F)),{scrollToWhenVisible:!1})}else ie()(e)}}function Zt(e){V(je,e.getBoundingClientRect().height)}W(()=>(J(y()),J(b())),()=>{V(de,Nf({escapeControlCharacters:y(),escapeUnicodeCharacters:b()}))}),W(()=>K(be),()=>{(function(e){if(K(pe)){var t=e?Kp:-100;K(pe).scrollTo({top:Fc(pe,K(pe).scrollTop+=t),left:K(pe).scrollLeft})}})(K(be))}),W(()=>J(p()),()=>{(function(e){var t={json:K(A)},n=pf(e)?e.text!==K(_e):!k(t.json,e.json);if(a(`update external content`,{isChanged:n}),n){var r={json:K(A),documentState:K(Ie),selection:K(F),sortedColumn:K(Le),text:K(_e),textIsRepaired:K(Re)};if(pf(e))try{V(A,C()(e.text)),V(Ie,Sm(K(A),K(Ie))),V(_e,e.text),V(Re,!1),V(ve,void 0)}catch(t){try{V(A,C()(br(e.text))),V(Ie,Sm(K(A),K(Ie))),V(_e,e.text),V(Re,!0),V(ve,void 0)}catch{V(A,void 0),V(Ie,void 0),V(_e,e.text),V(Re,!1),V(ve,K(_e)===``?void 0:uf(K(_e),t.message||String(t)))}}else V(A,e.json),V(Ie,Sm(K(A),K(Ie))),V(_e,void 0),V(Re,!1),V(ve,void 0);Fe(K(A)),V(Le,void 0),Ve(r)}})(p())}),W(()=>J(m()),()=>{(function(e){k(K(F),e)||(a(`applyExternalSelection`,{selection:K(F),externalSelection:e}),th(e)&&V(F,e))})(m())}),W(()=>(K(Te),K(A),J(x()),K(we)),()=>{V(Te,Wt(K(A))?function(e,t){var n=new Set(t.map(pn)),r=new Set(e.map(pn));for(var i of n)r.has(i)||n.delete(i);for(var a of r)n.has(a)||n.add(a);return[...n].map(fn)}(Tb(K(A),x(),K(we)),K(Te)):[])}),W(()=>(K(A),K(Te)),()=>{V(Ee,!(!K(A)||Dt(K(Te))))}),W(()=>(K(A),K(we)),()=>{V(n,Array.isArray(K(A))&&K(A).length>K(we))}),W(()=>(K(Me),K(je),K(A),K(be),Kp),()=>{V(r,Ob(K(Me),K(je),K(A),Ae,Ne,K(be)?Kp:0))}),W(()=>K(A),()=>{K(A),K(pe)&&K(pe).scrollTo({top:K(pe).scrollTop,left:K(pe).scrollLeft})}),W(()=>K(F),()=>{var e=K(F);k(e,m())||(a(`onSelect`,e),ne()(e))}),W(()=>(J(f()),J(g()),J(S()),K(de),K(A),K(Ie),J(ae())),()=>{V(Be,{mode:Tf.table,readOnly:f(),truncateTextSize:g(),parser:S(),normalization:K(de),getJson:()=>K(A),getDocumentState:()=>K(Ie),findElement:at,findNextInside:Ze,focus:Qe,onPatch:(e,t)=>qe(function(e,t){return e.flatMap(e=>{if(Jt(e)){var n=fn(e.path);if(n.length>0){for(var r=[e],i=Ct(n);i.length>0&&!dn(t,i);)r.unshift({op:`add`,path:pn(i),value:{}}),i=Ct(i);return r}}return e})}(e,K(A)),t),onSelect:Pe,onFind:qt,onPasteJson:Ye,onRenderValue:ae()})}),W(()=>(K(A),J(w()),J(S()),J(T())),()=>{We(K(A),w(),S(),T())}),W(()=>(K(He),K(Te)),()=>{V(i,Mb(K(He),K(Te)))}),il();var Qt={validate:Ge,patch:Ke,focus:Qe,acceptAutoRepair:tt,scrollTo:nt,findElement:at,openTransformModal:zt};Sd(!0);var $t=yS();Y(`mousedown`,Ec,function(e){!qf(e.target,e=>e===K(fe))&&wh(K(F))&&(a(`click outside the editor, exit edit mode`),V(F,hh(K(F))),Oe&&K(me)&&(K(me).focus(),K(me).blur()),a(`blur (outside editor)`),K(me)&&K(me).blur())});var en,tn=Kc($t),nn=H(tn),rn=e=>{(function(e,t){Xo(t,!1);var n=$(t,`containsValidArray`,9),r=$(t,`readOnly`,9),i=$(t,`showSearch`,13,!1),a=$(t,`history`,9),o=$(t,`onSort`,9),s=$(t,`onTransform`,9),c=$(t,`onContextMenu`,9),l=$(t,`onUndo`,9),u=$(t,`onRedo`,9),d=$(t,`onRenderMenu`,9);function f(){i(!i())}var p=B(void 0,!0),m=B(void 0,!0);W(()=>(J(r()),J(o()),J(n()),J(s()),J(c()),J(l()),J(a()),J(u())),()=>{V(p,r()?[{type:`space`}]:[{type:`button`,icon:zi,title:`Sort`,className:`jse-sort`,onClick:o(),disabled:r()||!n()},{type:`button`,icon:pi,title:`Transform contents (filter, sort, project)`,className:`jse-transform`,onClick:s(),disabled:r()||!n()},{type:`button`,icon:gi,title:`Search (Ctrl+F)`,className:`jse-search`,onClick:f,disabled:!n()},{type:`button`,icon:xi,title:Rp,className:`jse-contextmenu`,onClick:c()},{type:`separator`},{type:`button`,icon:Yi,title:`Undo (Ctrl+Z)`,className:`jse-undo`,onClick:l(),disabled:!a().canUndo},{type:`button`,icon:qi,title:`Redo (Ctrl+Shift+Z)`,className:`jse-redo`,onClick:u(),disabled:!a().canRedo},{type:`space`}])}),W(()=>(J(d()),K(p)),()=>{V(m,d()(K(p))||K(p))}),il(),Sd(!0),ny(e,{get items(){return K(m)}}),Zo()})(e,{get containsValidArray(){return K(Ee)},get readOnly(){return f()},get history(){return h()},onSort:Ht,onTransform:Kt,onUndo:Yt,onRedo:Xt,onContextMenu:ct,get onRenderMenu(){return oe()},get showSearch(){return K(be)},set showSearch(e){V(be,e)},$$legacy:!0})};Q(nn,e=>{v()&&e(rn)});var an=U(nn,2),on=e=>{var t=_S(),a=Kc(t),o=H(a);o.readOnly=!0,yd(o,e=>V(me,e),()=>K(me));var s=U(a,2),c=e=>{var t=hS(),a=Kc(t);Cb(H(a),{get json(){return K(A)},get documentState(){return K(Ie)},get parser(){return S()},get showSearch(){return K(be)},get showReplace(){return K(N)},get readOnly(){return f()},get columns(){return K(Te)},onSearch:P,onFocus:xe,onPatch:qe,onClose:Ce});var o=U(a,2),s=H(H(H(o))),c=H(s),l=H(c),u=e=>{var t=z(()=>(J(Nb),K(i),q(()=>Nb([],K(i)?.root)))),n=ou(),r=Kc(n),a=e=>{var n=sS();yy(H(n),{get validationError(){return K(t)},get onExpand(){return jx}}),Z(e,n)};Q(r,e=>{K(t)&&e(a)}),Z(e,n)},d=Sc(()=>(J(Dt),K(i),q(()=>!Dt(K(i)?.root))));Q(l,e=>{K(d)&&e(u)});var p=U(c);Nu(p,1,()=>K(Te),ju,(e,t)=>{var n=cS();(function(e,t){Xo(t,!1);var n=B(void 0,!0),r=B(void 0,!0),i=B(void 0,!0),a=$(t,`path`,9),o=$(t,`sortedColumn`,9),s=$(t,`readOnly`,9),c=$(t,`onSort`,9);W(()=>(J(a()),Cg),()=>{V(n,Dt(a())?`values`:Cg(a()))}),W(()=>(J(o()),J(a())),()=>{V(r,o()&&k(a(),o()?.path)?o().sortDirection:void 0)}),W(()=>(K(r),qp),()=>{V(i,K(r)?qp[K(r)]:void 0)}),il(),Sd(!0);var l,u=eS(),d=H(u),f=H(d),p=U(d,2),m=e=>{var t=$x(),n=H(t),a=z(()=>(K(r),J(Af),J(Ji),J(Ui),q(()=>K(r)===Af.asc?Ji:Ui)));Cp(n,{get data(){return K(a)}}),G(()=>cd(t,`title`,`Currently sorted in ${K(i)} order`)),Z(e,t)};Q(p,e=>{K(r)!==void 0&&e(m)}),G(e=>{l=Ju(u,1,`jse-column-header svelte-5pxwfq`,null,l,{"jse-readonly":s()}),cd(u,`title`,s()?K(n):K(n)+` (Click to sort the data by this column)`),du(f,e)},[()=>(J(pp),K(n),J(50),q(()=>pp(K(n),50)))]),Y(`click`,u,function(){s()||c()({path:a(),sortDirection:K(r)===Af.asc?Af.desc:Af.asc})}),Z(e,u),Zo()})(H(n),{get path(){return K(t)},get sortedColumn(){return K(Le)},get readOnly(){return f()},onSort:ze}),Z(e,n)});var m=U(p),h=e=>{var t=lS(),n=H(t),r=z(()=>(K(A),q(()=>Array.isArray(K(A))?K(A).length:0)));(function(e,t){Xo(t,!1);var n=$(t,`count`,9),r=$(t,`maxSampleCount`,9),i=$(t,`readOnly`,9),a=$(t,`onRefresh`,9);Sd(!0);var o,s=oS();Cp(H(s),{get data(){return ui}}),G(()=>{o=Ju(s,1,`jse-column-header svelte-1wgrwv3`,null,o,{"jse-readonly":i()}),cd(s,`title`,`The Columns are created by sampling ${r()} items out of ${n()}. If you're missing a column, click here to sample all of the items instead of a subset. This is slower.`)}),Y(`click`,s,()=>a()()),Z(e,s),Zo()})(n,{get count(){return K(r)},get maxSampleCount(){return K(we)},get readOnly(){return f()},onRefresh:()=>V(we,1/0)}),Z(e,t)};Q(m,e=>{K(n)&&e(h)});var g,_,v=U(s),y=H(v),b=U(v);Nu(b,1,()=>(K(r),q(()=>K(r).visibleItems)),ju,(e,t,a)=>{var o=z(()=>(K(r),q(()=>K(r).startIndex+a))),s=z(()=>(K(i),J(K(o)),q(()=>K(i).rows[K(o)]))),c=z(()=>(J(Nb),J(K(o)),J(K(s)),q(()=>Nb([String(K(o))],K(s)?.row)))),l=z(()=>(J(jm),K(A),K(ye),J(K(o)),q(()=>jm(K(A),K(ye),[String(K(o))])))),u=mS(),d=H(u);Au(d,()=>K(o),e=>{var t=uS(),n=H(t),r=U(n),i=e=>{yy(e,{get validationError(){return K(c)},get onExpand(){return jx}})};Q(r,e=>{K(c)&&e(i)}),Vu(t,(e,t)=>fx?.(e,t),()=>e=>function(e,t){Ae[t]=e.getBoundingClientRect().height}(e,K(o))),G(()=>du(n,`${K(o)??``} `)),Z(e,t)});var p=U(d);Nu(p,1,()=>K(Te),ju,(e,n,r,i)=>{var a,c=z(()=>(J(K(o)),K(n),q(()=>[String(K(o))].concat(K(n))))),u=z(()=>(J(I),K(t),K(n),q(()=>I(K(t),K(n))))),d=z(()=>(J(Qm),K(F),J(mh),J(K(c)),q(()=>Qm(K(F))&&mh(K(F).path,K(c))))),p=z(()=>(J(K(s)),q(()=>K(s)?.columns[r]))),m=z(()=>(J(Nb),J(K(c)),J(K(p)),q(()=>Nb(K(c),K(p))))),h=fS(),g=H(h),_=H(g),v=e=>{var r=z(()=>(J(lg),J(jm),K(t),J(K(l)),K(n),q(()=>lg(jm(K(t),K(l),K(n)))))),i=z(()=>(J(K(r)),q(()=>!!K(r)&&K(r).some(e=>e.active)))),a=z(()=>(J(Dt),J(K(r)),q(()=>!Dt(K(r)))));(function(e,t){Xo(t,!1);var n=$(t,`path`,9),r=$(t,`value`,9),i=$(t,`parser`,9),a=$(t,`isSelected`,9),o=$(t,`containsSearchResult`,9),s=$(t,`containsActiveSearchResult`,9),c=$(t,`onEdit`,9);Sd(!0);var l,u=Qx(),d=H(u);G(e=>{l=Ju(u,1,`jse-inline-value svelte-1jv89ui`,null,l,{"jse-selected":a(),"jse-highlight":o(),"jse-active":s()}),du(d,e)},[()=>(J(pp),J(i()),J(r()),J(50),q(()=>pp(i().stringify(r())??``,50)))]),Y(`dblclick`,u,()=>c()(n())),Z(e,u),Zo()})(e,{get path(){return K(c)},get value(){return K(u)},get parser(){return S()},get isSelected(){return K(d)},get containsSearchResult(){return K(a)},get containsActiveSearchResult(){return K(i)},onEdit:Bt})},y=Sc(()=>(J(zd),J(K(u)),q(()=>zd(K(u))))),b=e=>{var t=z(()=>(J(jm),K(A),K(ye),J(K(c)),q(()=>jm(K(A),K(ye),K(c))?.searchResults))),n=z(()=>K(u)===void 0?``:K(u)),r=z(()=>(J(Rm),K(A),K(Ie),J(K(c)),q(()=>Rm(K(A),K(Ie),K(c))))),i=z(()=>K(d)?K(F):void 0);hy(e,{get path(){return K(c)},get value(){return K(n)},get enforceString(){return K(r)},get selection(){return K(i)},get searchResultItems(){return K(t)},get context(){return K(Be)}})};Q(_,e=>{K(y)?e(v):e(b,-1)});var x=U(_),C=e=>{var t=dS();dy(H(t),{selected:!0,onContextMenu:ot}),Z(e,t)},w=Sc(()=>(J(f()),J(K(d)),J(wh),K(F),q(()=>!f()&&K(d)&&!wh(K(F)))));Q(x,e=>{K(w)&&e(C)});var T=U(g,2),E=e=>{yy(e,{get validationError(){return K(m)},get onExpand(){return jx}})};Q(T,e=>{K(m)&&e(E)}),G(e=>{cd(h,`data-path`,e),a=Ju(g,1,`jse-value-outer svelte-1p86y3c`,null,a,{"jse-selected-value":K(d)})},[()=>(J($f),J(K(c)),q(()=>$f(K(c))))]),Z(e,h)});var m=U(p),h=e=>{Z(e,pS())};Q(m,e=>{K(n)&&e(h)}),Z(e,u)});var x,C=H(U(b));yd(o,e=>V(pe,e),()=>K(pe)),Vu(o,(e,t)=>fx?.(e,t),()=>Zt),rl(()=>Y(`scroll`,o,$e));var w=U(o,2),T=e=>{var t=z(()=>(K(j),q(()=>`You pasted a JSON ${Array.isArray(K(j).contents)?`array`:`object`} as text`))),n=z(()=>[{icon:Ai,text:`Paste as JSON instead`,title:`Paste the text as JSON instead of a single value`,onMouseDown:ft},{text:`Leave as is`,title:`Keep the pasted content as a single value`,onClick:vt}]);zv(e,{type:`info`,get message(){return K(t)},get actions(){return K(n)}})};Q(w,e=>{K(j)&&e(T)});var E=U(w,2),ee=e=>{var t=z(()=>[{icon:Ai,text:`Paste as string instead`,title:`Paste the clipboard data as a single string value instead of an array`,onClick:gt},{text:`Leave as is`,title:`Keep the pasted array`,onClick:yt}]);zv(e,{type:`info`,message:`Multiline text was pasted as array`,get actions(){return K(t)}})};Q(E,e=>{K(M)&&e(ee)});var te=U(E,2),ne=e=>{var t=z(()=>f()?[]:[{icon:Mi,text:`Ok`,title:`Accept the repaired document`,onClick:tt},{icon:Ei,text:`Repair manually instead`,title:`Leave the document unchanged and repair it manually instead`,onClick:bt}]);zv(e,{type:`success`,message:`The loaded JSON document was invalid but is successfully repaired.`,get actions(){return K(t)},onClose:Qe})};Q(te,e=>{K(Re)&&e(ne)}),Kv(U(te,2),{get validationErrors(){return K(He)},selectError:Rt}),G(()=>{g=Ju(v,1,`jse-table-invisible-start-section svelte-1p86y3c`,null,g,{"jse-search-box-background":K(be)}),cd(y,`colspan`,(K(Te),q(()=>K(Te).length))),_=Xu(y,``,_,{height:(K(r),q(()=>K(r).startHeight+`px`))}),cd(C,`colspan`,(K(Te),q(()=>K(Te).length))),x=Xu(C,``,x,{height:(K(r),q(()=>K(r).endHeight+`px`))})}),Z(e,t)},l=e=>{var t=gS(),n=Kc(t),r=z(()=>f()?[]:[{icon:Ei,text:`Repair manually`,title:`Open the document in "code" mode and repair it manually`,onClick:bt}]);zv(n,{type:`error`,message:`The loaded JSON document is invalid and could not be repaired automatically.`,get actions(){return K(r)}}),Jb(U(n,2),{get text(){return K(_e)},get json(){return K(A)},get indentation(){return E()},get parser(){return S()}}),Z(e,t)},u=e=>{aS(e,{get text(){return K(_e)},get json(){return K(A)},get readOnly(){return f()},get parser(){return S()},openJSONEditorModal:Bt,extractPath:Ot,get onChangeMode(){return te()},onClick:()=>{Qe()}})};Q(s,e=>{K(Ee)?e(c):K(ve)&&K(_e)!==void 0&&K(_e)!==``?e(l,1):e(u,-1)}),Y(`paste`,o,Pt),Z(e,t)},sn=e=>{Z(e,vS())};Q(an,e=>{d?e(sn,-1):e(on)}),yd(tn,e=>V(fe,e),()=>K(fe));var cn=U(tn,2),ln=e=>{Zv(e,{onClose:()=>V(ke,!1)})};Q(cn,e=>{K(ke)&&e(ln)});var un=U(cn,2),mn=e=>{oy(e,kd(()=>K(he),{onClose:()=>{var e;(e=K(he))==null||e.onClose(),V(he,void 0)}}))};return Q(un,e=>{K(he)&&e(mn)}),G(()=>en=Ju(tn,1,`jse-table-mode svelte-1p86y3c`,null,en,{"no-main-menu":!v()})),Y(`mousedown`,tn,function(e){if(e.buttons===1||e.buttons===2){var t=e.target;t.isContentEditable||Qe();var n=ep(t);if(n){if(wh(K(F))&&Ah(K(A),K(F),n))return;V(F,vh(n)),e.preventDefault()}}}),Y(`keydown`,tn,function(e){var t=rp(e);if(a(`keydown`,{combo:t,key:e.key}),t===`Ctrl+X`&&(e.preventDefault(),xt(!0)),t===`Ctrl+Shift+X`&&(e.preventDefault(),xt(!1)),t===`Ctrl+C`&&(e.preventDefault(),wt(!0)),t===`Ctrl+Shift+C`&&(e.preventDefault(),wt(!1)),t===`Ctrl+D`&&(e.preventDefault(),kt()),t!==`Delete`&&t!==`Backspace`||(e.preventDefault(),Et()),t===`Insert`&&e.preventDefault(),t===`Ctrl+A`&&e.preventDefault(),t===`Ctrl+Q`&&st(e),t===`ArrowLeft`&&(e.preventDefault(),et(),K(F))){var n=function(e,t){var{rowIndex:n,columnIndex:r}=Ab(Mh(t),e);return r>0?vh(jb({rowIndex:n,columnIndex:r-1},e)):t}(K(Te),K(F));V(F,n),it(Mh(n))}if(t===`ArrowRight`&&(e.preventDefault(),et(),K(F))){var r=function(e,t){var{rowIndex:n,columnIndex:r}=Ab(Mh(t),e);return r<e.length-1?vh(jb({rowIndex:n,columnIndex:r+1},e)):t}(K(Te),K(F));V(F,r),it(Mh(r))}if(t===`ArrowUp`&&(e.preventDefault(),et(),K(F))){var i=function(e,t){var{rowIndex:n,columnIndex:r}=Ab(Mh(t),e);return n>0?vh(jb({rowIndex:n-1,columnIndex:r},e)):t}(K(Te),K(F));V(F,i),it(Mh(i))}if(t===`ArrowDown`&&(e.preventDefault(),et(),K(F))){var o=function(e,t,n){var{rowIndex:r,columnIndex:i}=Ab(Mh(n),t);return r<e.length-1?vh(jb({rowIndex:r+1,columnIndex:i},t)):n}(K(A),K(Te),K(F));V(F,o),it(Mh(o))}if(t===`Enter`&&K(F)&&Qm(K(F))){e.preventDefault();var s=K(F).path;zd(I(K(A),s))?Bt(s):f()||V(F,L(L({},K(F)),{},{edit:!0}))}if(t.replace(/^Shift\+/,``).length===1&&K(F))return e.preventDefault(),void function(e){Nt.apply(this,arguments)}(e.key);if(t===`Ctrl+Enter`&&Qm(K(F))){e.preventDefault();var c=I(K(A),K(F).path);qd(c)&&window.open(String(c),`_blank`)}t===`Escape`&&K(F)&&(e.preventDefault(),V(F,void 0)),t===`Ctrl+F`&&(e.preventDefault(),qt(!1)),t===`Ctrl+H`&&(e.preventDefault(),qt(!0)),t===`Ctrl+Z`&&(e.preventDefault(),Yt()),t===`Ctrl+Shift+Z`&&(e.preventDefault(),Xt())}),Y(`contextmenu`,tn,st),Z(e,$t),_d(t,`validate`,Ge),_d(t,`patch`,Ke),_d(t,`focus`,Qe),_d(t,`acceptAutoRepair`,tt),_d(t,`scrollTo`,nt),_d(t,`findElement`,at),_d(t,`openTransformModal`,zt),Zo(Qt)}function xS(e,t){Xo(t,!1);var n=$(t,`content`,8),r=$(t,`selection`,12),i=$(t,`readOnly`,8),a=$(t,`indentation`,8),o=$(t,`tabSize`,8),s=$(t,`truncateTextSize`,8),c=$(t,`externalMode`,8),l=$(t,`mainMenuBar`,8),u=$(t,`navigationBar`,8),d=$(t,`statusBar`,8),f=$(t,`askToFormat`,8),p=$(t,`escapeControlCharacters`,8),m=$(t,`escapeUnicodeCharacters`,8),h=$(t,`maxDocumentSizeTextMode`,8),g=$(t,`flattenColumns`,8),_=$(t,`parser`,8),v=$(t,`parseMemoizeOne`,8),b=$(t,`validator`,8),x=$(t,`validationParser`,8),S=$(t,`pathParser`,8),C=$(t,`insideModal`,8),w=$(t,`onChange`,8),T=$(t,`onChangeMode`,8),E=$(t,`onSelect`,8),ee=$(t,`onRenderValue`,8),te=$(t,`onClassName`,8),ne=$(t,`onRenderMenu`,8),re=$(t,`onRenderContextMenu`,8),ie=$(t,`onError`,8),ae=$(t,`onFocus`,8),oe=$(t,`onBlur`,8),se=$(t,`onSortModal`,8),D=$(t,`onTransformModal`,8),ce=$(t,`onJSONEditorModal`,8),le=B(),O=B(),k=B(),ue=Ad(`jsoneditor:JSONEditorRoot`),de=B(Sx({onChange:e=>V(de,e)}).get()),fe=B(c());function pe(e){if(gm(e)){V(fe,e.undo.mode);var t=K(de).items(),n=t.findIndex(t=>t===e),i=n===-1?void 0:t[n-1];ue(`handleUndo`,{index:n,item:e,items:t,prevItem:i}),i&&r(i.redo.selection),T()(K(fe))}}function me(e){if(gm(e)){V(fe,e.redo.mode);var t=K(de).items(),n=t.findIndex(t=>t===e),i=n===-1?void 0:t[n+1];ue(`handleRedo`,{index:n,item:e,items:t,nextItem:i}),i&&r(i.undo.selection),T()(K(fe))}}var he=B(),ge={type:`separator`},A=B(),_e=B();function ve(e){if(K(le))return K(le).patch(e);if(K(O))return K(O).patch(e);if(K(k))return K(k).patch(e);throw Error(`Method patch is not available in mode "${K(fe)}"`)}function j(e,t){if(K(le))return K(le).expand(e,t);if(K(k))return K(k).expand(e,t);throw Error(`Method expand is not available in mode "${K(fe)}"`)}function M(e,t){if(K(le))return K(le).collapse(e,t);if(K(k))return K(k).collapse(e,t);throw Error(`Method collapse is not available in mode "${K(fe)}"`)}function ye(e){if(K(k))K(k).openTransformModal(e);else if(K(le))K(le).openTransformModal(e);else{if(!K(O))throw Error(`Method transform is not available in mode "${K(fe)}"`);K(O).openTransformModal(e)}}function be(){if(K(k))return K(k).validate();if(K(le))return K(le).validate();if(K(O))return K(O).validate();throw Error(`Method validate is not available in mode "${K(fe)}"`)}function N(){return K(le)?K(le).acceptAutoRepair():n()}function P(e){if(K(le))return K(le).scrollTo(e);if(K(O))return K(O).scrollTo(e);throw Error(`Method scrollTo is not available in mode "${K(fe)}"`)}function xe(e){if(K(le))return K(le).findElement(e);if(K(O))return K(O).findElement(e);throw Error(`Method findElement is not available in mode "${K(fe)}"`)}function Se(){K(k)?K(k).focus():K(le)?K(le).focus():K(O)&&K(O).focus()}function Ce(){return we.apply(this,arguments)}function we(){return(we=Wa(function*(){K(k)&&(yield K(k).refresh())})).apply(this,arguments)}W(()=>J(c()),()=>{(function(e){if(e!==K(fe)){var t={type:`mode`,undo:{mode:K(fe),selection:void 0},redo:{mode:e,selection:void 0}};K(fe)===`text`&&K(k)&&K(k).flush(),ue(`add history item`,t),K(de).add(t),V(fe,e)}})(c())}),W(()=>(K(fe),J(T())),()=>{V(he,[{type:`button`,text:`text`,title:`Switch to text mode (current mode: ${K(fe)})`,className:`jse-group-button jse-first`+(K(fe)===Tf.text?` jse-selected`:``),onClick:()=>T()(Tf.text)},{type:`button`,text:`tree`,title:`Switch to tree mode (current mode: ${K(fe)})`,className:`jse-group-button `+(K(fe)===Tf.tree?` jse-selected`:``),onClick:()=>T()(Tf.tree)},{type:`button`,text:`table`,title:`Switch to table mode (current mode: ${K(fe)})`,className:`jse-group-button jse-last`+(K(fe)===Tf.table?` jse-selected`:``),onClick:()=>T()(Tf.table)}])}),W(()=>(K(he),J(ne()),K(fe),J(C()),J(i())),()=>{V(A,e=>{var t=Zp(e[0])?K(he).concat(e):K(he).concat(ge,e),n=y(t);return ne()(t,{mode:K(fe),modal:C(),readOnly:i()})||n})}),W(()=>(J(re()),K(fe),J(C()),J(i()),J(r())),()=>{V(_e,e=>{var t=y(e);return re()(e,{mode:K(fe),modal:C(),readOnly:i(),selection:r()})??(!i()&&t)})}),il();var Te={patch:ve,expand:j,collapse:M,transform:ye,validate:be,acceptAutoRepair:N,scrollTo:P,findElement:xe,focus:Se,refresh:Ce};Sd();var Ee=ou(),De=Kc(Ee),Oe=e=>{yd(Zx(e,{get externalContent(){return n()},get externalSelection(){return r()},get history(){return K(de)},get readOnly(){return i()},get indentation(){return a()},get tabSize(){return o()},get mainMenuBar(){return l()},get statusBar(){return d()},get askToFormat(){return f()},get escapeUnicodeCharacters(){return m()},get maxDocumentSize(){return h()},get parser(){return _()},get validator(){return b()},get validationParser(){return x()},get onChange(){return w()},get onChangeMode(){return T()},get onSelect(){return E()},onUndo:pe,onRedo:me,get onError(){return ie()},get onFocus(){return ae()},get onBlur(){return oe()},get onRenderMenu(){return K(A)},get onSortModal(){return se()},get onTransformModal(){return D()},$$legacy:!0}),e=>V(k,e),()=>K(k))},ke=Sc(()=>(K(fe),J(Tf),q(()=>K(fe)===Tf.text||String(K(fe))===`code`))),Ae=e=>{yd(bS(e,{get externalContent(){return n()},get externalSelection(){return r()},get history(){return K(de)},get readOnly(){return i()},get truncateTextSize(){return s()},get mainMenuBar(){return l()},get escapeControlCharacters(){return p()},get escapeUnicodeCharacters(){return m()},get flattenColumns(){return g()},get parser(){return _()},get parseMemoizeOne(){return v()},get validator(){return b()},get validationParser(){return x()},get indentation(){return a()},get onChange(){return w()},get onChangeMode(){return T()},get onSelect(){return E()},onUndo:pe,onRedo:me,get onRenderValue(){return ee()},get onFocus(){return ae()},get onBlur(){return oe()},get onRenderMenu(){return K(A)},get onRenderContextMenu(){return K(_e)},get onSortModal(){return se()},get onTransformModal(){return D()},get onJSONEditorModal(){return ce()},$$legacy:!0}),e=>V(O,e),()=>K(O))},je=e=>{yd(yx(e,{get externalContent(){return n()},get externalSelection(){return r()},get history(){return K(de)},get readOnly(){return i()},get indentation(){return a()},get truncateTextSize(){return s()},get mainMenuBar(){return l()},get navigationBar(){return u()},get escapeControlCharacters(){return p()},get escapeUnicodeCharacters(){return m()},get parser(){return _()},get parseMemoizeOne(){return v()},get validator(){return b()},get validationParser(){return x()},get pathParser(){return S()},get onError(){return ie()},get onChange(){return w()},get onChangeMode(){return T()},get onSelect(){return E()},onUndo:pe,onRedo:me,get onRenderValue(){return ee()},get onClassName(){return te()},get onFocus(){return ae()},get onBlur(){return oe()},get onRenderMenu(){return K(A)},get onRenderContextMenu(){return K(_e)},get onSortModal(){return se()},get onTransformModal(){return D()},get onJSONEditorModal(){return ce()},$$legacy:!0}),e=>V(le,e),()=>K(le))};return Q(De,e=>{K(ke)?e(Oe):(K(fe),J(Tf),q(()=>K(fe)===Tf.table)?e(Ae,1):e(je,-1))}),Z(e,Ee),_d(t,`patch`,ve),_d(t,`expand`,j),_d(t,`collapse`,M),_d(t,`transform`,ye),_d(t,`validate`,be),_d(t,`acceptAutoRepair`,N),_d(t,`scrollTo`,P),_d(t,`findElement`,xe),_d(t,`focus`,Se),_d(t,`refresh`,Ce),Zo(Te)}op(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
}`);var NS=X(`<div role="none"><!></div> <!> <!> <!>`,1);function PS(e,t){Xo(t,!1);var n=B(void 0,!0),r=Ad(`jsoneditor:JSONEditor`),i={text:``},a=void 0,o=!1,s=Tf.tree,l=!0,u=!0,d=!0,f=!0,p=!1,m=!1,h=10485760,g=!0,v=JSON,b=void 0,x=JSON,S={parse:wg,stringify:Cg},C=[hp],w=C[0].id,T=jx,E=void 0,ee=void 0,te=Sg,ne=jx,re=jx,ie=jx,ae=jx,oe=e=>{console.error(e),alert(e.toString())},se=jx,D=jx,ce=$(t,`content`,13,i),le=$(t,`selection`,13,a),O=$(t,`readOnly`,13,o),k=$(t,`indentation`,13,2),ue=$(t,`tabSize`,13,4),de=$(t,`truncateTextSize`,13,1e3),fe=$(t,`mode`,13,s),pe=$(t,`mainMenuBar`,13,l),me=$(t,`navigationBar`,13,u),he=$(t,`statusBar`,13,d),ge=$(t,`askToFormat`,13,f),A=$(t,`escapeControlCharacters`,13,p),_e=$(t,`escapeUnicodeCharacters`,13,m),ve=$(t,`maxDocumentSizeTextMode`,13,h),j=$(t,`flattenColumns`,13,g),M=$(t,`parser`,13,v),ye=$(t,`validator`,13,b),be=$(t,`validationParser`,13,x),N=$(t,`pathParser`,13,S),P=$(t,`queryLanguages`,13,C),xe=$(t,`queryLanguageId`,13,w),Se=$(t,`onChangeQueryLanguage`,13,T),Ce=$(t,`onChange`,13,E),we=$(t,`onSelect`,13,ee),Te=$(t,`onRenderValue`,13,te),Ee=$(t,`onClassName`,13,ne),De=$(t,`onRenderMenu`,13,re),Oe=$(t,`onRenderContextMenu`,13,ie),ke=$(t,`onChangeMode`,13,ae),Ae=$(t,`onError`,13,oe),je=$(t,`onFocus`,13,se),Me=$(t,`onBlur`,13,D),Ne=B(Pd(),!0),Pe=B(!1,!0),Fe=B(void 0,!0),Ie=B(void 0,!0),F=B(void 0,!0),Le=B(void 0,!0),Re=B(M(),!0);function ze(){return ce()}function Be(e){r(`set`);var t=ff(e);if(t)throw Error(t);V(Ne,Pd()),ce(e),Hs()}function Ve(e){r(`update`);var t=ff(e);if(t)throw Error(t);ce(e),Hs()}function He(e){var t=K(Fe).patch(e);return Hs(),t}function Ue(e){le(e),Hs()}function We(e,t){K(Fe).expand(e,t),Hs()}function Ge(e){var t=arguments.length>1&&arguments[1]!==void 0&&arguments[1];K(Fe).collapse(e,t),Hs()}function Ke(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};K(Fe).transform(e),Hs()}function qe(){return K(Fe).validate()}function Je(){var e=K(Fe).acceptAutoRepair();return Hs(),e}function Ye(e){return Xe.apply(this,arguments)}function Xe(){return(Xe=Wa(function*(e){yield K(Fe).scrollTo(e)})).apply(this,arguments)}function Ze(e){return K(Fe).findElement(e)}function Qe(){K(Fe).focus(),Hs()}function $e(){return et.apply(this,arguments)}function et(){return(et=Wa(function*(){yield K(Fe).refresh()})).apply(this,arguments)}function tt(e){for(var t of Object.keys(e))switch(t){case`content`:ce(e[t]??i);break;case`selection`:le(e[t]??a);break;case`readOnly`:O(e[t]??o);break;case`indentation`:k(e[t]??2);break;case`tabSize`:ue(e[t]??4);break;case`truncateTextSize`:de(e[t]??1e3);break;case`mode`:fe(e[t]??s);break;case`mainMenuBar`:pe(e[t]??l);break;case`navigationBar`:me(e[t]??u);break;case`statusBar`:he(e[t]??d);break;case`askToFormat`:ge(e[t]??f);break;case`escapeControlCharacters`:A(e[t]??p);break;case`escapeUnicodeCharacters`:_e(e[t]??m);break;case`maxDocumentSizeTextMode`:ve(e[t]??h);break;case`flattenColumns`:j(e[t]??g);break;case`parser`:M(e[t]??v);break;case`validator`:ye(e[t]??b);break;case`validationParser`:be(e[t]??x);break;case`pathParser`:N(e[t]??S);break;case`queryLanguages`:P(e[t]??C);break;case`queryLanguageId`:xe(e[t]??w);break;case`onChangeQueryLanguage`:Se(e[t]??T);break;case`onChange`:Ce(e[t]??E);break;case`onRenderValue`:Te(e[t]??te);break;case`onClassName`:Ee(e[t]??ne);break;case`onRenderMenu`:De(e[t]??re);break;case`onRenderContextMenu`:Oe(e[t]??ie);break;case`onChangeMode`:ke(e[t]??ae);break;case`onSelect`:we(e[t]??ee);break;case`onError`:Ae(e[t]??oe);break;case`onFocus`:je(e[t]??se);break;case`onBlur`:Me(e[t]??D);break;default:n(t)}function n(e){r(`Unknown property "${e}"`)}P().some(e=>e.id===xe())||xe(P()[0].id),Hs()}function nt(){return rt.apply(this,arguments)}function rt(){return(rt=Wa(function*(){throw Error(`class method destroy() is deprecated. It is replaced with a method destroy() in the vanilla library.`)})).apply(this,arguments)}function it(e,t,n){ce(e),Ce()&&Ce()(e,t,n)}function at(e){le(e),we()&&we()(y(e))}function ot(){V(Pe,!0),je()&&je()()}function st(){V(Pe,!1),Me()&&Me()()}function ct(e){return lt.apply(this,arguments)}function lt(){return(lt=Wa(function*(e){fe()!==e&&(fe(e),Hs(),Qe(),ke()(e))})).apply(this,arguments)}function ut(e){r(`handleChangeQueryLanguage`,e),xe(e),Se()(e)}function dt(e){var{id:t,json:r,rootPath:i,onTransform:a,onClose:o}=e;O()||V(Le,{id:t,json:r,rootPath:i,indentation:k(),truncateTextSize:de(),escapeControlCharacters:A(),escapeUnicodeCharacters:_e(),parser:M(),parseMemoizeOne:K(n),validationParser:be(),pathParser:N(),queryLanguages:P(),queryLanguageId:xe(),onChangeQueryLanguage:ut,onRenderValue:Te(),onRenderMenu:e=>De()(e,{mode:fe(),modal:!0,readOnly:O()}),onRenderContextMenu:e=>Oe()(e,{mode:fe(),modal:!0,readOnly:O(),selection:le()}),onClassName:Ee(),onTransform:a,onClose:o})}function ft(e){O()||V(F,e)}function pt(e){var{content:t,path:n,onPatch:i,onClose:a}=e;r(`onJSONEditorModal`,{content:t,path:n}),V(Ie,{content:t,path:n,onPatch:i,readOnly:O(),indentation:k(),tabSize:ue(),truncateTextSize:de(),mainMenuBar:pe(),navigationBar:me(),statusBar:he(),askToFormat:ge(),escapeControlCharacters:A(),escapeUnicodeCharacters:_e(),maxDocumentSizeTextMode:ve(),flattenColumns:j(),parser:M(),validator:void 0,validationParser:be(),pathParser:N(),onRenderValue:Te(),onClassName:Ee(),onRenderMenu:De(),onRenderContextMenu:Oe(),onSortModal:ft,onTransformModal:dt,onClose:a})}function mt(e){e.stopPropagation()}W(()=>(J(M()),K(Re),J(ce()),Pd),()=>{if(!Cf(M(),K(Re))){if(r(`parser changed, recreate editor`),mf(ce())){var e=K(Re).stringify(ce().json);ce({json:e===void 0?void 0:M().parse(e)})}V(Re,M()),V(Ne,Pd())}}),W(()=>J(ce()),()=>{var e=ff(ce());e&&console.error(`Error: `+e)}),W(()=>J(le()),()=>{le()===null&&console.warn(`selection is invalid: it is null but should be undefined`)}),W(()=>J(M()),()=>{V(n,_(M().parse))}),W(()=>J(fe()),()=>{r(`mode changed to`,fe())}),il();var ht={get:ze,set:Be,update:Ve,patch:He,select:Ue,expand:We,collapse:Ge,transform:Ke,validate:qe,acceptAutoRepair:Je,scrollTo:Ye,findElement:Ze,focus:Qe,refresh:$e,updateProps:tt,destroy:nt};return Sd(!0),dp(e,{children:(e,t)=>{var r,i=NS(),a=Kc(i);Au(H(a),()=>K(Ne),e=>{yd(xS(e,{get externalMode(){return fe()},get content(){return ce()},get selection(){return le()},get readOnly(){return O()},get indentation(){return k()},get tabSize(){return ue()},get truncateTextSize(){return de()},get statusBar(){return he()},get askToFormat(){return ge()},get mainMenuBar(){return pe()},get navigationBar(){return me()},get maxDocumentSizeTextMode(){return ve()},get escapeControlCharacters(){return A()},get escapeUnicodeCharacters(){return _e()},get flattenColumns(){return j()},get parser(){return M()},get parseMemoizeOne(){return K(n)},get validator(){return ye()},get validationParser(){return be()},get pathParser(){return N()},insideModal:!1,get onError(){return Ae()},onChange:it,onChangeMode:ct,onSelect:at,get onRenderValue(){return Te()},get onClassName(){return Ee()},onFocus:ot,onBlur:st,get onRenderMenu(){return De()},get onRenderContextMenu(){return Oe()},onSortModal:ft,onTransformModal:dt,onJSONEditorModal:pt,$$legacy:!0}),e=>V(Fe,e),()=>K(Fe))});var o=U(a,2),s=e=>{(function(e,t){Xo(t,!1);var n=B(void 0,!0),r=B(void 0,!0),i=B(void 0,!0),a=B(void 0,!0),o=Ad(`jsoneditor:SortModal`),s=$(t,`id`,9),c=$(t,`json`,9),l=$(t,`rootPath`,9),u=$(t,`onSort`,9),d=$(t,`onClose`,9),f={value:1,label:`ascending`},p=[f,{value:-1,label:`descending`}],m=`${s()}:${pn(l())}`,h=B(kS()[m]?.selectedProperty,!0),g=B(kS()[m]?.selectedDirection||f,!0),_=B(void 0,!0);function v(){try{var e;V(_,void 0);var t=K(h)?.value||((e=K(a))==null||(e=e[0])==null?void 0:e.value)||[],n=K(g)?.value,r=ib(c(),l(),t,n);u()!==void 0&&l()!==void 0&&u()({operations:r,rootPath:l(),itemPath:t,direction:n}),d()()}catch(e){V(_,String(e))}}function y(e){e.focus()}W(()=>(J(c()),J(l())),()=>{V(n,I(c(),l()))}),W(()=>K(n),()=>{V(r,Array.isArray(K(n)))}),W(()=>(K(r),K(n)),()=>{V(i,K(r)?Zd(K(n)):void 0)}),W(()=>(K(i),Tg),()=>{V(a,K(i)?K(i).map(Tg):void 0)}),W(()=>(kS(),K(h),K(g)),()=>{kS(kS()[m]={selectedProperty:K(h),selectedDirection:K(g)}),o(`store state in memory`,m,kS()[m])}),il(),Sd(!0),Yv(e,{get onClose(){return d()},className:`jse-sort-modal`,children:(e,t)=>{var n=MS(),i=Kc(n),o=z(()=>K(r)?`Sort array items`:`Sort object keys`);Cv(i,{get title(){return K(o)},get onClose(){return d()}});var s=H(U(i,2)),c=H(U(H(s))),u=H(U(H(c))),f=U(c),m=e=>{var t=AS();hv(H(U(H(t))),{showChevron:!0,get items(){return K(a)},get value(){return K(h)},set value(e){V(h,e)},$$legacy:!0}),Z(e,t)};Q(f,e=>{K(r),K(a),q(()=>K(r)&&K(a)&&K(a)?.length>1)&&e(m)}),hv(H(U(H(U(f)))),{showChevron:!0,clearable:!1,get items(){return p},get value(){return K(g)},set value(e){V(g,e)},$$legacy:!0});var b=U(s,2),x=H(b),S=e=>{var t=jS(),n=H(t);G(()=>du(n,K(_))),Z(e,t)};Q(x,e=>{K(_)&&e(S)});var C=H(U(b,2));rl(()=>Y(`click`,C,v)),Vu(C,e=>y?.(e)),G(e=>{sd(u,e),C.disabled=(K(r),K(a),K(h),q(()=>!!(K(r)&&K(a)&&K(a)?.length>1)&&!K(h)))},[()=>(J(l()),J(Dt),J(Cg),q(()=>l()&&!Dt(l())?Cg(l()):`(document root)`))]),Z(e,n)},$$slots:{default:!0}}),Zo()})(e,kd(()=>K(F),{onClose:()=>{var e;(e=K(F))==null||e.onClose(),V(F,void 0)}}))};Q(o,e=>{K(F)&&e(s)});var l=U(o,2),u=e=>{Ax(e,kd(()=>K(Le),{onClose:()=>{var e;(e=K(Le))==null||e.onClose(),V(Le,void 0)}}))};Q(l,e=>{K(Le)&&e(u)});var d=U(l,2),f=e=>{(function(e,t){Xo(t,!1);var n=B(void 0,!0),r=B(void 0,!0),i=B(void 0,!0),a=B(void 0,!0),o=Ad(`jsoneditor:JSONEditorModal`),s=$(t,`content`,9),l=$(t,`path`,9),u=$(t,`onPatch`,9),d=$(t,`readOnly`,9),f=$(t,`indentation`,9),p=$(t,`tabSize`,9),m=$(t,`truncateTextSize`,9),h=$(t,`mainMenuBar`,9),g=$(t,`navigationBar`,9),v=$(t,`statusBar`,9),y=$(t,`askToFormat`,9),b=$(t,`escapeControlCharacters`,9),x=$(t,`escapeUnicodeCharacters`,9),S=$(t,`maxDocumentSizeTextMode`,9),C=$(t,`flattenColumns`,9),w=$(t,`parser`,9),T=$(t,`validator`,9),E=$(t,`validationParser`,9),ee=$(t,`pathParser`,9),te=$(t,`onRenderValue`,9),ne=$(t,`onClassName`,9),re=$(t,`onRenderMenu`,9),ie=$(t,`onRenderContextMenu`,9),ae=$(t,`onSortModal`,9),oe=$(t,`onTransformModal`,9),se=$(t,`onClose`,9),D=B(void 0,!0),ce=B(void 0,!0),le={mode:ue(s()),content:s(),selection:void 0,relativePath:l()},O=B([le],!0),k=B(void 0,!0);function ue(e){return mf(e)&&Wt(e.json)?Tf.table:Tf.tree}function de(){var e=c(K(O))?.selection;th(e)&&K(D).scrollTo(Mh(e))}function fe(){if(o(`handleApply`),!d())try{V(k,void 0);var e=K(n).relativePath,t=K(n).content,r=[{op:`replace`,path:pn(e),value:gf(t,w()).json}];if(K(O).length>1){var i=gf(K(O)[K(O).length-2].content,w()).json,a={json:gn(i,r)},s=L(L({},K(O)[K(O).length-2]||le),{},{content:a});V(O,[...K(O).slice(0,K(O).length-2),s]),Hs(),de()}else u()(r),se()()}catch(e){V(k,String(e))}}function pe(){var e;o(`handleClose`),K(O).length>1?(V(O,Ct(K(O))),Hs(),(e=K(D))==null||e.focus(),de(),V(k,void 0)):se()()}function me(e){o(`handleChange`,e),A(t=>L(L({},t),{},{content:e}))}function he(e){o(`handleChangeSelection`,e),A(t=>L(L({},t),{},{selection:e}))}function ge(e){o(`handleChangeMode`,e),A(t=>L(L({},t),{},{mode:e}))}function A(e){var t=e(c(K(O)));V(O,[...Ct(K(O)),t])}function _e(e){V(k,e.toString()),console.error(e)}function ve(e){var t,{content:n,path:r}=e;o(`handleJSONEditorModal`,{content:n,path:r});var i={mode:ue(n),content:n,selection:void 0,relativePath:r};V(O,[...K(O),i]),Hs(),(t=K(D))==null||t.focus()}function j(e){e.focus()}Cu(()=>{var e;(e=K(D))==null||e.focus()}),W(()=>K(O),()=>{V(n,c(K(O))||le)}),W(()=>K(O),()=>{V(r,K(O).flatMap(e=>e.relativePath))}),W(()=>(K(r),Cg),()=>{V(i,Dt(K(r))?`(document root)`:Cg(K(r)))}),W(()=>J(w()),()=>{V(a,_(w().parse))}),il(),Sd(!0),Yv(e,{onClose:pe,className:`jse-jsoneditor-modal`,get fullscreen(){return K(ce)},children:(e,t)=>{var r=DS();dp(H(r),{children:(e,t)=>{var r=ES(),o=Kc(r),s=z(()=>(K(O),q(()=>K(O).length>1?` (${K(O).length})`:``)));Cv(o,{get title(){return`Edit nested content ${K(s)??``}`},fullScreenButton:!0,onClose:pe,get fullscreen(){return K(ce)},set fullscreen(e){V(ce,e)},$$legacy:!0});var c=U(H(U(o,2)),2),l=U(c,4);yd(xS(H(l),{get externalMode(){return K(n),q(()=>K(n).mode)},get content(){return K(n),q(()=>K(n).content)},get selection(){return K(n),q(()=>K(n).selection)},get readOnly(){return d()},get indentation(){return f()},get tabSize(){return p()},get truncateTextSize(){return m()},get statusBar(){return v()},get askToFormat(){return y()},get mainMenuBar(){return h()},get navigationBar(){return g()},get escapeControlCharacters(){return b()},get escapeUnicodeCharacters(){return x()},get maxDocumentSizeTextMode(){return S()},get flattenColumns(){return C()},get parser(){return w()},get parseMemoizeOne(){return K(a)},get validator(){return T()},get validationParser(){return E()},get pathParser(){return ee()},insideModal:!0,onError:_e,onChange:me,onChangeMode:ge,onSelect:he,get onRenderValue(){return te()},get onClassName(){return ne()},get onFocus(){return jx},get onBlur(){return jx},get onRenderMenu(){return re()},get onRenderContextMenu(){return ie()},get onSortModal(){return ae()},get onTransformModal(){return oe()},onJSONEditorModal:ve,$$legacy:!0}),e=>V(D,e),()=>K(D));var u=H(U(l,2)),_=e=>{var t=SS(),n=H(t);G(()=>du(n,K(k))),Z(e,t)};Q(u,e=>{K(k)&&e(_)});var se=U(u,2),le=e=>{var t=CS();Cp(H(t),{get data(){return vi}}),Y(`click`,t,pe),Z(e,t)};Q(se,e=>{K(O),q(()=>K(O).length>1)&&e(le)});var ue=U(se,2),de=e=>{var t=wS();rl(()=>Y(`click`,t,fe)),Vu(t,e=>j?.(e)),Z(e,t)},A=e=>{var t=TS();Y(`click`,t,pe),Z(e,t)};Q(ue,e=>{d()?e(A,-1):e(de)}),G(()=>sd(c,K(i))),Z(e,r)},$$slots:{default:!0}}),Z(e,r)},$$slots:{default:!0}}),Zo()})(e,kd(()=>K(Ie),{onClose:()=>{var e;(e=K(Ie))==null||e.onClose(),V(Ie,void 0)}}))};Q(d,e=>{K(Ie)&&e(f)}),G(()=>r=Ju(a,1,`jse-main svelte-1l55585`,null,r,{"jse-focus":K(Pe)})),Y(`keydown`,a,mt),Z(e,i)},$$slots:{default:!0}}),_d(t,`get`,ze),_d(t,`set`,Be),_d(t,`update`,Ve),_d(t,`patch`,He),_d(t,`select`,Ue),_d(t,`expand`,We),_d(t,`collapse`,Ge),_d(t,`transform`,Ke),_d(t,`validate`,qe),_d(t,`acceptAutoRepair`,Je),_d(t,`scrollTo`,Ye),_d(t,`findElement`,Ze),_d(t,`focus`,Qe),_d(t,`refresh`,$e),_d(t,`updateProps`,tt),_d(t,`destroy`,nt),Zo(ht)}function FS(e){var{target:t,props:n}=e,r=fu(PS,{target:t,props:n});return r.destroy=Wa(function*(){return function(e,t){var n=mu.get(e);return n?(mu.delete(e),n(t)):Promise.resolve()}(r)}),Hs(),r}export{mf as n,FS as r,Tf as t};