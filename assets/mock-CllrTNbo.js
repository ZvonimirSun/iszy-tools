...
.jse-json-node.svelte-wovgt4 .jse-insert-area.jse-selected:where(.svelte-wovgt4) {
  outline-color: var(--jse-context-menu-pointer-background, var(--jse-context-menu-background, #656565));
                ...
                `).concat((Ye=s().length===1?"item":"items")!==null&&Ye!==void 0?Ye:""))}),se("click",He,_),P(H,_e)};Y(De,H=>{n(x)?H(Ie):H(xt,!1)});var It=N(tt,2),Be=H=>{var _e=hy();ja(A(_e),{get root(){return n(o)},selected:!0,get onContextMenu(){return d().onContextMenu}}),P(H,_e)};Y(It,H=>{!d().readOnly&&n(y)&&u()&&($n(u())||Jn(u()))&&!Jr(u())&&Zt(Qe(u()),n(j))&&H(Be)});var be=N(I,2),Ue=H=>{qs(H,{get validationError(){return n(C)},onExpand:_})};Y(be,H=>{!n(C)||n(x)&&n(C).isChildError||H(Ue)});var ut=N(be,2),ze=H=>{var _e=gy();se("click",_e,de),P(H,_e)},mt=H=>{var _e=my();se("click",_e,Me),P(H,_e)};Y(ut,H=>{n(x)?H(ze):H(mt,!1)});var nt=N(ae,2),Le=H=>{var _e=wy(),He=Ne(_e),Tt=A(He),an=zn=>{var Jt,Bt=by();vn(Bt,"title",Hc);var fn=A(Bt),sr=fe(()=>n(y)&&_r(u()));ja(fn,{insert:!0,get selected(){return n(sr)},onContextMenu:ue}),we(Un=>{Jt=Ot(Bt,1,"jse-insert-area jse-inside svelte-wovgt4",null,Jt,{"jse-hovered":n(m)===pi,"jse-selected":Un}),Ps(Bt,"--level",n(j).length+1)},[()=>n(y)&&_r(u())],fe),P(zn,Bt)};Y(Tt,zn=>{!d().readOnly&&(n(m)===pi||n(y)&&_r(u()))&&zn(an)}),dr(N(Tt,2),1,()=>n(O)||Rs,mr,(zn,Jt,Bt)=>{var fn=xy(),sr=Ne(fn);dr(sr,1,()=>function(Fe,pn,dt){var Qt=pn.start,jn=Math.min(pn.end,Fe.length),En=xp(Qt,jn);return dt&&dt.offset!==0?Mv(En,dt.selectionStartIndex,dt.selectionItemsCount,dt.offset).map((kn,qn)=>({index:kn,gutterIndex:qn})):En.map(kn=>({index:kn,gutterIndex:kn}))}(s(),n(Jt),n(b)),Fe=>Fe.index,(Fe,pn)=>{var dt=Ft(),Qt=fe(()=>Ir(l())?l().items[n(pn).index]:void 0),jn=fe(()=>Qv(d().getJson(),u(),n(j).concat(String(n(pn).index)))),En=Ne(dt),kn=fe(()=>rv(a(),n(pn).index)),qn=fe(()=>Ir(i())?i().items[n(pn).index]:void 0),Qn=fe(()=>Ir(c())?c().items[n(pn).index]:void 0);Du(En,{get value(){return s()[n(pn).index]},get pointer(){return n(kn)},get state(){return n(qn)},get validationErrors(){return n(Qt)},get searchResults(){return n(Qn)},get selection(){return n(jn)},get context(){return d()},onDragSelectionStart:G,$$slots:{identifier:(Or,tr)=>{var pr=jy(),br=A(pr),vr=A(br);we(()=>gt(vr,n(pn).gutterIndex)),P(Or,pr)}}}),P(Fe,dt)});var Un=N(sr,2),cn=Fe=>{var pn=fe(()=>n(O)||Rs);ay(Fe,{get visibleSections(){return n(pn)},sectionIndex:Bt,get total(){return s().length},get path(){return n(j)},get onExpandSection(){return d().onExpandSection},get selection(){return u()},get context(){return d()}})};Y(Un,Fe=>{n(Jt).end<s().length&&Fe(cn)}),P(zn,fn)});var Ye=N(He,2),Vt=N(A(Ye),2),An=zn=>{var Jt=yy();se("click",Jt,Me),P(zn,Jt)};Y(Vt,zn=>{n(o)||zn(An)}),P(H,_e)};Y(nt,H=>{n(x)&&H(Le)}),se("click",je,$),P(te,q)},ie=te=>{var q=Ft(),ae=Ne(q),I=Ke=>{var W=_y(),V=Ne(W),R=A(V),et=A(R),kt=A(et),tt=Ye=>{en(Ye,{data:_a})},Xe=Ye=>{en(Ye,{data:Ei})};Y(kt,Ye=>{n(x)?Ye(tt):Ye(Xe,!1)});var De=N(et,2);ur(De,t,"identifier",{},null);var Ie=N(De,2),xt=Ye=>{P(Ye,Cy())};Y(Ie,Ye=>{n(o)||Ye(xt)});var It=N(Ie,2),Be=A(It),be=A(Be),Ue=Ye=>{P(Ye,Sy())},ut=Ye=>{var Vt=Oy(),An=N(Ne(Vt),2),zn=A(An);we((Jt,Bt)=>gt(zn,"".concat(Jt??"",`
                `).concat(Bt??"")),[()=>Object.keys(s()).length,()=>Object.keys(s()).length===1?"prop":"props"],fe),se("click",An,_),P(Ye,Vt)};Y(be,Ye=>{n(x)?Ye(Ue):Ye(ut,!1)});var ze=N(It,2),mt=Ye=>{var Vt=zy();ja(A(Vt),{get root(){return n(o)},selected:!0,get onContextMenu(){return d().onContextMenu}}),P(Ye,Vt)};Y(ze,Ye=>{!d().readOnly&&n(y)&&u()&&($n(u())||Jn(u()))&&!Jr(u())&&Zt(Qe(u()),n(j))&&Ye(mt)});var nt=N(R,2),Le=Ye=>{qs(Ye,{get validationError(){return n(C)},onExpand:_})};Y(nt,Ye=>{!n(C)||n(x)&&n(C).isChildError||Ye(Le)});var H=N(nt,2),_e=Ye=>{var Vt=Ey();se("click",Vt,de),P(Ye,Vt)},He=Ye=>{var Vt=Ft(),An=Ne(Vt),zn=Jt=>{var Bt=$y();se("click",Bt,Me),P(Jt,Bt)};Y(An,Jt=>{n(o)||Jt(zn)},!0),P(Ye,Vt)};Y(H,Ye=>{n(x)?Ye(_e):Ye(He,!1)});var Tt=N(V,2),an=Ye=>{var Vt=Ry(),An=Ne(Vt),zn=A(An),Jt=Un=>{var cn,Fe=My();vn(Fe,"title",Hc);var pn=A(Fe),dt=fe(()=>n(y)&&_r(u()));ja(pn,{insert:!0,get selected(){return n(dt)},onContextMenu:ue}),we(Qt=>{cn=Ot(Fe,1,"jse-insert-area jse-inside svelte-wovgt4",null,cn,{"jse-hovered":n(m)===pi,"jse-selected":Qt}),Ps(Fe,"--level",n(j).length+1)},[()=>n(y)&&_r(u())],fe),P(Un,Fe)};Y(zn,Un=>{!d().readOnly&&(n(m)===pi||n(y)&&_r(u()))&&Un(Jt)}),dr(N(zn,2),1,()=>function(Un,cn){var Fe=Object.keys(Un);return cn&&cn.offset!==0?Mv(Fe,cn.selectionStartIndex,cn.selectionItemsCount,cn.offset):Fe}(s(),n(b)),mr,(Un,cn)=>{var Fe=Ft(),pn=fe(()=>rv(a(),n(cn))),dt=fe(()=>Oo(c())?c().properties[n(cn)]:void 0),Qt=fe(()=>Oo(l())?l().properties[n(cn)]:void 0),jn=fe(()=>n(j).concat(n(cn))),En=fe(()=>Qv(d().getJson(),u(),n(jn))),kn=Ne(Fe),qn=fe(()=>Oo(i())?i().properties[n(cn)]:void 0);Du(kn,{get value(){return s()[n(cn)]},get pointer(){return n(pn)},get state(){return n(qn)},get validationErrors(){return n(Qt)},get searchResults(){return n(dt)},get selection(){return n(En)},get context(){return d()},onDragSelectionStart:G,$$slots:{identifier:(Qn,Or)=>{var tr,pr=Ay(),br=A(pr),vr=fe(()=>{return Wn=n(dt),(nr=Nv(Wn)?Wn.searchResults.filter(le=>le.field===So.key):void 0)&&nr.length>0?nr:void 0;var Wn,nr});(function(Wn,nr){lt(nr,!1);var le=M(void 0,!0),Nt=M(void 0,!0),Bn=v(nr,"pointer",9),K=v(nr,"key",9),xe=v(nr,"selection",9),st=v(nr,"searchResultItems",9),Ct=v(nr,"onUpdateKey",9),rt=v(nr,"context",9),qt=M(void 0,!0);function tn(Dt){n(Nt)||rt().readOnly||(Dt.preventDefault(),rt().onSelect(Ad(n(qt))))}function Pt(Dt,hn){var Ut=Ct()(K(),rt().normalization.unescapeValue(Dt)),rr=on(n(qt)).concat(Ut);rt().onSelect(hn===Aa.nextInside?Yt(rr):da(rr)),hn!==Aa.self&&rt().focus()}function Rt(){rt().onSelect(da(n(qt))),rt().focus()}U(()=>E(Bn()),()=>{f(qt,Io(Bn()))}),U(()=>(E(xe()),n(qt)),()=>{f(le,kr(xe())&&Zt(xe().path,n(qt)))}),U(()=>(n(le),E(xe())),()=>{f(Nt,n(le)&&Jr(xe()))}),ln(),pt(!0);var ot=ly(),at=Ne(ot),un=Dt=>{var hn=fe(()=>rt().normalization.escapeValue(K())),Ut=fe(()=>Jr(xe())?xe().initialValue:void 0);Ph(Dt,{get value(){return n(hn)},get initialValue(){return n(Ut)},label:"Edit key",shortText:!0,onChange:Pt,onCancel:Rt,get onFind(){return rt().onFind}})},St=Dt=>{var hn,Ut=iy(),rr=A(Ut),D=ke=>{var $t=fe(()=>rt().normalization.escapeValue(K()));Nh(ke,{get text(){return n($t)},get searchResultItems(){return st()}})},X=ke=>{var $t=Lr();we(rn=>gt($t,rn),[()=>mc(rt().normalization.escapeValue(K()))],fe),P(ke,$t)};Y(rr,ke=>{st()?ke(D):ke(X,!1)}),we(()=>hn=Ot(Ut,1,"jse-key svelte-2iqnqn",null,hn,{"jse-empty":K()===""})),se("dblclick",Ut,tn),P(Dt,Ut)};Y(at,Dt=>{!rt().readOnly&&n(Nt)?Dt(un):Dt(St,!1)});var Cn=N(at,2),nn=Dt=>{ja(Dt,{selected:!0,get onContextMenu(){return rt().onContextMenu}})};Y(Cn,Dt=>{rt().readOnly||!n(le)||n(Nt)||Dt(nn)}),P(Wn,ot),ct()})(br,{get pointer(){return n(pn)},get key(){return n(cn)},get selection(){return n(En)},get searchResultItems(){return n(vr)},get context(){return d()},onUpdateKey:T}),we(Wn=>tr=Ot(pr,1,"jse-key-outer svelte-wovgt4",null,tr,{"jse-selected-key":Wn}),[()=>kr(n(En))&&Zt(n(En).path,n(jn))],fe),P(Qn,pr)}}}),P(Un,Fe)});var Bt=N(An,2),fn=N(A(Bt),2),sr=Un=>{var cn=Py();se("click",cn,Me),P(Un,cn)};Y(fn,Un=>{n(o)||Un(sr)}),P(Ye,Vt)};Y(Tt,Ye=>{n(x)&&Ye(an)}),se("click",et,$),P(Ke,W)},je=Ke=>{var W=Ny(),V=A(W),R=A(V);ur(R,t,"identifier",{},null);var et=N(R,2),kt=ze=>{P(ze,Iy())};Y(et,ze=>{n(o)||ze(kt)});var tt=N(et,2),Xe=A(tt),De=fe(()=>n(y)?u():void 0),Ie=fe(()=>{return ze=c(),(mt=Nv(ze)?ze.searchResults.filter(nt=>nt.field===So.value):void 0)&&mt.length>0?mt:void 0;var ze,mt});eg(Xe,{get path(){return n(j)},get value(){return s()},get enforceString(){return n(S)},get selection(){return n(De)},get searchResultItems(){return n(Ie)},get context(){return d()}});var xt=N(tt,2),It=ze=>{var mt=qy();ja(A(mt),{get root(){return n(o)},selected:!0,get onContextMenu(){return d().onContextMenu}}),P(ze,mt)};Y(xt,ze=>{!d().readOnly&&n(y)&&u()&&($n(u())||Jn(u()))&&!Jr(u())&&Zt(Qe(u()),n(j))&&ze(It)});var Be=N(V,2),be=ze=>{qs(ze,{get validationError(){return n(C)},onExpand:_})};Y(Be,ze=>{n(C)&&ze(be)});var Ue=N(Be,2),ut=ze=>{var mt=Ty();se("click",mt,Me),P(ze,mt)};Y(Ue,ze=>{n(o)||ze(ut)}),P(Ke,W)};Y(ae,Ke=>{wn(s())?Ke(I):Ke(je,!1)},!0),P(te,q)};Y(Ze,te=>{Array.isArray(s())?te(re):te(ie,!1)});var Ee=N(Ze,2),At=te=>{var q,ae=Dy();vn(ae,"title",Hc);var I=A(ae),je=fe(()=>n(y)&&co(u()));ja(I,{insert:!0,get selected(){return n(je)},onContextMenu:ve}),we(Ke=>q=Ot(ae,1,"jse-insert-area jse-after svelte-wovgt4",null,q,{"jse-hovered":n(m)===Jc,"jse-selected":Ke}),[()=>n(y)&&co(u())],fe),P(te,ae)};Y(Ee,te=>{!d().readOnly&&(n(m)===Jc||n(y)&&co(u()))&&te(At)}),we((te,q,ae)=>{me=Ot(Ce,1,Da(te),"svelte-wovgt4",me,{"jse-root":n(o),"jse-selected":q,"jse-selected-value":ae,"jse-readonly":d().readOnly,"jse-hovered":n(m)===_v}),vn(Ce,"data-path",n(r)),vn(Ce,"aria-selected",n(y)),Ps(Ce,"--level",n(j).length)},[()=>ri("jse-json-node",{"jse-expanded":n(x)},d().onClassName(n(j),s())),()=>n(y)&&Jn(u()),()=>n(y)&&$n(u())],fe),se("mousedown",Ce,function(te){if((te.buttons===1||te.buttons===2)&&!((q=te.target).nodeName==="DIV"&&q.contentEditable==="true"||te.buttons===1&&jh(te.target,"BUTTON"))){var q;te.stopPropagation(),te.preventDefault(),d().focus(),document.addEventListener("mousemove",z,!0),document.addEventListener("mouseup",ne);var ae=Vc(te.target),I=d().getJson(),je=d().getDocumentState();if(!u()||ae===In.after||ae===In.inside||u().type!==ae&&u().type!==In.multi||!Di(I,u(),n(j)))if(Hn(Hn().selecting=!0),Hn(Hn().selectionAnchor=n(j)),Hn(Hn().selectionAnchorType=ae),Hn(Hn().selectionFocus=n(j)),te.shiftKey){var Ke=d().getSelection();Ke&&d().onSelect(Dr(Ka(Ke),n(j)))}else if(ae===In.multi)if(n(o)&&te.target.hasAttribute("data-path")){var W=Ht(zh(s(),je));d().onSelect(Au(W))}else d().onSelect(Dr(n(j),n(j)));else I!==void 0&&d().onSelect(Yv(ae,n(j)));else te.button===0&&h()(te)}}),se("mousemove",Ce,function(te){if(Hn().selecting){te.preventDefault(),te.stopPropagation(),Hn().selectionFocus===void 0&&window.getSelection&&window.getSelection().empty();var q=Vc(te.target);Zt(n(j),Hn().selectionFocus)&&q===Hn().selectionAnchorType||(Hn(Hn().selectionFocus=n(j)),Hn(Hn().selectionAnchorType=q),d().onSelect(Dr(Hn().selectionAnchor||Hn().selectionFocus,Hn().selectionFocus)))}}),se("mouseover",Ce,function(te){Hn().selecting||Hn().dragging||(te.stopPropagation(),Sa(te.target,"data-type","selectable-value")?f(m,_v):Sa(te.target,"data-type","selectable-key")?f(m,void 0):Sa(te.target,"data-type","insert-selection-area-inside")?f(m,pi):Sa(te.target,"data-type","insert-selection-area-after")&&f(m,Jc),clearTimeout(g))}),se("mouseout",Ce,function(te){te.stopPropagation(),g=window.setTimeout(()=>f(m,void 0))}),P(e,Ce),ct()}var By={prefix:"fas",iconName:"jsoneditor-expand",icon:[512,512,[],"","M 0,448 V 512 h 512 v -64 z M 0,0 V 64 H 512 V 0 Z M 256,96 128,224 h 256 z M 256,416 384,288 H 128 Z"]},Ly={prefix:"fas",iconName:"jsoneditor-collapse",icon:[512,512,[],"","m 0,224 v 64 h 512 v -64 z M 256,192 384,64 H 128 Z M 256,320 128,448 h 256 z"]},vf={prefix:"fas",iconName:"jsoneditor-format",icon:[512,512,[],"","M 0,32 v 64 h 416 v -64 z M 160,160 v 64 h 352 v -64 z M 160,288 v 64 h 288 v -64 z M 0,416 v 64 h 320 v -64 z"]},Fy={prefix:"fas",iconName:"jsoneditor-compact",icon:[512,512,[],"","M 0,32 v 64 h 512 v -64 z M 0,160 v 64 h 512 v -64 z M 0,288 v 64 h 352 v -64 z"]};jt(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
.jse-tree-mode.svelte-vrx1dr .jse-contents:where(.svelte-vrx1dr) .jse-search-box-background:where(.svelte-vrx1dr) {
  ...
  margin-bottom: 2px;
  display: inline-block;
}`);var O1=F("<!> <!>",1),z1=F('<div class="jse-search-box-background svelte-vrx1dr"></div>'),E1=F('<div class="jse-search-box-container svelte-vrx1dr"><!></div> <div class="jse-contents svelte-vrx1dr"><!> <!></div> <!> <!> <!>',1),$1=F('<label class="jse-hidden-input-label svelte-vrx1dr"><input type="text" tabindex="-1" class="jse-hidden-input svelte-vrx1dr"></label> <!>',1),M1=F('<div class="jse-contents svelte-vrx1dr"><div class="jse-loading-space svelte-vrx1dr"></div> <div class="jse-loading svelte-vrx1dr">loading...</div></div>'),A1=F('<div role="tree" tabindex="-1"><!> <!> <!></div> <!> <!>',1);function Wu(e,t){lt(t,!1);var r=M(void 0,!0),o=Sr("jsoneditor:TreeMode"),a=typeof window>"u";o("isSSR:",a);var s=Ts(),i=Ts(),{openAbsolutePopup:l,closeAbsolutePopup:c}=Ba("absolute-popup"),u=M(void 0,!0),d=M(void 0,!0),h=M(void 0,!0),p=!1,m=Qh(),g=v(t,"readOnly",9),b=v(t,"externalContent",9),j=v(t,"externalSelection",9),x=v(t,"history",9),S=v(t,"mainMenuBar",9),O=v(t,"navigationBar",9),C=v(t,"escapeControlCharacters",9),y=v(t,"escapeUnicodeCharacters",9),$=v(t,"parser",9),_=v(t,"parseMemoizeOne",9),T=v(t,"validator",9),z=v(t,"validationParser",9),ne=v(t,"pathParser",9),Q=v(t,"indentation",9),B=v(t,"onError",9),G=v(t,"onChange",9),pe=v(t,"onChangeMode",9),Z=v(t,"onSelect",9),de=v(t,"onUndo",9),Me=v(t,"onRedo",9),ue=v(t,"onRenderValue",9),ve=v(t,"onRenderMenu",9),me=v(t,"onRenderContextMenu",9),Ce=v(t,"onClassName",9),Ze=v(t,"onFocus",9),re=v(t,"onBlur",9),ie=v(t,"onSortModal",9),Ee=v(t,"onTransformModal",9),At=v(t,"onJSONEditorModal",9),te=!1,q=M(!1,!0),ae=M(void 0,!0);Id({onMount:qr,onDestroy:uo,getWindow:()=>Xi(n(h)),hasFocus:()=>te&&document.hasFocus()||jd(n(h)),onFocus:()=>{p=!0,Ze()&&Ze()()},onBlur:()=>{p=!1,re()&&re()()}});var I=M(void 0,!0),je=M(void 0,!0),Ke=void 0,W=!1,V=M(Mu({json:n(I)}),!0),R=M(Ni(j())?j():void 0,!0);function et(w){f(R,w)}qr(()=>{if(n(R)){var w=Qe(n(R));f(V,mo(n(I),n(V),w,kl)),setTimeout(()=>St(w))}});var kt,tt=M(void 0,!0),Xe=M(void 0,!0),De=M(void 0,!0),Ie=M(!1,!0),xt=M(!1,!0);function It(w){f(De,(kt=w)?Th(n(I),kt.items):void 0)}function Be(w){return be.apply(this,arguments)}function be(){return(be=wt(function*(w){f(V,mo(n(I),n(V),w,kl)),yield ot(w)})).apply(this,arguments)}function Ue(){f(Ie,!1),f(xt,!1),Lt()}function ut(w){o("select validation error",w),f(R,Yt(w.path)),ot(w.path)}function ze(w){var L=arguments.length>1&&arguments[1]!==void 0?arguments[1]:Wv;o("expand"),f(V,mo(n(I),n(V),w,L))}function mt(w,L){f(V,Bv(n(I),n(V),w,L)),n(R)&&function(oe,qe){return ua(Qe(oe),qe)&&(Qe(oe).length>qe.length||_r(oe))}(n(R),w)&&f(R,void 0)}var nt=M(!1,!0),Le=M([],!0),H=M(void 0,!0),_e=$i(Xh);function He(w,L,oe,qe){Es(()=>{var $e;try{$e=_e(w,L,oe,qe)}catch(Se){$e=[{path:[],message:"Failed to validate: "+Se.message,severity:Co.warning}]}Zt($e,n(Le))||(o("validationErrors changed:",$e),f(Le,$e),f(H,function(Se,Oe){var Ve;return Oe.forEach(vt=>{Ve=df(Se,Ve,vt.path,(sn,Wt)=>ge(ge({},Wt),{},{validationError:vt}))}),Oe.forEach(vt=>{for(var sn=vt.path;sn.length>0;)sn=on(sn),Ve=df(Se,Ve,sn,(Wt,Rn)=>Rn.validationError?Rn:ge(ge({},Rn),{},{validationError:{isChildError:!0,path:sn,message:"Contains invalid data",severity:Co.warning}}))}),Ve}(w,n(Le))))},$e=>o("validationErrors updated in ".concat($e," ms")))}function Tt(){return o("validate"),Ke?{parseError:Ke,isRepairable:!1}:(He(n(I),T(),$(),z()),_n(n(Le))?void 0:{validationErrors:n(Le)})}function an(){return n(I)}function Ye(){return n(V)}function Vt(){return n(R)}function An(w){o("applyExternalContent",{updatedContent:w}),Ri(w)?function(L){if(L!==void 0){var oe=!Zt(n(I),L);if(o("update external json",{isChanged:oe,currentlyText:n(I)===void 0}),!!oe){var qe={documentState:n(V),selection:n(R),json:n(I),text:n(je),textIsRepaired:n(nt)};f(I,L),f(V,no(L,n(V))),zn(n(I)),f(je,void 0),f(nt,!1),Ke=void 0,Jt(n(I)),Bt(qe)}}}(w.json):Pi(w)&&function(L){if(!(L===void 0||Ri(b()))){var oe=L!==n(je);if(o("update external text",{isChanged:oe}),!!oe){var qe={documentState:n(V),selection:n(R),json:n(I),text:n(je),textIsRepaired:n(nt)};try{f(I,_()(L)),f(V,no(n(I),n(V))),zn(n(I)),f(je,L),f(nt,!1),Ke=void 0}catch($e){try{f(I,_()(qo(L))),f(V,no(n(I),n(V))),zn(n(I)),f(je,L),f(nt,!0),Ke=void 0,Jt(n(I))}catch{f(I,void 0),f(V,void 0),f(je,b().text),f(nt,!1),Ke=n(je)!==void 0&&n(je)!==""?Us(n(je),$e.message||String($e)):void 0}}Jt(n(I)),Bt(qe)}}}(w.text)}function zn(w){W||(W=!0,f(V,ts(w,n(V),[])))}function Jt(w){n(R)&&(ka(w,Ka(n(R)))&&ka(w,Qe(n(R)))||(o("clearing selection: path does not exist anymore",n(R)),f(R,hs(w,n(V)))))}function Bt(w){if(w.json!==void 0||w.text!==void 0){var L=n(I)!==void 0&&w.json!==void 0;x().add({type:"tree",undo:{patch:L?[{op:"replace",path:"",value:w.json}]:void 0,json:w.json,text:w.text,documentState:w.documentState,textIsRepaired:w.textIsRepaired,selection:_o(w.selection),sortedColumn:void 0},redo:{patch:L?[{op:"replace",path:"",value:n(I)}]:void 0,json:n(I),text:n(je),documentState:n(V),textIsRepaired:n(nt),selection:_o(n(R)),sortedColumn:void 0}})}}function fn(w,L){var oe;if(o("patch",w,L),n(I)===void 0)throw new Error("Cannot apply patch: no JSON");var qe=n(I),$e={json:void 0,text:n(je),documentState:n(V),selection:_o(n(R)),textIsRepaired:n(nt),sortedColumn:void 0},Se=qh(n(I),w),Oe=Sh(n(I),n(V),w),Ve=(oe=Ls(n(I),w))!==null&&oe!==void 0?oe:n(R),vt=typeof L=="function"?L(Oe.json,Oe.documentState,Ve):void 0;return f(I,(vt==null?void 0:vt.json)!==void 0?vt.json:Oe.json),f(V,(vt==null?void 0:vt.state)!==void 0?vt.state:Oe.documentState),f(R,(vt==null?void 0:vt.selection)!==void 0?vt.selection:Ve),f(je,void 0),f(nt,!1),f(Xe,void 0),Ke=void 0,Jt(n(I)),x().add({type:"tree",undo:ge({patch:Se},$e),redo:{patch:w,json:void 0,text:n(je),documentState:n(V),selection:_o(n(R)),sortedColumn:void 0,textIsRepaired:n(nt)}}),{json:n(I),previousJson:qe,undo:Se,redo:w}}function sr(){!g()&&n(R)&&f(R,Ad(Qe(n(R))))}function Un(){if(!g()&&n(R)){var w=Qe(n(R)),L=Je(n(I),w);gr(L)?function(oe,qe){o("openJSONEditorModal",{path:oe,value:qe}),te=!0,At()({content:{json:qe},path:oe,onPatch:n(gn).onPatch,onClose:()=>{te=!1,setTimeout(Lt)}})}(w,L):f(R,Fl(w))}}function cn(){if(!g()&&$n(n(R))){var w=Qe(n(R)),L=Et(w),oe=Je(n(I),w),qe=!aa(n(I),n(V),w),$e=qe?String(oe):ti(String(oe),$());o("handleToggleEnforceString",{enforceString:qe,value:oe,updatedValue:$e}),nn([{op:"replace",path:L,value:$e}],(Se,Oe)=>({state:bc(n(I),Oe,w,{type:"value",enforceString:qe})}))}}function Fe(){return n(nt)&&n(I)!==void 0&&Dt(n(I)),n(I)!==void 0?{json:n(I)}:{text:n(je)||""}}function pn(){return dt.apply(this,arguments)}function dt(){return dt=wt(function*(){var w=!(arguments.length>0&&arguments[0]!==void 0)||arguments[0];yield ag({json:n(I),selection:n(R),indentation:w?Q():void 0,readOnly:g(),parser:$(),onPatch:nn})}),dt.apply(this,arguments)}function Qt(){return jn.apply(this,arguments)}function jn(){return jn=wt(function*(){var w=!(arguments.length>0&&arguments[0]!==void 0)||arguments[0];n(I)!==void 0&&(yield sg({json:n(I),selection:n(R),indentation:w?Q():void 0,parser:$()}))}),jn.apply(this,arguments)}function En(w){var L;w.preventDefault(),Qn((L=w.clipboardData)===null||L===void 0?void 0:L.getData("text/plain"))}function kn(){return qn.apply(this,arguments)}function qn(){return(qn=wt(function*(){try{Qn(yield navigator.clipboard.readText())}catch(w){console.error(w),f(q,!0)}})).apply(this,arguments)}function Qn(w){w!==void 0&&ig({clipboardText:w,json:n(I),selection:n(R),readOnly:g(),parser:$(),onPatch:nn,onChangeText:hn,openRepairModal:Or})}function Or(w,L){f(ae,{text:w,onParse:oe=>gc(oe,qe=>Qi(qe,$())),onRepair:vh,onApply:L,onClose:Lt})}function tr(){lg({json:n(I),text:n(je),selection:n(R),keepSelection:!1,readOnly:g(),onChange:G(),onPatch:nn})}function pr(){!g()&&n(I)!==void 0&&n(R)&&Os&&!_n(Qe(n(R)))&&(o("duplicate",{selection:n(R)}),nn(Rh(n(I),Pa(n(I),n(R)))))}function br(){if(!g()&&n(R)&&(Jn(n(R))||$n(n(R)))&&!_n(Qe(n(R)))){o("extract",{selection:n(R)});var w=function(L,oe){if($n(oe))return[{op:"move",from:Et(oe.path),path:""}];if(!Jn(oe))throw new Error("Cannot create extract operations: parent must be an Object or Array");var qe=on(oe.focusPath),$e=Je(L,qe);if(wr($e)){var Se=Pa(L,oe).map(Ve=>{var vt=Pr(Ht(Ve));return $e[vt]});return[{op:"replace",path:"",value:Se}]}if($r($e)){var Oe={};return Pa(L,oe).forEach(Ve=>{var vt=String(Ht(Ve));Oe[vt]=$e[vt]}),[{op:"replace",path:"",value:Oe}]}throw new Error("Cannot extract: unsupported type of selection "+JSON.stringify(oe))}(n(I),n(R));nn(w,(L,oe)=>{if(gr(L))return{state:Xc(L,oe,[])}})}}function vr(w){Gl({insertType:w,selectInside:!0,initialValue:void 0,json:n(I),selection:n(R),readOnly:g(),parser:$(),onPatch:nn,onReplaceJson:Dt})}function Wn(w){kr(n(R))&&f(R,Yt(n(R).path)),n(R)||f(R,hs(n(I),n(V))),vr(w)}function nr(w){if(!g()&&n(R))if(dl(n(R)))try{var L=Ka(n(R)),oe=Je(n(I),L),qe=function(Se,Oe,Ve){if(Oe==="array"){if(Array.isArray(Se))return Se;if(wn(Se))return $v(Se);if(typeof Se=="string")try{var vt=Ve.parse(Se);if(Array.isArray(vt))return vt;if(wn(vt))return $v(vt)}catch{return[Se]}return[Se]}if(Oe==="object"){if(Array.isArray(Se))return Ev(Se);if(wn(Se))return Se;if(typeof Se=="string")try{var sn=Ve.parse(Se);if(wn(sn))return sn;if(Array.isArray(sn))return Ev(sn)}catch{return{value:Se}}return{value:Se}}if(Oe==="value")return gr(Se)?Ve.stringify(Se):Se;throw new Error("Cannot convert ".concat(gd(Se,Ve)," to ").concat(Oe))}(oe,w,$());if(qe===oe)return;var $e=[{op:"replace",path:Et(L),value:qe}];o("handleConvert",{selection:n(R),path:L,type:w,operations:$e}),nn($e,(Se,Oe)=>({state:n(R)?ts(Se,Oe,Qe(n(R))):n(V)}))}catch(Se){B()(Se)}else B()(new Error("Cannot convert current selection to ".concat(w)))}function le(){if(n(R)){var w=Hv(n(I),n(V),n(R),!1),L=on(Qe(n(R)));w&&!_n(Qe(w))&&Zt(L,on(Qe(w)))?f(R,sa(Qe(w))):f(R,va(L)),o("insert before",{selection:n(R),selectionBefore:w,parentPath:L}),ar(),Kt()}}function Nt(){if(n(R)){var w=Ra(n(I),n(R));o("insert after",w),f(R,sa(w)),ar(),Kt()}}function Bn(w){return K.apply(this,arguments)}function K(){return(K=wt(function*(w){yield cg({char:w,selectInside:!0,json:n(I),selection:n(R),readOnly:g(),parser:$(),onPatch:nn,onReplaceJson:Dt,onSelect:et})})).apply(this,arguments)}function xe(){if(!g()&&x().canUndo){var w=x().undo();if(Bl(w)){var L={json:n(I),text:n(je)};f(I,w.undo.patch?To(n(I),w.undo.patch):w.undo.json),f(V,w.undo.documentState),f(R,w.undo.selection),f(je,w.undo.text),f(nt,w.undo.textIsRepaired),Ke=void 0,o("undo",{item:w,json:n(I),documentState:n(V),selection:n(R)}),Cn(L,w.undo.patch&&w.redo.patch?{json:n(I),previousJson:L.json,redo:w.undo.patch,undo:w.redo.patch}:void 0),Lt(),n(R)&&ot(Qe(n(R)),!1)}else de()(w)}}function st(){if(!g()&&x().canRedo){var w=x().redo();if(Bl(w)){var L={json:n(I),text:n(je)};f(I,w.redo.patch?To(n(I),w.redo.patch):w.redo.json),f(V,w.redo.documentState),f(R,w.redo.selection),f(je,w.redo.text),f(nt,w.redo.textIsRepaired),Ke=void 0,o("redo",{item:w,json:n(I),documentState:n(V),selection:n(R)}),Cn(L,w.undo.patch&&w.redo.patch?{json:n(I),previousJson:L.json,redo:w.redo.patch,undo:w.undo.patch}:void 0),Lt(),n(R)&&ot(Qe(n(R)),!1)}else Me()(w)}}function Ct(w){var L;g()||n(I)===void 0||(te=!0,ie()({id:s,json:n(I),rootPath:w,onSort:(L=wt(function*(oe){var{operations:qe}=oe;o("onSort",w,qe),nn(qe,($e,Se)=>({state:Xc($e,Se,w),selection:Yt(w)}))}),function(oe){return L.apply(this,arguments)}),onClose:()=>{te=!1,setTimeout(Lt)}}))}function rt(){n(R)&&Ct(Kv(n(I),n(R)))}function qt(){Ct([])}function tn(w){if(n(I)!==void 0){var{id:L,onTransform:oe,onClose:qe}=w,$e=w.rootPath||[];te=!0,Ee()({id:L||i,json:n(I),rootPath:$e,onTransform:Se=>{oe?oe({operations:Se,json:n(I),transformedJson:To(n(I),Se)}):(o("onTransform",$e,Se),nn(Se,(Oe,Ve)=>({state:Xc(Oe,Ve,$e),selection:Yt($e)})))},onClose:()=>{te=!1,setTimeout(Lt),qe&&qe()}})}}function Pt(){n(R)&&tn({rootPath:Kv(n(I),n(R))})}function Rt(){tn({rootPath:[]})}function ot(w){return at.apply(this,arguments)}function at(){return at=wt(function*(w){var L=!(arguments.length>1&&arguments[1]!==void 0)||arguments[1];f(V,mo(n(I),n(V),w,kl));var oe=un(w);if(o("scrollTo",{path:w,elem:oe,refContents:n(u)}),!oe||!n(u))return Promise.resolve();var qe=n(u).getBoundingClientRect(),$e=oe.getBoundingClientRect();if(!L&&$e.bottom>qe.top&&$e.top<qe.bottom)return Promise.resolve();var Se=-qe.height/4;return new Promise(Oe=>{m(oe,{container:n(u),offset:Se,duration:300,callback:()=>Oe()})})}),at.apply(this,arguments)}function un(w){var L,oe;return ar(),(L=(oe=n(u))===null||oe===void 0?void 0:oe.querySelector('div[data-path="'.concat(Ou(w),'"]')))!==null&&L!==void 0?L:void 0}function St(w){var L=un(w);if(L&&n(u)){var oe=n(u).getBoundingClientRect(),qe=L.getBoundingClientRect(),$e=gr(Je(n(I),w))?20:qe.height;qe.top<oe.top+20?m(L,{container:n(u),offset:-20,duration:0}):qe.top+$e>oe.bottom-20&&m(L,{container:n(u),offset:-(oe.height-$e-20),duration:0})}}function Cn(w,L){if(w.json!==void 0||(w==null?void 0:w.text)!==void 0){if(n(je)!==void 0){var oe,qe={text:n(je),json:void 0};(oe=G())===null||oe===void 0||oe(qe,w,{contentErrors:Tt(),patchResult:L})}else if(n(I)!==void 0){var $e,Se={text:void 0,json:n(I)};($e=G())===null||$e===void 0||$e(Se,w,{contentErrors:Tt(),patchResult:L})}}}function nn(w,L){o("handlePatch",w,L);var oe={json:n(I),text:n(je)},qe=fn(w,L);return Cn(oe,qe),qe}function Dt(w,L){var oe={json:n(I),text:n(je)},qe={documentState:n(V),selection:n(R),json:n(I),text:n(je),textIsRepaired:n(nt)},$e=mo(n(I),no(w,n(V)),[],wi),Se=typeof L=="function"?L(w,$e,n(R)):void 0;f(I,(Se==null?void 0:Se.json)!==void 0?Se.json:w),f(V,(Se==null?void 0:Se.state)!==void 0?Se.state:$e),f(R,(Se==null?void 0:Se.selection)!==void 0?Se.selection:n(R)),f(je,void 0),f(nt,!1),Ke=void 0,Jt(n(I)),Bt(qe),Cn(oe,void 0)}function hn(w,L){o("handleChangeText");var oe={json:n(I),text:n(je)},qe={documentState:n(V),selection:n(R),json:n(I),text:n(je),textIsRepaired:n(nt)};try{f(I,_()(w)),f(V,mo(n(I),no(n(I),n(V)),[],wi)),f(je,void 0),f(nt,!1),Ke=void 0}catch(Se){try{f(I,_()(qo(w))),f(V,mo(n(I),no(n(I),n(V)),[],wi)),f(je,w),f(nt,!0),Ke=void 0}catch{f(I,void 0),f(V,Mu({json:n(I),expand:wi})),f(je,w),f(nt,!1),Ke=n(je)!==""?Us(n(je),Se.message||String(Se)):void 0}}if(typeof L=="function"){var $e=L(n(I),n(V),n(R));f(I,($e==null?void 0:$e.json)!==void 0?$e.json:n(I)),f(V,($e==null?void 0:$e.state)!==void 0?$e.state:n(V)),f(R,($e==null?void 0:$e.selection)!==void 0?$e.selection:n(R))}Jt(n(I)),Bt(qe),Cn(oe,void 0)}function Ut(w,L){var oe=arguments.length>2&&arguments[2]!==void 0&&arguments[2];o("handleExpand",{path:w,expanded:L,recursive:oe}),L?ze(w,oe?Md:Wv):mt(w,oe),Lt()}function rr(){Ut([],!0,!0)}function D(){Ut([],!1,!0)}function X(w){o("openFind",{findAndReplace:w}),f(Ie,!1),f(xt,!1),ar(),f(Ie,!0),f(xt,w)}function ke(w,L){o("handleExpandSection",w,L),f(V,function(oe,qe,$e,Se){return Bs(oe,qe,$e,(Oe,Ve)=>{if(!Ir(Ve))return Ve;var vt=wh(Ve.visibleSections.concat(Se));return ge(ge({},Ve),{},{visibleSections:vt})})}(n(I),n(V),w,L))}function $t(w){o("pasted json as text",w),f(Xe,w)}function rn(w){var L,{anchor:oe,left:qe,top:$e,width:Se,height:Oe,offsetTop:Ve,offsetLeft:vt,showTip:sn}=w,Wt=function(Tn){var{json:Xn,documentState:it,selection:Pe,readOnly:Mt,onEditKey:fr,onEditValue:On,onToggleEnforceString:mn,onCut:Dn,onCopy:hr,onPaste:_t,onRemove:Vn,onDuplicate:Rr,onExtract:fo,onInsertBefore:Tr,onInsert:Fr,onConvert:Ko,onInsertAfter:cs,onSort:ha,onTransform:Er}=Tn,Gn=Xn!==void 0,Vr=!!Pe,Zr=!!Pe&&_n(Qe(Pe)),po=Pe?Je(Xn,Qe(Pe)):void 0,oi=Array.isArray(po)?"Edit array":wn(po)?"Edit object":"Edit value",Yr=Gn&&(Jn(Pe)||kr(Pe)||$n(Pe)),ai=Pe&&!Zr?Je(Xn,on(Qe(Pe))):void 0,Mc=!Mt&&Gn&&Ll(Pe)&&!Zr&&!Array.isArray(ai),si=!Mt&&Gn&&Pe!==void 0&&Ll(Pe),Ac=si&&!gr(po),ii=!Mt&&Yr,li=Yr,Pc=!Mt&&Vr,jr=!Mt&&Gn&&Yr&&!Zr,Po=!Mt&&Gn&&Pe!==void 0&&(Jn(Pe)||$n(Pe))&&!Zr,so=Yr,Yo=so?"Convert to:":"Insert:",Fa=!Mt&&(_r(Pe)&&Array.isArray(po)||co(Pe)&&Array.isArray(ai)),Qr=!Mt&&(so?dl(Pe)&&!wn(po):Vr),Rc=!Mt&&(so?dl(Pe)&&!Array.isArray(po):Vr),_c=!Mt&&(so?dl(Pe)&&gr(po):Vr),Ic=Pe!==void 0&&aa(Xn,it,Qe(Pe));function us(ci){Yr?ci!=="structure"&&Ko(ci):Fr(ci)}return[{type:"row",items:[{type:"button",onClick:()=>fr(),icon:$s,text:"Edit key",title:"Edit the key (Double-click on the key)",disabled:!Mc},{type:"dropdown-button",main:{type:"button",onClick:()=>On(),icon:$s,text:oi,title:"Edit the value (Double-click on the value)",disabled:!si},width:"11em",items:[{type:"button",icon:$s,text:oi,title:"Edit the value (Double-click on the value)",onClick:()=>On(),disabled:!si},{type:"button",icon:Ic?up:dp,text:"Enforce string",title:"Enforce keeping the value as string when it contains a numeric value",onClick:()=>mn(),disabled:!Ac}]}]},{type:"separator"},{type:"row",items:[{type:"dropdown-button",main:{type:"button",onClick:()=>Dn(!0),icon:Ms,text:"Cut",title:"Cut selected contents, formatted with indentation (Ctrl+X)",disabled:!ii},width:"10em",items:[{type:"button",icon:Ms,text:"Cut formatted",title:"Cut selected contents, formatted with indentation (Ctrl+X)",onClick:()=>Dn(!0),disabled:!ii},{type:"button",icon:Ms,text:"Cut compacted",title:"Cut selected contents, without indentation (Ctrl+Shift+X)",onClick:()=>Dn(!1),disabled:!ii}]},{type:"dropdown-button",main:{type:"button",onClick:()=>hr(!0),icon:wa,text:"Copy",title:"Copy selected contents, formatted with indentation (Ctrl+C)",disabled:!li},width:"12em",items:[{type:"button",icon:wa,text:"Copy formatted",title:"Copy selected contents, formatted with indentation (Ctrl+C)",onClick:()=>hr(!0),disabled:!li},{type:"button",icon:wa,text:"Copy compacted",title:"Copy selected contents, without indentation (Ctrl+Shift+C)",onClick:()=>hr(!1),disabled:!li}]},{type:"button",onClick:()=>_t(),icon:vp,text:"Paste",title:"Paste clipboard contents (Ctrl+V)",disabled:!Pc}]},{type:"separator"},{type:"row",items:[{type:"column",items:[{type:"button",onClick:()=>Rr(),icon:fp,text:"Duplicate",title:"Duplicate selected contents (Ctrl+D)",disabled:!jr},{type:"button",onClick:()=>fo(),icon:jm,text:"Extract",title:"Extract selected contents",disabled:!Po},{type:"button",onClick:()=>ha(),icon:Ml,text:"Sort",title:"Sort array or object contents",disabled:Mt||!Yr},{type:"button",onClick:()=>Er(),icon:Al,text:"Transform",title:"Transform array or object contents (filter, sort, project)",disabled:Mt||!Yr},{type:"button",onClick:()=>Vn(),icon:pu,text:"Remove",title:"Remove selected contents (Delete)",disabled:Mt||!Yr}]},{type:"column",items:[{type:"label",text:Yo},{type:"button",onClick:()=>us("structure"),icon:so?rl:ks,text:"Structure",title:Yo+" structure like the first item in the array",disabled:!Fa},{type:"button",onClick:()=>us("object"),icon:so?rl:ks,text:"Object",title:Yo+" object",disabled:!Qr},{type:"button",onClick:()=>us("array"),icon:so?rl:ks,text:"Array",title:Yo+" array",disabled:!Rc},{type:"button",onClick:()=>us("value"),icon:so?rl:ks,text:"Value",title:Yo+" value",disabled:!_c}]}]},{type:"separator"},{type:"row",items:[{type:"button",onClick:()=>Tr(),icon:xm,text:"Insert before",title:"Select area before current entry to insert or paste contents",disabled:Mt||!Yr||Zr},{type:"button",onClick:()=>cs(),icon:ym,text:"Insert after",title:"Select area after current entry to insert or paste contents",disabled:Mt||!Yr||Zr}]}]}({json:n(I),documentState:n(V),selection:n(R),readOnly:g(),onEditKey:sr,onEditValue:Un,onToggleEnforceString:cn,onCut:pn,onCopy:Qt,onPaste:kn,onRemove:tr,onDuplicate:pr,onExtract:br,onInsertBefore:le,onInsert:Wn,onInsertAfter:Nt,onConvert:nr,onSort:rt,onTransform:Pt}),Rn=(L=me()(Wt))!==null&&L!==void 0?L:Wt;if(Rn!==!1){var ht={left:qe,top:$e,offsetTop:Ve,offsetLeft:vt,width:Se,height:Oe,anchor:oe,closeOnOuterClick:!0,onClose:()=>{te=!1,Lt()}};te=!0;var lr=l(dg,{tip:sn?"Tip: you can open this context menu via right-click or with Ctrl+Q":void 0,items:Rn,onRequestClose:()=>c(lr)},ht)}}function Kt(w){if(!Jr(n(R)))if(w&&(w.stopPropagation(),w.preventDefault()),w&&w.type==="contextmenu"&&w.target!==n(d))rn({left:w.clientX,top:w.clientY,width:Zo,height:Go,showTip:!1});else{var L,oe=(L=n(u))===null||L===void 0?void 0:L.querySelector(".jse-context-menu-pointer.jse-selected");if(oe)rn({anchor:oe,offsetTop:2,width:Zo,height:Go,showTip:!1});else{var qe,$e=(qe=n(u))===null||qe===void 0?void 0:qe.getBoundingClientRect();$e&&rn({top:$e.top+2,left:$e.left+2,width:Zo,height:Go,showTip:!1})}}}function Sn(w){rn({anchor:xh(w.target,"BUTTON"),offsetTop:0,width:Zo,height:Go,showTip:!0})}function Ln(){return Pn.apply(this,arguments)}function Pn(){return(Pn=wt(function*(){if(o("apply pasted json",n(Xe)),n(Xe)){var{onPasteAsJson:w}=n(Xe);f(Xe,void 0),w(),setTimeout(Lt)}})).apply(this,arguments)}function ir(){o("clear pasted json"),f(Xe,void 0),Lt()}function Te(){pe()(yr.text)}function Nn(w){f(R,w),Lt(),ot(Qe(w))}function Lt(){o("focus"),n(d)&&(n(d).focus(),n(d).select())}function zr(w){return function(L,oe,qe){var $e=on(qe),Se=[Ht(qe)],Oe=Je(L,$e),Ve=Oe?Qc(Oe,oe,Se):void 0;return Ve?Yt($e.concat(Ve)):sa(qe)}(n(I),n(V),w)}function ft(w){n(r)&&n(r).onDrag(w)}function dn(){n(r)&&n(r).onDragEnd()}var gn=M(void 0,!0);U(()=>n(R),()=>{var w;w=n(R),Zt(w,j())||(o("onSelect",w),Z()(w))}),U(()=>(E(C()),E(y())),()=>{f(tt,md({escapeControlCharacters:C(),escapeUnicodeCharacters:y()}))}),U(()=>n(Ie),()=>{(function(w){n(u)&&w&&n(u).scrollTop===0&&(ro(u,n(u).style.overflowAnchor="none"),ro(u,n(u).scrollTop+=yi),setTimeout(()=>{n(u)&&ro(u,n(u).style.overflowAnchor="")}))})(n(Ie))}),U(()=>E(b()),()=>{An(b())}),U(()=>E(j()),()=>{(function(w){Zt(n(R),w)||(o("applyExternalSelection",{selection:n(R),externalSelection:w}),Ni(w)&&f(R,w))})(j())}),U(()=>(n(I),E(T()),E($()),E(z())),()=>{He(n(I),T(),$(),z())}),U(()=>(n(u),uf),()=>{f(r,n(u)?uf(n(u)):void 0)}),U(()=>(E(g()),E($()),n(tt),E(ue()),E(Ce())),()=>{f(gn,{mode:yr.tree,readOnly:g(),parser:$(),normalization:n(tt),getJson:an,getDocumentState:Ye,getSelection:Vt,findElement:un,findNextInside:zr,focus:Lt,onPatch:nn,onInsert:vr,onExpand:Ut,onSelect:et,onFind:X,onExpandSection:ke,onPasteJson:$t,onRenderValue:ue(),onContextMenu:rn,onClassName:Ce()||(()=>{}),onDrag:ft,onDragEnd:dn})}),U(()=>n(gn),()=>{o("context changed",n(gn))}),ln(),pt(!0);var Fn=A1();se("mousedown",oa,function(w){!ni(w.target,L=>L===n(h))&&Jr(n(R))&&(o("click outside the editor, exit edit mode"),f(R,_o(n(R))),p&&n(d)&&(n(d).focus(),n(d).blur()),o("blur (outside editor)"),n(d)&&n(d).blur())});var k,J=Ne(Fn),ce=A(J),he=w=>{(function(L,oe){lt(oe,!1);var qe=M(void 0,!0),$e=M(void 0,!0),Se=M(void 0,!0),Oe=v(oe,"json",9),Ve=v(oe,"selection",9),vt=v(oe,"readOnly",9),sn=v(oe,"showSearch",13,!1),Wt=v(oe,"history",9),Rn=v(oe,"onExpandAll",9),ht=v(oe,"onCollapseAll",9),lr=v(oe,"onUndo",9),Tn=v(oe,"onRedo",9),Xn=v(oe,"onSort",9),it=v(oe,"onTransform",9),Pe=v(oe,"onContextMenu",9),Mt=v(oe,"onCopy",9),fr=v(oe,"onRenderMenu",9);function On(){sn(!sn())}var mn=M(void 0,!0),Dn=M(void 0,!0),hr=M(void 0,!0),_t=M(void 0,!0);U(()=>E(Oe()),()=>{f(qe,Oe()!==void 0)}),U(()=>(n(qe),E(Ve()),$n),()=>{f($e,n(qe)&&(Jn(Ve())||kr(Ve())||$n(Ve())))}),U(()=>(E(Rn()),E(Oe())),()=>{f(mn,{type:"button",icon:By,title:"Expand all",className:"jse-expand-all",onClick:Rn(),disabled:!gr(Oe())})}),U(()=>(E(ht()),E(Oe())),()=>{f(Dn,{type:"button",icon:Ly,title:"Collapse all",className:"jse-collapse-all",onClick:ht(),disabled:!gr(Oe())})}),U(()=>E(Oe()),()=>{f(hr,{type:"button",icon:ac,title:"Search (Ctrl+F)",className:"jse-search",onClick:On,disabled:Oe()===void 0})}),U(()=>(E(vt()),n(mn),n(Dn),E(Xn()),E(Oe()),E(it()),n(hr),E(Pe()),E(lr()),E(Wt()),E(Tn()),E(Mt()),n($e)),()=>{f(_t,vt()?[n(mn),n(Dn),{type:"separator"},{type:"button",icon:wa,title:"Copy (Ctrl+C)",className:"jse-copy",onClick:Mt(),disabled:!n($e)},{type:"separator"},n(hr),{type:"space"}]:[n(mn),n(Dn),{type:"separator"},{type:"button",icon:Ml,title:"Sort",className:"jse-sort",onClick:Xn(),disabled:vt()||Oe()===void 0},{type:"button",icon:Al,title:"Transform contents (filter, sort, project)",className:"jse-transform",onClick:it(),disabled:vt()||Oe()===void 0},n(hr),{type:"button",icon:pp,title:wd,className:"jse-contextmenu",onClick:Pe()},{type:"separator"},{type:"button",icon:td,title:"Undo (Ctrl+Z)",className:"jse-undo",onClick:lr(),disabled:!Wt().canUndo},{type:"button",icon:nd,title:"Redo (Ctrl+Shift+Z)",className:"jse-redo",onClick:Tn(),disabled:!Wt().canRedo},{type:"space"}])}),U(()=>(E(fr()),n(_t)),()=>{f(Se,fr()(n(_t))||n(_t))}),ln(),pt(!0),kc(L,{get items(){return n(Se)}}),ct()})(w,{get json(){return n(I)},get selection(){return n(R)},get readOnly(){return g()},get history(){return x()},onExpandAll:rr,onCollapseAll:D,onUndo:xe,onRedo:st,onSort:qt,onTransform:Rt,onContextMenu:Sn,onCopy:Qt,get onRenderMenu(){return ve()},get showSearch(){return n(Ie)},set showSearch(L){f(Ie,L)},$$legacy:!0})};Y(ce,w=>{S()&&w(he)});var ye=N(ce,2),Re=w=>{o1(w,{get json(){return n(I)},get selection(){return n(R)},onSelect:Nn,get onError(){return B()},get pathParser(){return ne()}})};Y(ye,w=>{O()&&w(Re)});var Ae=N(ye,2),We=w=>{var L=$1(),oe=Ne(L),qe=A(oe);qe.readOnly=!0,Yn(qe,Ve=>f(d,Ve),()=>n(d));var $e=N(oe,2),Se=Ve=>{var vt=Ft(),sn=Ne(vt),Wt=ht=>{(function(lr,Tn){lt(Tn,!1);var Xn=v(Tn,"readOnly",9),it=v(Tn,"onCreateArray",9),Pe=v(Tn,"onCreateObject",9),Mt=v(Tn,"onClick",9);pt(!0);var fr=Wy(),On=N(A(fr),2),mn=N(A(On),2),Dn=hr=>{var _t=Vy(),Vn=N(Ne(_t),2);vn(Vn,"title","Create an empty JSON object (press '{')");var Rr=N(Vn,2);vn(Rr,"title","Create an empty JSON array (press '[')"),se("click",Vn,bo(()=>Pe()())),se("click",Rr,bo(()=>it()())),P(hr,_t)};Y(mn,hr=>{Xn()||hr(Dn)}),se("click",fr,()=>Mt()()),P(lr,fr),ct()})(ht,{get readOnly(){return g()},onCreateObject:()=>{Lt(),Bn("{")},onCreateArray:()=>{Lt(),Bn("[")},onClick:()=>{Lt()}})},Rn=ht=>{var lr=O1(),Tn=Ne(lr),Xn=fe(()=>g()?[]:[{icon:Pl,text:"Repair manually",title:'Open the document in "code" mode and repair it manually',onClick:Te}]);$o(Tn,{type:"error",message:"The loaded JSON document is invalid and could not be repaired automatically.",get actions(){return n(Xn)}}),ug(N(Tn,2),{get text(){return n(je)},get json(){return n(I)},get indentation(){return Q()},get parser(){return $()}}),P(ht,lr)};Y(sn,ht=>{n(je)===""||n(je)===void 0?ht(Wt):ht(Rn,!1)}),P(Ve,vt)},Oe=Ve=>{var vt=E1(),sn=Ne(vt);ng(A(sn),{get json(){return n(I)},get documentState(){return n(V)},get parser(){return $()},get showSearch(){return n(Ie)},get showReplace(){return n(xt)},get readOnly(){return g()},columns:void 0,onSearch:It,onFocus:Be,onPatch:nn,onClose:Ue});var Wt=N(sn,2);vn(Wt,"data-jsoneditor-scrollable-contents",!0);var Rn=A(Wt),ht=Pe=>{P(Pe,z1())};Y(Rn,Pe=>{n(Ie)&&Pe(ht)}),Du(N(Rn,2),{get value(){return n(I)},pointer:"",get state(){return n(V)},get validationErrors(){return n(H)},get searchResults(){return n(De)},get selection(){return n(R)},get context(){return n(gn)},onDragSelectionStart:xr}),Yn(Wt,Pe=>f(u,Pe),()=>n(u));var lr=N(Wt,2),Tn=Pe=>{var Mt=fe(()=>"You pasted a JSON ".concat(Array.isArray(n(Xe).contents)?"array":"object"," as text"));$o(Pe,{type:"info",get message(){return n(Mt)},actions:[{icon:Ns,text:"Paste as JSON instead",title:"Replace the value with the pasted JSON",onMouseDown:Ln},{text:"Leave as is",title:"Keep the JSON embedded in the value",onClick:ir}]})};Y(lr,Pe=>{n(Xe)&&Pe(Tn)});var Xn=N(lr,2),it=Pe=>{var Mt=fe(()=>g()?[]:[{icon:rd,text:"Ok",title:"Accept the repaired document",onClick:Fe},{icon:Pl,text:"Repair manually instead",title:"Leave the document unchanged and repair it manually instead",onClick:Te}]);$o(Pe,{type:"success",message:"The loaded JSON document was invalid but is successfully repaired.",get actions(){return n(Mt)},onClose:Lt})};Y(Xn,Pe=>{n(nt)&&Pe(it)}),qd(N(Xn,2),{get validationErrors(){return n(Le)},selectError:ut}),P(Ve,vt)};Y($e,Ve=>{n(I)===void 0?Ve(Se):Ve(Oe,!1)}),se("paste",qe,En),P(w,L)},zt=w=>{P(w,M1())};Y(Ae,w=>{a?w(zt,!1):w(We)}),Yn(J,w=>f(h,w),()=>n(h));var Xt=N(J,2),Gt=w=>{Gh(w,{onClose:()=>f(q,!1)})};Y(Xt,w=>{n(q)&&w(Gt)});var xn=N(Xt,2),yn=w=>{Zh(w,Ma(()=>n(ae),{onClose:()=>{var L;(L=n(ae))===null||L===void 0||L.onClose(),f(ae,void 0)}}))};return Y(xn,w=>{n(ae)&&w(yn)}),we(()=>k=Ot(J,1,"jse-tree-mode svelte-vrx1dr",null,k,{"no-main-menu":!S()})),se("keydown",J,function(w){var L=ca(w),oe=w.shiftKey;if(o("keydown",{combo:L,key:w.key}),L==="Ctrl+X"&&(w.preventDefault(),pn(!0)),L==="Ctrl+Shift+X"&&(w.preventDefault(),pn(!1)),L==="Ctrl+C"&&(w.preventDefault(),Qt(!0)),L==="Ctrl+Shift+C"&&(w.preventDefault(),Qt(!1)),L==="Ctrl+D"&&(w.preventDefault(),pr()),L!=="Delete"&&L!=="Backspace"||(w.preventDefault(),tr()),L==="Insert"&&(w.preventDefault(),vr("structure")),L==="Ctrl+A"&&(w.preventDefault(),f(R,Yt([]))),L==="Ctrl+Q"&&Kt(w),L==="ArrowUp"||L==="Shift+ArrowUp"){w.preventDefault();var qe=n(R)?Hv(n(I),n(V),n(R),oe)||n(R):hs(n(I),n(V));f(R,qe),St(Qe(qe))}if(L==="ArrowDown"||L==="Shift+ArrowDown"){w.preventDefault();var $e=n(R)?function(Wt,Rn,ht){var lr=arguments.length>3&&arguments[3]!==void 0&&arguments[3];if(ht){var Tn=lr?Qe(ht):Ra(Wt,ht),Xn=gr(Je(Wt,Tn))?Bv(Wt,Rn,Tn,!0):Rn,it=Qc(Wt,Rn,Tn),Pe=Qc(Wt,Xn,Tn);if(lr)return _r(ht)?it!==void 0?Dr(it,it):void 0:co(ht)?Pe!==void 0?Dr(Pe,Pe):void 0:Pe!==void 0?Dr(Ka(ht),Pe):void 0;if(co(ht))return Pe!==void 0?Yt(Pe):void 0;if(_r(ht)||$n(ht))return it!==void 0?Yt(it):void 0;if(kr(ht)){if(it===void 0||it.length===0)return;var Mt=on(it),fr=Je(Wt,Mt);return Array.isArray(fr)?Yt(it):da(it)}return Jn(ht)?Pe!==void 0?Yt(Pe):it!==void 0?Yt(it):void 0:void 0}}(n(I),n(V),n(R),oe)||n(R):hs(n(I),n(V));f(R,$e),St(Qe($e))}if(L==="ArrowLeft"||L==="Shift+ArrowLeft"){w.preventDefault();var Se=n(R)?function(Wt,Rn,ht){var lr=arguments.length>3&&arguments[3]!==void 0&&arguments[3],Tn=!(arguments.length>4&&arguments[4]!==void 0)||arguments[4];if(ht){var{caret:Xn,previous:it}=Jv(Wt,Rn,ht,Tn);if(lr)return Jn(ht)?void 0:Dr(ht.path,ht.path);if(Xn&&it)return Au(it);var Pe=on(Qe(ht)),Mt=Je(Wt,Pe);return $n(ht)&&Array.isArray(Mt)?Dr(ht.path,ht.path):Jn(ht)&&!Array.isArray(Mt)?da(ht.focusPath):void 0}}(n(I),n(V),n(R),oe,!g())||n(R):hs(n(I),n(V));f(R,Se),St(Qe(Se))}if(L==="ArrowRight"||L==="Shift+ArrowRight"){w.preventDefault();var Oe=n(R)&&n(I)!==void 0?function(Wt,Rn,ht){var lr=arguments.length>3&&arguments[3]!==void 0&&arguments[3],Tn=!(arguments.length>4&&arguments[4]!==void 0)||arguments[4];if(ht){var{caret:Xn,next:it}=Jv(Wt,Rn,ht,Tn);return lr?Jn(ht)?void 0:Dr(ht.path,ht.path):Xn&&it?Au(it):Jn(ht)?Yt(ht.focusPath):void 0}}(n(I),n(V),n(R),oe,!g())||n(R):hs(n(I),n(V));f(R,Oe),St(Qe(Oe))}if(L==="Enter"&&n(R)){if(jc(n(R))){var Ve=n(R).focusPath,vt=Je(n(I),on(Ve));Array.isArray(vt)&&(w.preventDefault(),f(R,Yt(Ve)))}kr(n(R))&&(w.preventDefault(),f(R,ge(ge({},n(R)),{},{edit:!0}))),$n(n(R))&&(w.preventDefault(),gr(Je(n(I),n(R).path))?Ut(n(R).path,!0):f(R,ge(ge({},n(R)),{},{edit:!0})))}if(L.replace(/^Shift\+/,"").length===1&&n(R))return w.preventDefault(),void Bn(w.key);if(L==="Enter"&&(co(n(R))||_r(n(R))))return w.preventDefault(),void Bn("");if(L==="Ctrl+Enter"&&$n(n(R))){var sn=Je(n(I),n(R).path);hc(sn)&&window.open(String(sn),"_blank")}L==="Escape"&&n(R)&&(w.preventDefault(),f(R,void 0)),L==="Ctrl+F"&&(w.preventDefault(),X(!1)),L==="Ctrl+H"&&(w.preventDefault(),X(!0)),L==="Ctrl+Z"&&(w.preventDefault(),xe()),L==="Ctrl+Shift+Z"&&(w.preventDefault(),st())}),se("mousedown",J,function(w){o("handleMouseDown",w);var L=w.target;jh(L,"BUTTON")||L.isContentEditable||(Lt(),n(R)||n(I)!==void 0||n(je)!==""&&n(je)!==void 0||(o("createDefaultSelection"),f(R,Yt([]))))}),se("contextmenu",J,Kt),P(e,Fn),yt(t,"expand",ze),yt(t,"collapse",mt),yt(t,"validate",Tt),yt(t,"getJson",an),yt(t,"patch",fn),yt(t,"acceptAutoRepair",Fe),yt(t,"openTransformModal",tn),yt(t,"scrollTo",ot),yt(t,"findElement",un),yt(t,"focus",Lt),ct({expand:ze,collapse:mt,validate:Tt,getJson:an,patch:fn,acceptAutoRepair:Fe,openTransformModal:tn,scrollTo:ot,findElement:un,focus:Lt})}function vg(e){return typeof(t=e)!="object"||t===null?e:new Proxy(e,{get:(r,o,a)=>vg(Reflect.get(r,o,a)),set:()=>!1,deleteProperty:()=>!1});var t}var bl=Sr("jsoneditor:History");function fg(){var e=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},t=e.maxItems||1e3,r=[],o=0;function a(){return o<r.length}function s(){return o>0}function i(){return{canUndo:a(),canRedo:s(),items:()=>r.slice().reverse(),add:c,undo:d,redo:h,clear:u}}function l(){e.onChange&&e.onChange(i())}function c(p){bl("add",p),r=[p].concat(r.slice(o)).slice(0,t),o=0,l()}function u(){bl("clear"),r=[],o=0,l()}function d(){if(a()){var p=r[o];return o+=1,bl("undo",p),l(),p}}function h(){if(s())return bl("redo",r[o-=1]),l(),r[o]}return{get:i}}jt(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
