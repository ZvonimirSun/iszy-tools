...
snippet wbr
	<wbr />\${1}
`}),ace.define("ace/snippets/html",["require","exports","module","ace/snippets/html.snippets"],function(p,g,$){g.snippetText=p("./html.snippets"),g.scope="html"}),function(){ace.require(["ace/snippets/html"],function(p){w&&(w.exports=p)})}()})(Z);const J="/assets/worker-html.ca2d0aac.js";const T=w=>(q("data-v-19c4b3b4"),w=w(),W(),w),G={class:"panel"},K={class:"inputPanel"},Q={class:"header"},tt=T(()=>v("span",{class:"i-iszy-jsoneditor-format"},null,-1)),et=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),nt=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),at={class:"inputPanel"},it={class:"header"},ot=T(()=>v("span",{class:"i-iszy-jsoneditor-format"},null,-1)),rt=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),st=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),lt={class:"inputPanel"},pt={class:"header"},ct=T(()=>v("span",{class:"i-iszy-jsoneditor-format"},null,-1)),ut=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),dt=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),mt=["srcdoc"],gt={__name:"tinyEditor",setup(w){E.config.setModuleUrl("ace/mode/css_worker",X),E.config.setModuleUrl("ace/mode/javascript_worker",Y),E.config.setModuleUrl("ace/mode/html_worker",J);const L=E.require("ace/ext/beautify"),p={},g=M(""),$=M(""),f=M(""),h=B();j(()=>{g.value=h.state.tinyEditor.html,$.value=h.state.tinyEditor.css,f.value=h.state.tinyEditor.js}),D(g,e=>{h.dispatch("tinyEditor/setContent",{type:"html",content:e})}),D($,e=>{h.dispatch("tinyEditor/setContent",{type:"css",content:e})}),D(f,e=>{h.dispatch("tinyEditor/setContent",{type:"js",content:e})});const m=O(()=>g.value+$.value+f.value===""?"\u8F93\u5165\u5185\u5BB9\u4EE5\u5728\u6B64\u5C55\u793A":g.value+"<style>"+$.value+"</style><script>"+f.value+"<\/script>"),o=M(!1);function s(e,t){e.getSession().setTabSize(2),e.getSession().setUseSoftTabs(!0),e.setShowPrintMargin(!1),p[t]=e}function c(e){p[e]&&L.beautify(p[e].session)}function a(e){var t;(t=p[e])==null||t.session.foldAll()}function l(e){var t;(t=p[e])==null||t.session.unfold()}function r(){o.value=!o.value}function n(){window.open("","_blank").document.write(m.value)}return(e,t)=>{const i=P,u=U;return S(),A("div",G,[I(v("div",K,[v("div",Q,[k(i,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:t[0]||(t[0]=d=>c("html"))},{icon:_(()=>[tt]),_:1}),k(i,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:t[1]||(t[1]=d=>a("html"))},{icon:_(()=>[et]),_:1}),k(i,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:t[2]||(t[2]=d=>l("html"))},{icon:_(()=>[nt]),_:1})]),k(R(z),{value:g.value,"onUpdate:value":t[3]||(t[3]=d=>g.value=d),lang:"html",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165HTML\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:t[4]||(t[4]=d=>s(d,"html"))},null,8,["value"])],512),[[F,!o.value]]),I(v("div",at,[v("div",it,[k(i,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:t[5]||(t[5]=d=>c("css"))},{icon:_(()=>[ot]),_:1}),k(i,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:t[6]||(t[6]=d=>a("js"))},{icon:_(()=>[rt]),_:1}),k(i,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:t[7]||(t[7]=d=>l("js"))},{icon:_(()=>[st]),_:1})]),k(R(z),{value:f.value,"onUpdate:value":t[8]||(t[8]=d=>f.value=d),lang:"javascript",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165JS\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:t[9]||(t[9]=d=>s(d,"js"))},null,8,["value"])],512),[[F,!o.value]]),I(v("div",lt,[v("div",pt,[k(i,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:t[10]||(t[10]=d=>c("css"))},{icon:_(()=>[ct]),_:1}),k(i,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:t[11]||(t[11]=d=>a("css"))},{icon:_(()=>[ut]),_:1}),k(i,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:t[12]||(t[12]=d=>l("css"))},{icon:_(()=>[dt]),_:1})]),k(R(z),{value:$.value,"onUpdate:value":t[13]||(t[13]=d=>$.value=d),lang:"css",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165CSS\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:t[14]||(t[14]=d=>s(d,"css"))},null,8,["value"])],512),[[F,!o.value]]),v("div",{class:N(["displayPanel",{fullPanel:o.value}])},[k(u,{class:"fullScreen"},{default:_(()=>[o.value?(S(),A("span",{key:0,class:"i-icon-park-outline-off-screen",title:"\u9000\u51FA\u5B8C\u6574\u5C55\u793A",onClick:r})):(S(),A("span",{key:1,class:"i-icon-park-outline-full-screen",title:"\u5B8C\u6574\u5C55\u793A",onClick:r})),v("span",{class:"i-fa-solid-external-link-alt",title:"\u65B0\u6807\u7B7E\u6253\u5F00",onClick:n})]),_:1}),v("iframe",{"w-full":"","h-full":"",srcdoc:R(m),seamless:"",title:"\u5C55\u793A\u9762\u677F"},null,8,mt)],2)])}}},yt=H(gt,[["__scopeId","data-v-19c4b3b4"]]);export{yt as default};
