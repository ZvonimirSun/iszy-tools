...
}`);var Ax=L('<button type="button"><!> </button>'),Px=L('<div class="jse-select-query-language svelte-atm4um"><div class="jse-select-query-language-container svelte-atm4um"></div></div>');function Rx(e,t){lt(t,!1);var r=v(t,"queryLanguages",8),o=v(t,"queryLanguageId",12),a=v(t,"onChangeQueryLanguage",8);pt();var s=Px();dr(A(s),5,r,br,(i,l)=>{var c,u=Ax(),d=A(u),h=g=>{en(g,{data:lp})},p=g=>{en(g,{data:cp})};Y(d,g=>{n(l).id===o()?g(h):g(p,!1)});var m=N(d);we(()=>{var g;c=St(u,1,"jse-query-language svelte-atm4um",null,c,{selected:n(l).id===o()}),vn(u,"title","Select ".concat(n(l).name," as query language")),gt(m," ".concat((g=n(l).name)!==null&&g!==void 0?g:""))}),se("click",u,()=>{return g=n(l).id,o(g),void a()(g);var g}),P(i,u)}),P(e,s),ct()}bt(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
}`);var Ux=L('<button type="button" class="jse-button jse-action jse-primary svelte-czprfx"><!> </button>'),Bx=L('<div><div role="button" tabindex="-1"><div class="jse-text-centered"><!> </div></div> <div class="jse-actions svelte-czprfx"></div></div>');function Mo(e,t){lt(t,!1);var r=v(t,"type",9,"success"),o=v(t,"icon",9,void 0),a=v(t,"message",9,void 0),s=v(t,"actions",25,()=>[]),i=v(t,"onClick",9,void 0),l=v(t,"onClose",9,void 0);l()&&vo(l()),pt(!0);var c,u=Bx(),d=A(u),h=A(d),p=A(h),m=b=>{en(b,{get data(){return o()}})};Y(p,b=>{o()&&b(m)});var g=N(p);dr(N(d,2),5,s,br,(b,j)=>{var x=Ux(),S=A(x),O=y=>{en(y,{get data(){return n(j).icon}})};Y(S,y=>{n(j).icon&&y(O)});var C=N(S);we(()=>{var y;vn(x,"title",n(j).title),x.disabled=n(j).disabled,gt(C," ".concat((y=n(j).text)!==null&&y!==void 0?y:""))}),se("click",x,()=>{n(j).onClick&&n(j).onClick()}),se("mousedown",x,()=>{n(j).onMouseDown&&n(j).onMouseDown()}),P(b,x)}),we(()=>{var b,j;St(u,1,"jse-message jse-".concat((b=r())!==null&&b!==void 0?b:""),"svelte-czprfx"),c=St(d,1,"jse-text svelte-czprfx",null,c,{"jse-clickable":!!i()}),gt(g," ".concat((j=a())!==null&&j!==void 0?j:""))}),se("click",d,function(){i()&&i()()}),P(e,u),ct()}bt(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
