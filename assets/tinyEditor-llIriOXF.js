...
snippet wbr
	<wbr />\${1}
`}),ace.define("ace/snippets/html",["require","exports","module","ace/snippets/html.snippets"],function(c,g,$){g.snippetText=c("./html.snippets"),g.scope="html"}),function(){ace.require(["ace/snippets/html"],function(c){y&&(y.exports=c)})}()})(G);const K="/assets/worker-javascript-PN319Npu.js",Q="/assets/worker-html-sAHX0OUH.js",C=y=>(W("data-v-abcc7aa4"),y=y(),U(),y),ee={class:"panel"},te={class:"inputPanel"},ne={class:"header"},re=C(()=>k("span",{class:"i-iszy-jsoneditor-format"},null,-1)),ae=C(()=>k("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),oe=C(()=>k("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),ie={class:"inputPanel"},se={class:"header"},le=C(()=>k("span",{class:"i-iszy-jsoneditor-format"},null,-1)),pe=C(()=>k("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),ce=C(()=>k("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),ue={class:"inputPanel"},de={class:"header"},ge=C(()=>k("span",{class:"i-iszy-jsoneditor-format"},null,-1)),me=C(()=>k("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),he=C(()=>k("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),fe=["srcdoc"],xe={__name:"tinyEditor",setup(y){E.config.setModuleUrl("ace/mode/css_worker",X),E.config.setModuleUrl("ace/mode/javascript_worker",K),E.config.setModuleUrl("ace/mode/html_worker",Q);const R=E.require("ace/ext/beautify"),c={},g=Y(),$=D("textmate"),h=j();h.value&&($.value="twilight"),N(h,n=>{n?$.value="twilight":$.value="textmate"});const m=z(()=>g.html+g.css+g.js===""?"输入内容以在此展示":g.html+"<style>"+g.css+"</style><script>"+g.js+"<\/script>"),d=D(!1);function a(n,e){n.getSession().setTabSize(2),n.getSession().setUseSoftTabs(!0),n.setShowPrintMargin(!1),c[e]=n}function l(n){c[n]&&R.beautify(c[n].session)}function u(n){var e;(e=c[n])==null||e.session.foldAll()}function r(n){var e;(e=c[n])==null||e.session.unfold()}function p(){d.value=!d.value}function i(){window.open("","_blank").document.write(m.value)}return(n,e)=>{const t=q,o=P;return L(),S("div",ee,[I(k("div",te,[k("div",ne,[_(t,{type:"primary",title:"格式化",onClick:e[0]||(e[0]=s=>l("html"))},{icon:T(()=>[re]),_:1}),_(t,{type:"primary",title:"折叠所有",onClick:e[1]||(e[1]=s=>u("html"))},{icon:T(()=>[ae]),_:1}),_(t,{type:"primary",title:"展开所有",onClick:e[2]||(e[2]=s=>r("html"))},{icon:T(()=>[oe]),_:1})]),_(v(F),{value:v(g).html,"onUpdate:value":e[3]||(e[3]=s=>v(g).html=s),lang:"html",theme:v($),style:{height:"calc(100% - 4.2rem)"},placeholder:"请输入HTML内容",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:e[4]||(e[4]=s=>a(s,"html"))},null,8,["value","theme"])],512),[[A,!v(d)]]),I(k("div",ie,[k("div",se,[_(t,{type:"primary",title:"格式化",onClick:e[5]||(e[5]=s=>l("css"))},{icon:T(()=>[le]),_:1}),_(t,{type:"primary",title:"折叠所有",onClick:e[6]||(e[6]=s=>u("js"))},{icon:T(()=>[pe]),_:1}),_(t,{type:"primary",title:"展开所有",onClick:e[7]||(e[7]=s=>r("js"))},{icon:T(()=>[ce]),_:1})]),_(v(F),{value:v(g).js,"onUpdate:value":e[8]||(e[8]=s=>v(g).js=s),lang:"javascript",theme:v($),style:{height:"calc(100% - 4.2rem)"},placeholder:"请输入JS内容",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:e[9]||(e[9]=s=>a(s,"js"))},null,8,["value","theme"])],512),[[A,!v(d)]]),I(k("div",ue,[k("div",de,[_(t,{type:"primary",title:"格式化",onClick:e[10]||(e[10]=s=>l("css"))},{icon:T(()=>[ge]),_:1}),_(t,{type:"primary",title:"折叠所有",onClick:e[11]||(e[11]=s=>u("css"))},{icon:T(()=>[me]),_:1}),_(t,{type:"primary",title:"展开所有",onClick:e[12]||(e[12]=s=>r("css"))},{icon:T(()=>[he]),_:1})]),_(v(F),{value:v(g).css,"onUpdate:value":e[13]||(e[13]=s=>v(g).css=s),lang:"css",theme:v($),style:{height:"calc(100% - 4.2rem)"},placeholder:"请输入CSS内容",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:e[14]||(e[14]=s=>a(s,"css"))},null,8,["value","theme"])],512),[[A,!v(d)]]),k("div",{class:O(["displayPanel",{fullPanel:v(d)}])},[_(o,{class:"fullScreen"},{default:T(()=>[v(d)?(L(),S("span",{key:0,class:"i-icon-park-outline-off-screen",title:"退出完整展示",onClick:p})):(L(),S("span",{key:1,class:"i-icon-park-outline-full-screen",title:"完整展示",onClick:p})),k("span",{class:"i-fa-solid-external-link-alt",title:"新标签打开",onClick:i})]),_:1}),k("iframe",{"w-full":"","h-full":"",srcdoc:v(m),seamless:"",title:"展示面板",allowTransparency:"true"},null,8,fe)],2)])}}},Te=H(xe,[["__scopeId","data-v-abcc7aa4"]]);export{Te as default};
