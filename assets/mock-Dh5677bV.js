...
.jse-value.jse-empty.svelte-c0g9qz::after {
  ...
  color: var(--jse-tag-background, rgba(0, 0, 0, 0.2));
  content: "value";
}`);var vj=B('<div role="button" tabindex="-1" data-type="selectable-value"><!></div>');function pj(e,t){rt(t,!1);var o=M(void 0,!0),r=p(t,"path",9),a=p(t,"value",9),s=p(t,"mode",9),i=p(t,"readOnly",9),l=p(t,"normalization",9),c=p(t,"parser",9),d=p(t,"onSelect",9),u=p(t,"searchResultItems",9);N(()=>$(a()),()=>{v(o,Ul(a()))}),Wt(),ct(!0);var f=vj(),h=xe(()=>{var m;return"".concat((m=Qf(a(),s(),c()))!==null&&m!==void 0?m:""," svelte-c0g9qz")});L(A(f),u,m=>{var g=xe(()=>l().escapeValue(a()));oh(m,{get text(){return n(g)},get searchResultItems(){return u()}})},m=>{var g=zo();ne(()=>dt(g,Fl(l().escapeValue(a())))),P(m,g)}),ne(()=>{Wo(f,n(h)),Yt(f,"title",n(o)?"Ctrl+Click or Ctrl+Enter to open url in new window":void 0)}),ee("click",f,function(m){typeof a()=="string"&&n(o)&&Lu(m)&&(m.preventDefault(),m.stopPropagation(),window.open(a(),"_blank"))}),ee("dblclick",f,function(m){i()||(m.preventDefault(),d()(gl(r())))}),P(e,f),at()}ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
}`);var zx=B('<button type="button" class="jse-expand-items svelte-1h6hzoq"> </button>'),$x=B('<div role="none" class="jse-collapsed-items svelte-1h6hzoq"><div><div class="jse-text svelte-1h6hzoq"> </div> <!></div></div>');function Mx(e,t){rt(t,!1);var o=M(void 0,!0),r=M(void 0,!0),a=M(void 0,!0),s=M(void 0,!0),i=M(void 0,!0),l=p(t,"visibleSections",9),c=p(t,"sectionIndex",9),d=p(t,"total",9),u=p(t,"path",9),f=p(t,"selection",9),h=p(t,"onExpandSection",9),m=p(t,"context",9);N(()=>($(l()),$(c())),()=>{v(o,l()[c()])}),N(()=>n(o),()=>{v(r,n(o).end)}),N(()=>($(l()),$(c()),$(d())),()=>{v(a,l()[c()+1]?l()[c()+1].start:d())}),N(()=>($(m()),$(f()),$(u()),n(r)),()=>{v(s,fi(m().getJson(),f(),u().concat(String(n(r)))))}),N(()=>(n(r),n(a)),()=>{v(i,function(E,y){var S={start:E,end:Math.min(Xc(E),y)},w=Math.max(fl((E+y)/2),E),_={start:w,end:Math.min(Xc(w),y)},I=fl(y),q=I===y?I-di:I,k={start:Math.max(q,E),end:y},Q=[S],je=_.start>=S.end&&_.end<=k.start;return je&&Q.push(_),k.start>=(je?_.end:S.end)&&Q.push(k),Q}(n(r),n(a)))}),Wt(),ct(!0);var g=$x(),b=A(g),j=A(b),x=A(j);Hn(D(j,2),1,()=>n(i),no,(E,y)=>{var S=zx(),w=A(S);ne(()=>{var _,I;return dt(w,"show ".concat((_=n(y).start)!==null&&_!==void 0?_:"","-").concat((I=n(y).end)!==null&&I!==void 0?I:""))}),ee("click",S,()=>h()(u(),n(y))),P(E,S)}),ne(()=>{var E,y;We(g,"jse-selected",n(s)),hs(g,"--level",u().length+2),dt(x,"Items ".concat((E=n(r))!==null&&E!==void 0?E:"","-").concat((y=n(a))!==null&&y!==void 0?y:""))}),ee("mousemove",g,function(E){E.stopPropagation()}),P(e,g),at()}ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
.jse-json-preview.svelte-1vjn89h {
  ...
  border-right: var(--jse-main-border, 1px solid #d7d7d7);
  border-bottom: var(--jse-main-border, 1px solid #d7d7d7);
}`);var F1=B('<div class="jse-json-preview svelte-1vjn89h"> </div>');function Ah(e,t){rt(t,!1);var o=M(),r=M(),a=p(t,"text",8),s=p(t,"json",8),i=p(t,"indentation",8),l=p(t,"parser",8);N(()=>($(s()),$(a())),()=>{v(o,s()!==void 0?{json:s()}:{text:a()||""})}),N(()=>(n(o),$(i()),$(l()),Qc),()=>{v(r,ui(Jc(n(o),i(),l()),Qc))}),Wt(),ct();var c=F1(),d=A(c);ne(()=>dt(d,n(r))),P(e,c),at()}ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
}`);var J1=B('<div class="jse-separator svelte-12z7bz1"></div>'),K1=B('<div class="jse-label svelte-12z7bz1"> </div>'),Y1=B('<div class="jse-column svelte-12z7bz1"></div>'),Q1=B('<div class="jse-separator svelte-12z7bz1"></div>'),X1=B('<div class="jse-row svelte-12z7bz1"></div>'),G1=B('<div class="jse-separator svelte-12z7bz1"></div>'),Z1=B('<div class="jse-row svelte-12z7bz1"><div class="jse-tip svelte-12z7bz1"><div class="jse-tip-icon svelte-12z7bz1"><!></div> <div class="jse-tip-text"> </div></div></div>'),ey=B('<div role="menu" tabindex="-1" class="jse-contextmenu svelte-12z7bz1"><!> <!></div>');function Ph(e,t){rt(t,!1);var o=p(t,"items",9),r=p(t,"onRequestClose",9),a=p(t,"tip",9),s=M(void 0,!0);Ao(()=>{var u=Array.from(n(s).querySelectorAll("button")).find(f=>!f.disabled);u&&u.focus()});var i={ArrowUp:"Up",ArrowDown:"Down",ArrowLeft:"Left",ArrowRight:"Right"};function l(u){return console.error("Unknown type of context menu item",u),"???"}ct(!0);var c=ey(),d=A(c);Hn(d,1,o,no,(u,f)=>{var h=It();L(Te(h),()=>Gs(n(f)),m=>{Sc(m,{get item(){return n(f)},get onRequestClose(){return r()}})},m=>{var g=It();L(Te(g),()=>pc(n(f)),b=>{Oc(b,{get item(){return n(f)},get onRequestClose(){return r()}})},b=>{var j=It();L(Te(j),()=>ej(n(f)),x=>{var E=X1();Hn(E,5,()=>n(f).items,no,(y,S)=>{var w=It();L(Te(w),()=>Gs(n(S)),_=>{Sc(_,{get item(){return n(S)},get onRequestClose(){return r()}})},_=>{var I=It();L(Te(I),()=>pc(n(S)),q=>{Oc(q,{get item(){return n(S)},get onRequestClose(){return r()}})},q=>{var k=It();L(Te(k),()=>tj(n(S)),Q=>{var je=Y1();Hn(je,5,()=>n(S).items,no,(ae,fe)=>{var qe=It();L(Te(qe),()=>Gs(n(fe)),we=>{Sc(we,{className:"left",get item(){return n(fe)},get onRequestClose(){return r()}})},we=>{var ze=It();L(Te(ze),()=>pc(n(fe)),_e=>{Oc(_e,{className:"left",get item(){return n(fe)},get onRequestClose(){return r()}})},_e=>{var $e=It();L(Te($e),()=>Zi(n(fe)),he=>{P(he,J1())},he=>{var ce=It();L(Te(ce),()=>Z0(n(fe)),ie=>{var Ge=K1(),le=A(Ge);ne(()=>dt(le,n(fe).text)),P(ie,Ge)},ie=>{var Ge=zo();ne(()=>dt(Ge,l(n(fe)))),P(ie,Ge)},!0),P(he,ce)},!0),P(_e,$e)},!0),P(we,ze)}),P(ae,qe)}),P(Q,je)},Q=>{var je=It();L(Te(je),()=>Zi(n(S)),ae=>{P(ae,Q1())},ae=>{var fe=zo();ne(()=>dt(fe,l(n(S)))),P(ae,fe)},!0),P(Q,je)},!0),P(q,k)},!0),P(_,I)}),P(y,w)}),P(x,E)},x=>{var E=It();L(Te(E),()=>Zi(n(f)),y=>{P(y,G1())},y=>{var S=zo();ne(()=>dt(S,l(n(f)))),P(y,S)},!0),P(x,E)},!0),P(b,j)},!0),P(m,g)}),P(u,h)}),L(D(d,2),a,u=>{var f=Z1(),h=A(f),m=A(h);Ut(A(m),{data:bm});var g=A(D(m,2));ne(()=>dt(g,a())),P(u,f)}),On(c,u=>v(s,u),()=>n(s)),ee("keydown",c,function(u){var f=Fr(u),h=i[f];if(h&&u.target){u.preventDefault();var m=P0({allElements:Array.from(n(s).querySelectorAll("button:not([disabled])")),currentElement:u.target,direction:h,hasPrio:g=>g.getAttribute("data-type")!=="jse-open-dropdown"});m&&m.focus()}}),P(e,c),at()}ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
}`);var Vs=Nl(()=>yj),Xa=Nl(()=>wj),iy=B('<div class="query-error svelte-rrrjnb"> </div>'),ly=B("<!> <!>",1),cy=B('<div class="jse-preview jse-error svelte-rrrjnb"> </div>'),uy=B('<!> <div class="jse-modal-contents svelte-rrrjnb"><div class="jse-main-contents svelte-rrrjnb"><div class="jse-query-contents svelte-rrrjnb"><div class="jse-label svelte-rrrjnb"><div class="jse-label-inner svelte-rrrjnb">Language</div></div> <div class="jse-description svelte-rrrjnb"><!></div> <div class="jse-label svelte-rrrjnb"><div class="jse-label-inner svelte-rrrjnb">Path</div></div> <input class="jse-path svelte-rrrjnb" type="text" readonly="" title="Selected path"> <div class="jse-label svelte-rrrjnb"><div class="jse-label-inner svelte-rrrjnb"><button type="button" class="svelte-rrrjnb"><!> Wizard</button></div></div> <!> <div class="jse-label svelte-rrrjnb"><div class="jse-label-inner svelte-rrrjnb">Query</div></div> <textarea class="jse-query svelte-rrrjnb" spellcheck="false"></textarea></div> <div class="jse-data-contents svelte-rrrjnb"><div class="jse-original-data svelte-rrrjnb"><div class="jse-label svelte-rrrjnb"><div class="jse-label-inner svelte-rrrjnb"><button type="button" class="svelte-rrrjnb"><!> Original</button></div></div> <!></div> <div class="jse-preview-data svelte-rrrjnb"><div class="jse-label svelte-rrrjnb"><div class="jse-label-inner svelte-rrrjnb">Preview</div></div> <!></div></div></div> <div class="jse-actions svelte-rrrjnb"><button type="button" class="jse-primary svelte-rrrjnb">Transform</button></div></div>',1),dy=B('<div class="jse-transform-modal-inner svelte-rrrjnb"><!></div>');function vy(e,t){var o,r,a;rt(t,!1);var s=ho("jsoneditor:TransformModal"),i=p(t,"id",25,()=>"transform-modal-"+ss()),l=p(t,"json",9),c=p(t,"rootPath",25,()=>[]),d=p(t,"indentation",9),u=p(t,"escapeControlCharacters",9),f=p(t,"escapeUnicodeCharacters",9),h=p(t,"parser",9),m=p(t,"parseMemoizeOne",9),g=p(t,"validationParser",9),b=p(t,"pathParser",9),j=p(t,"queryLanguages",9),x=p(t,"queryLanguageId",13),E=p(t,"onChangeQueryLanguage",9),y=p(t,"onRenderValue",9),S=p(t,"onRenderMenu",9),w=p(t,"onRenderContextMenu",9),_=p(t,"onClassName",9),I=p(t,"onTransform",9),q=p(t,"onClose",9),k=M(void 0,!0),Q=M(void 0,!0),je=M(void 0,!0),ae=M(!1,!0),fe="".concat(i(),":").concat(xt(c())),qe=(o=Vs()[fe])!==null&&o!==void 0?o:{},we=M(Xa().showWizard!==!1,!0),ze=M(Xa().showOriginal!==!1,!0),_e=M((r=qe.queryOptions)!==null&&r!==void 0?r:{},!0),$e=M(x()===qe.queryLanguageId&&qe.query?qe.query:"",!0),he=M((a=qe.isManual)!==null&&a!==void 0&&a,!0),ce=M(void 0,!0),ie=M(void 0,!0),Ge=M({text:""},!0);function le(R){var ve;return(ve=j().find(vt=>vt.id===R))!==null&&ve!==void 0?ve:j()[0]}function de(R){try{v(_e,R),v($e,le(x()).createQuery(n(Q),R)),v(ce,void 0),v(he,!1),s("updateQueryByWizard",{queryOptions:n(_e),query:n($e),isManual:n(he)})}catch(ve){v(ce,String(ve))}}function C(R){v($e,R.target.value),v(he,!0),s("handleChangeQuery",{query:n($e),isManual:n(he)})}n(he)||de(n(_e)),Ao(()=>{var R;(R=n(k))===null||R===void 0||R.focus()});var oe=rl(function(R,ve){if(R===void 0)return v(Ge,{text:""}),void v(ie,"Error: No JSON");if(ve.trim()!=="")try{s("previewTransform",{query:ve});var vt=le(x()).executeQuery(R,ve,h());v(Ge,{json:vt}),v(ie,void 0)}catch(Be){v(Ge,{text:""}),v(ie,String(Be))}else v(Ge,{json:R})},300);function T(){if(n(Q)===void 0)return v(Ge,{text:""}),void v(ie,"Error: No JSON");try{s("handleTransform",{query:n($e)});var R=le(x()).executeQuery(n(Q),n($e),h());I()([{op:"replace",path:xt(c()),value:R}]),q()()}catch(ve){console.error(ve),v(Ge,{text:""}),v(ie,String(ve))}}function re(){v(we,!n(we)),Xa(Xa().showWizard=n(we))}function Ze(){v(ze,!n(ze)),Xa(Xa().showOriginal=n(ze))}function se(R){s("handleChangeQueryLanguage",R),x(R),E()(R),de(n(_e))}function V(){n(ae)?v(ae,!n(ae)):q()()}N(()=>($(l()),$(c())),()=>{v(Q,Rh(He(l(),c())))}),N(()=>n(Q),()=>{v(je,n(Q)?{json:n(Q)}:{text:""})}),N(()=>(n(Q),n($e)),()=>{oe(n(Q),n($e))}),N(()=>(Vs(),n(_e),n($e),$(x()),n(he)),()=>{Vs(Vs()[fe]={queryOptions:n(_e),query:n($e),queryLanguageId:x(),isManual:n(he)}),s("store state in memory",fe,Vs()[fe])}),Wt(),ct(!0),mi(e,{get onClose(){return q()},className:"jse-transform-modal",get fullscreen(){return n(ae)},children:(R,ve)=>{var vt=dy();Yc(A(vt),{children:(Be,Ae)=>{var K=uy(),me=Te(K);(function($t,Bt){rt(Bt,!1);var sn,Mt=p(Bt,"queryLanguages",9),En=p(Bt,"queryLanguageId",9),Nn=p(Bt,"fullscreen",13),co=p(Bt,"onChangeQueryLanguage",9),Qt=p(Bt,"onClose",9),Pt=M(void 0,!0),{openAbsolutePopup:mn,closeAbsolutePopup:Un}=xa("absolute-popup");function hn(){var ao={queryLanguages:Mt(),queryLanguageId:En(),onChangeQueryLanguage:Mn=>{Un(sn),co()(Mn)}};sn=mn(rx,ao,{offsetTop:-2,offsetLeft:0,anchor:n(Pt),closeOnOuterClick:!0})}ct(!0),kl($t,{title:"Transform",fullScreenButton:!0,get fullscreen(){return Nn()},set fullscreen(ao){Nn(ao)},get onClose(){return Qt()},$$slots:{actions:(ao,Mn)=>{var Kn=ix();Ut(A(Kn),{data:Wg}),On(Kn,xn=>v(Pt,xn),()=>n(Pt)),ne(()=>We(Kn,"hide",Mt().length<=1)),ee("click",Kn,hn),P(ao,Kn)}},$$legacy:!0}),at()})(me,{get queryLanguages(){return j()},get queryLanguageId(){return x()},onChangeQueryLanguage:se,get onClose(){return q()},get fullscreen(){return n(ae)},set fullscreen($t){v(ae,$t)},$$legacy:!0});var Ie=A(D(me,2)),ut=A(Ie),Me=D(A(ut),2);kf(A(Me),()=>le(x()).description,!1,!1);var gt=D(Me,4);ne(()=>Ra(gt,un(c())?"(document root)":rr(c())));var Se=D(gt,2),Oe=A(Se),Xe=A(Oe),jt=A(Xe),zt=xe(()=>n(we)?ha:ni);Ut(jt,{get data(){return n(zt)}});var Fe=D(Se,2);L(Fe,()=>n(we),$t=>{var Bt=It();L(Te(Bt),()=>Array.isArray(n(Q)),sn=>{var Mt=ly(),En=Te(Mt);tx(En,{get queryOptions(){return n(_e)},get json(){return n(Q)},onChange:de}),L(D(En,2),()=>n(ce),Nn=>{var co=iy(),Qt=A(co);ne(()=>dt(Qt,n(ce))),P(Nn,co)}),P(sn,Mt)},sn=>{P(sn,zo("(Only available for arrays, not for objects)"))}),P($t,Bt)});var W=D(Fe,4);On(W,$t=>v(k,$t),()=>n(k));var Ot=D(ut,2),mt=A(Ot),Tn=A(mt),$n=A(Tn),jn=A($n),Xn=A(jn),gn=xe(()=>n(ze)?ha:ni);Ut(Xn,{get data(){return n(gn)}}),L(D(Tn,2),()=>n(ze),$t=>{fu($t,{get externalContent(){return n(je)},externalSelection:void 0,readOnly:!0,mainMenuBar:!1,navigationBar:!1,get indentation(){return d()},get escapeControlCharacters(){return u()},get escapeUnicodeCharacters(){return f()},get parser(){return h()},get parseMemoizeOne(){return m()},get onRenderValue(){return y()},get onRenderMenu(){return S()},get onRenderContextMenu(){return w()},onError:console.error,onChange:mo,onChangeMode:mo,onSelect:mo,onFocus:mo,onBlur:mo,onSortModal:mo,onTransformModal:mo,onJSONEditorModal:mo,get onClassName(){return _()},validator:void 0,get validationParser(){return g()},get pathParser(){return b()}})});var Dn=D(mt,2);L(D(A(Dn),2),()=>!n(ie),$t=>{fu($t,{get externalContent(){return n(Ge)},externalSelection:void 0,readOnly:!0,mainMenuBar:!1,navigationBar:!1,get indentation(){return d()},get escapeControlCharacters(){return u()},get escapeUnicodeCharacters(){return f()},get parser(){return h()},get parseMemoizeOne(){return m()},get onRenderValue(){return y()},get onRenderMenu(){return S()},get onRenderContextMenu(){return w()},onError:console.error,onChange:mo,onChangeMode:mo,onSelect:mo,onFocus:mo,onBlur:mo,onSortModal:mo,onTransformModal:mo,onJSONEditorModal:mo,get onClassName(){return _()},validator:void 0,get validationParser(){return g()},get pathParser(){return b()}})},$t=>{var Bt=cy(),sn=A(Bt);ne(()=>dt(sn,n(ie))),P($t,Bt)});var Jn=A(D(Ie,2));bo(()=>ee("click",Jn,T)),Eo(Jn,$t=>{$t.focus()}),ne(()=>{Ra(W,n($e)),We(Ot,"jse-hide-original-data",!n(ze)),We(mt,"jse-hide",!n(ze)),Jn.disabled=!!n(ie)}),ee("click",Xe,re),ee("input",W,C),ee("click",jn,Ze),P(Be,K)},$$slots:{default:!0}}),Eo(vt,(Be,Ae)=>bh(Be,Ae),()=>V),P(R,vt)},$$slots:{default:!0}}),at()}function Jo(){}function Rv(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:1e3;if(e<.9*t)return e.toFixed()+" B";var o=e/t;if(o<.9*t)return o.toFixed(1)+" KB";var r=o/t;if(r<.9*t)return r.toFixed(1)+" MB";var a=r/t;return a<.9*t?a.toFixed(1)+" GB":(a/t).toFixed(1)+" TB"}ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
.jse-table-mode-welcome.svelte-1q0ce0e .jse-space.jse-after:where(.svelte-1q0ce0e) {
  flex: 2;
        ...
        document in tree mode.`))},I=>{var q=zo();ne(()=>{var k;return dt(q,"".concat((k=n(s))!==null&&k!==void 0?k:""," cannot be opened in table mode."))}),P(I,q)}),L(D(y,2),()=>n(a)&&!c(),I=>{P(I,zy())},I=>{P(I,zo("You can open the document in tree mode instead."))});var S=D(E,2);Hn(S,1,()=>n(m),no,(I,q)=>{var k=$y(),Q=xe(()=>function(fe){return He(l(),fe).length}(n(q))),je=A(k);ne(()=>{var fe,qe;return dt(je,"".concat((fe=n(o))!==null&&fe!==void 0?fe:"",' "').concat((qe=rr(n(q)))!==null&&qe!==void 0?qe:"",'" '))});var ae=A(D(je));ne(()=>{var fe,qe;return dt(ae,"(".concat((fe=n(Q))!==null&&fe!==void 0?fe:""," ").concat((qe=n(Q)!==1?"items":"item")!==null&&qe!==void 0?qe:"",")"))}),ee("click",k,()=>u()(n(q))),P(I,k)});var w=D(S,2),_=A(w);ne(()=>{var I;dt(x,n(s)),dt(_,"".concat((I=n(o))!==null&&I!==void 0?I:""," in tree mode"))}),ee("click",w,()=>f()(io.tree)),ee("click",g,()=>h()()),P(e,g),at()}ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
...
.jse-modal-wrapper.svelte-v0el4e input:where(.svelte-v0el4e):read-only {
  background: var(--jse-input-background-readonly, transparent);
}`);var Jy=B('<div class="jse-error svelte-v0el4e"> </div>'),Ky=B('<button type="button" class="jse-secondary svelte-v0el4e"><!> Back</button>'),Yy=B('<button type="button" class="jse-primary svelte-v0el4e">Apply</button>'),Qy=B('<button type="button" class="jse-primary svelte-v0el4e">Close</button>'),Xy=B('<!> <div class="jse-modal-contents svelte-v0el4e"><div class="jse-label svelte-v0el4e"><div class="jse-label-inner svelte-v0el4e">Path</div></div> <input class="jse-path svelte-v0el4e" type="text" readonly="" title="Selected path"> <div class="jse-label svelte-v0el4e"><div class="jse-label-inner svelte-v0el4e">Contents</div></div> <div class="jse-modal-inline-editor svelte-v0el4e"><!></div> <div class="jse-actions svelte-v0el4e"><!> <!> <!></div></div>',1),Gy=B('<div class="jse-modal-wrapper svelte-v0el4e"><!></div>'),Zy={};ht(`/* over all fonts, sizes, and colors */
/* "consolas" for Windows, "menlo" for Mac with fallback to "monaco", 'Ubuntu Mono' for Ubuntu */
/* (at Mac this font looks too large at 14px, but 13px is too small for the font on Windows) */
/* main, menu, modal */
/* jsoneditor modal */
