...
snippet wbr
	<wbr />\${1}
`}),ace.define("ace/snippets/html",["require","exports","module","ace/snippets/html.snippets"],function(u,h,$){h.snippetText=u("./html.snippets"),h.scope="html"}),function(){ace.require(["ace/snippets/html"],function(u){w&&(w.exports=u)})}()})(Z);const J="/assets/worker-html.ca2d0aac.js";const T=w=>(W("data-v-cd9fe9e6"),w=w(),q(),w),G={class:"panel"},K={class:"inputPanel"},Q={class:"header"},tt=T(()=>v("span",{class:"i-icon-park-outline-indent-right"},null,-1)),et=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),nt=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),at={class:"inputPanel"},it={class:"header"},ot=T(()=>v("span",{class:"i-icon-park-outline-indent-right"},null,-1)),rt=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),st=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),lt={class:"inputPanel"},pt={class:"header"},ut=T(()=>v("span",{class:"i-icon-park-outline-indent-right"},null,-1)),ct=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),dt=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),mt=["srcdoc"],gt={__name:"tinyEditor",setup(w){E.config.setModuleUrl("ace/mode/css_worker",X),E.config.setModuleUrl("ace/mode/javascript_worker",Y),E.config.setModuleUrl("ace/mode/html_worker",J);const L=E.require("ace/ext/beautify"),u={},h=M(""),$=M(""),f=M(""),g=z();N(()=>{h.value=g.state.tinyEditor.html,$.value=g.state.tinyEditor.css,f.value=g.state.tinyEditor.js}),D(h,t=>{g.dispatch("tinyEditor/setContent",{type:"html",content:t})}),D($,t=>{g.dispatch("tinyEditor/setContent",{type:"css",content:t})}),D(f,t=>{g.dispatch("tinyEditor/setContent",{type:"js",content:t})});const m=O(()=>h.value+$.value+f.value===""?"\u8F93\u5165\u5185\u5BB9\u4EE5\u5728\u6B64\u5C55\u793A":h.value+"<style>"+$.value+"</style><script>"+f.value+"<\/script>"),s=M(!1);function p(t,e){t.getSession().setTabSize(2),t.getSession().setUseSoftTabs(!0),t.setShowPrintMargin(!1),u[e]=t}function c(t){u[t]&&L.beautify(u[t].session)}function l(t){var e;(e=u[t])==null||e.session.foldAll()}function i(t){var e;(e=u[t])==null||e.session.unfold()}function o(){s.value=!s.value}function a(){window.open("","_blank").document.write(m.value)}return(t,e)=>{const n=P,r=U;return A(),S("div",G,[I(v("div",K,[v("div",Q,[k(n,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:e[0]||(e[0]=d=>c("html"))},{icon:_(()=>[tt]),_:1}),k(n,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:e[1]||(e[1]=d=>l("html"))},{icon:_(()=>[et]),_:1}),k(n,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:e[2]||(e[2]=d=>i("html"))},{icon:_(()=>[nt]),_:1})]),k(R(B),{value:h.value,"onUpdate:value":e[3]||(e[3]=d=>h.value=d),lang:"html",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165HTML\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:e[4]||(e[4]=d=>p(d,"html"))},null,8,["value"])],512),[[F,!s.value]]),I(v("div",at,[v("div",it,[k(n,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:e[5]||(e[5]=d=>c("css"))},{icon:_(()=>[ot]),_:1}),k(n,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:e[6]||(e[6]=d=>l("js"))},{icon:_(()=>[rt]),_:1}),k(n,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:e[7]||(e[7]=d=>i("js"))},{icon:_(()=>[st]),_:1})]),k(R(B),{value:f.value,"onUpdate:value":e[8]||(e[8]=d=>f.value=d),lang:"javascript",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165JS\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:e[9]||(e[9]=d=>p(d,"js"))},null,8,["value"])],512),[[F,!s.value]]),I(v("div",lt,[v("div",pt,[k(n,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:e[10]||(e[10]=d=>c("css"))},{icon:_(()=>[ut]),_:1}),k(n,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:e[11]||(e[11]=d=>l("css"))},{icon:_(()=>[ct]),_:1}),k(n,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:e[12]||(e[12]=d=>i("css"))},{icon:_(()=>[dt]),_:1})]),k(R(B),{value:$.value,"onUpdate:value":e[13]||(e[13]=d=>$.value=d),lang:"css",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165CSS\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:e[14]||(e[14]=d=>p(d,"css"))},null,8,["value"])],512),[[F,!s.value]]),v("div",{class:j(["displayPanel",{fullPanel:s.value}])},[k(r,{class:"fullScreen"},{default:_(()=>[s.value?(A(),S("span",{key:0,class:"i-icon-park-outline-off-screen",title:"\u9000\u51FA\u5B8C\u6574\u5C55\u793A",onClick:o})):(A(),S("span",{key:1,class:"i-icon-park-outline-full-screen",title:"\u5B8C\u6574\u5C55\u793A",onClick:o})),v("span",{class:"i-fa-solid-external-link-alt",title:"\u65B0\u6807\u7B7E\u6253\u5F00",onClick:a})]),_:1}),v("iframe",{"w-full":"","h-full":"",srcdoc:R(m),seamless:"",title:"\u5C55\u793A\u9762\u677F"},null,8,mt)],2)])}}},yt=H(gt,[["__scopeId","data-v-cd9fe9e6"]]);export{yt as default};
