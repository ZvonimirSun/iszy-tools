...
snippet wbr
	<wbr />\${1}
`,h.scope="html"}),function(){ace.require(["ace/snippets/html"],function(u){w&&(w.exports=u)})}()})(Z);var J="/assets/worker-html.cf1cf9fc.js";const T=w=>(W("data-v-304ab2cf"),w=w(),q(),w),G={class:"panel"},K={class:"inputPanel"},Q={class:"header"},ee=T(()=>v("span",{class:"i-icon-park-outline-indent-right"},null,-1)),te=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),ne=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),ae={class:"inputPanel"},ie={class:"header"},oe=T(()=>v("span",{class:"i-icon-park-outline-indent-right"},null,-1)),re=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),se=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),le={class:"inputPanel"},pe={class:"header"},ue=T(()=>v("span",{class:"i-icon-park-outline-indent-right"},null,-1)),ce=T(()=>v("span",{class:"i-icon-park-outline-collapse-text-input"},null,-1)),de=T(()=>v("span",{class:"i-icon-park-outline-expand-text-input"},null,-1)),me=["srcdoc"],ge={setup(w){E.config.setModuleUrl("ace/mode/css_worker",X),E.config.setModuleUrl("ace/mode/javascript_worker",Y),E.config.setModuleUrl("ace/mode/html_worker",J);const L=E.require("ace/ext/beautify"),u={},h=M(""),b=M(""),f=M(""),g=z();N(()=>{h.value=g.state.tinyEditor.html,b.value=g.state.tinyEditor.css,f.value=g.state.tinyEditor.js}),S(h,e=>{g.dispatch("tinyEditor/setContent",{type:"html",content:e})}),S(b,e=>{g.dispatch("tinyEditor/setContent",{type:"css",content:e})}),S(f,e=>{g.dispatch("tinyEditor/setContent",{type:"js",content:e})});const m=O(()=>h.value+b.value+f.value===""?"\u8F93\u5165\u5185\u5BB9\u4EE5\u5728\u6B64\u5C55\u793A":h.value+"<style>"+b.value+"</style><script>"+f.value+"<\/script>"),s=M(!1);function p(e,t){e.getSession().setTabSize(2),e.getSession().setUseSoftTabs(!0),e.setShowPrintMargin(!1),u[t]=e}function c(e){u[e]&&L.beautify(u[e].session)}function l(e){var t;(t=u[e])==null||t.session.foldAll()}function i(e){var t;(t=u[e])==null||t.session.unfold()}function o(){s.value=!s.value}function a(){window.open("","_blank").document.write(m.value)}return(e,t)=>{const n=P,r=U;return D(),A("div",G,[F(v("div",K,[v("div",Q,[k(n,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:t[0]||(t[0]=d=>c("html"))},{icon:_(()=>[ee]),_:1}),k(n,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:t[1]||(t[1]=d=>l("html"))},{icon:_(()=>[te]),_:1}),k(n,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:t[2]||(t[2]=d=>i("html"))},{icon:_(()=>[ne]),_:1})]),k(R(B),{value:h.value,"onUpdate:value":t[3]||(t[3]=d=>h.value=d),lang:"html",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165HTML\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:t[4]||(t[4]=d=>p(d,"html"))},null,8,["value"])],512),[[I,!s.value]]),F(v("div",ae,[v("div",ie,[k(n,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:t[5]||(t[5]=d=>c("css"))},{icon:_(()=>[oe]),_:1}),k(n,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:t[6]||(t[6]=d=>l("js"))},{icon:_(()=>[re]),_:1}),k(n,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:t[7]||(t[7]=d=>i("js"))},{icon:_(()=>[se]),_:1})]),k(R(B),{value:f.value,"onUpdate:value":t[8]||(t[8]=d=>f.value=d),lang:"javascript",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165JS\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:t[9]||(t[9]=d=>p(d,"js"))},null,8,["value"])],512),[[I,!s.value]]),F(v("div",le,[v("div",pe,[k(n,{type:"primary",title:"\u683C\u5F0F\u5316",onClick:t[10]||(t[10]=d=>c("css"))},{icon:_(()=>[ue]),_:1}),k(n,{type:"primary",title:"\u6298\u53E0\u6240\u6709",onClick:t[11]||(t[11]=d=>l("css"))},{icon:_(()=>[ce]),_:1}),k(n,{type:"primary",title:"\u5C55\u5F00\u6240\u6709",onClick:t[12]||(t[12]=d=>i("css"))},{icon:_(()=>[de]),_:1})]),k(R(B),{value:b.value,"onUpdate:value":t[13]||(t[13]=d=>b.value=d),lang:"css",theme:"textmate",style:{height:"calc(100% - 4.2rem)"},placeholder:"\u8BF7\u8F93\u5165CSS\u5185\u5BB9",options:{useWorker:!0,enableBasicAutocompletion:!0,enableSnippets:!0,enableLiveAutocompletion:!0},onInit:t[14]||(t[14]=d=>p(d,"css"))},null,8,["value"])],512),[[I,!s.value]]),v("div",{class:j(["displayPanel",{fullPanel:s.value}])},[k(r,{class:"fullScreen"},{default:_(()=>[s.value?(D(),A("span",{key:0,class:"i-icon-park-outline-off-screen",title:"\u9000\u51FA\u5B8C\u6574\u5C55\u793A",onClick:o})):(D(),A("span",{key:1,class:"i-icon-park-outline-full-screen",title:"\u5B8C\u6574\u5C55\u793A",onClick:o})),v("span",{class:"i-fa-solid-external-link-alt",title:"\u65B0\u6807\u7B7E\u6253\u5F00",onClick:a})]),_:1}),v("iframe",{"w-full":"","h-full":"",srcdoc:R(m),seamless:"",title:"\u5C55\u793A\u9762\u677F"},null,8,me)],2)])}}};var ye=H(ge,[["__scopeId","data-v-304ab2cf"]]);export{ye as default};
