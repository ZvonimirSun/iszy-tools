...
guard ^\\s*
	...
	$0
`}),ace.define("ace/snippets/javascript",["require","exports","module","ace/snippets/javascript.snippets"],function(u,f,h){f.snippetText=u("./javascript.snippets"),f.scope="javascript"}),function(){ace.require(["ace/snippets/javascript"],function(u){m&&(m.exports=u)})}()})(b);const _="/assets/worker-javascript.38a4e986.js";export{_ as w};
