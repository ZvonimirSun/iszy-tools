...
guard ^\\s*
	...
	$0
`}),ace.define("ace/snippets/javascript",["require","exports","module","ace/snippets/javascript.snippets"],function(u,x,m){x.snippetText=u("./javascript.snippets"),x.scope="javascript"}),function(){ace.require(["ace/snippets/javascript"],function(u){h&&(h.exports=u)})}()})(b);const _=""+new URL("worker-javascript-e0d0f123.js",import.meta.url).href;export{_ as w};
