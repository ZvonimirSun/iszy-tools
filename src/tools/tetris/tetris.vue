            ...
            >
              ...
              >
                <div
                  ...
                  class="tetrisCell" :class="[`tetrisCellColor-${currentMatrix[x - 1][y - 1]}`, clearIndexs.includes(x - 1) ? 'blink' : '']"
                />
                <div
                  v-else
                  class="tetrisCell"
              ...
              >
                ...
                >
                  <div
                    ...
                    class="tetrisCell" :class="[`tetrisCellColor-${nextTetrimino}`]"
                  />
                  <div
                    v-else
                    class="tetrisCell"
